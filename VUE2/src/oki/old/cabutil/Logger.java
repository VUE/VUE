...
class Logger {
  ...
  private void setLabels() {
    className = c.getName();
    String s;
    if (prefix != null) s = className + "[" + prefix + "]"; else s = className;
    label = s + ": ";
    errLabel = s + "(error): ";
  }
  ...
  public void parseArgs(String args[]) {
    for (int i = 0; i < args.length; i++) {
      ...
      if (a.equals("-debug")) {
        this.d = true;
        this.v = true;
      } else if (a.equals("-verbose")) this.v = true; else if (
        a.equals("-n")
      ) action = false;
    }
  }
  ...
  void verbose(Object o) {
    if (this.v) outln(o == null ? "<null>" : o.toString());
  }
  ...
  void debug(Object o) {
    if (this.d) outln(o == null ? "<null>" : o.toString());
  }

  void debug(Object o, String s) {
    if (this.d) System.out.println(o.getClass().getName() + ": " + s);
  }

  void errout(String s) {
    System.err.println(errLabel + s);
  }

  void errout(Exception e, String s) {
    errout(s + ": " + e);
    errout(e);
  }
