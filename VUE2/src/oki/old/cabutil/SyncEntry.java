...
public class SyncEntry {
  ...
  private final String STATUS_CODES[] = {
    "u?",
    "CU",
    "NL",
    "CL",
  ...
  protected boolean setStatus(int s) {
    if (syncStatus == s) return false;
    syncStatus = s;
    if (s == SyncList.STATUS_NEW_REMOTE) setIsGhost(true);
    return true;
  }
  ...
  public void setCabinetEntry(CabinetEntry ce) {
    this.localEntry = ce;
    if (ce == null) throw new RuntimeException("null CabinetEntry");
  }
  ...
  public String toString() {
    ...
    return "SyncEntry<" + descriptionString() + ">"; else return (
      "SyncEntry(" + descriptionString() + ")"
    );
  }
  ...
  public long getLastModifiedTime() {
    long t = 0;
    try {
      if (localEntry instanceof ByteStore) t =
        ((ByteStore) localEntry).getLastModifiedTime(); else if (
        localEntry instanceof Cabinet
