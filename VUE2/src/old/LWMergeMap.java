...
public class LWMergeMap extends LWMap {
    ...
    /** Called by MergeMapsControlPanel -- REPLACE WITH SINGLE FACTORY CALL WITH VOTE v.s. WEIGHT ARG */
    ...
    public void fillAsVoteMerge()
    {
        ...
        for (LWMap map : activeMaps) {
            // if (map != getBaseMap()) // TODO: check -- really create matrix if ignoring baseMap?
