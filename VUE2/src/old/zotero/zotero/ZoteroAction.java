...
public class ZoteroAction {
  ...
  private static String ZOTERO_ONTOLOGY =
  ...
  private static String RDF_NAMESPACE =
  ...
  public static void importZotero(File file) {
    ...
    try {
      BufferedWriter out = new BufferedWriter(
        new FileWriter("/Users/mkorcy01/Desktop/triples.txt")
      );
  ...
  private static void addComponentsToMap(
    List<LWComponent> comps,
    String layout
  ) {
    LWMap map = VUE.getActiveMap();
    ...
    if (map != null) {
      ...
      if (layout.equals(RANDOM)) tufts.vue.LayoutAction.random.act(
        comps
      ); else if (layout.equals(SEARCH)) tufts.vue.LayoutAction.search.act(
        comps
      );
    }
  }
  ...
  private static void scatterKeywordlessItems(
    List<LWComponent> comps,
  ...
  private static String getZoteroNotes(
    String item,
    String itemId,
    Model model
  ) {
  ...
  private static List getZoteroItems(Model model) {
    ...
    while (results2.hasNext()) {
      ...
      String subject = null;
      if (qs2.getLiteral("subject") != null) subject =
        qs2.getLiteral("subject").toString();
      String item = qs2.get("item").toString();

      String reference = null;

      if (qs2.get("ref") != null) reference = qs2.get("ref").toString();
