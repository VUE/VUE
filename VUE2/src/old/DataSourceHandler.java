...
public class DataSourceHandler extends JPanel
    ...
    public final static org.osid.shared.Type favoritesRepositoryType = new edu.tufts.vue.util.Type("edu.tufts",
            "favorites", "Favorites");
    ...
    private final org.osid.shared.Type thumbnailType = new edu.tufts.vue.util.Type("mit.edu", "partStructure",
            "thumbnail");
    ...
    private static final JLabel StatusLabel = new JLabel(VueResources.getString("addLibrary.loading.label"),
            JLabel.CENTER);
