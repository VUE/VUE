...
public class VueLWCPropertyMapper implements VuePropertyMapper {
  ...
  static final String[] sNodeProperties = {
    LWKey.FillColor.name,
  ...
  static final String[] sLinkProperties = {
    LWKey.StrokeColor.name,
    LWKey.StrokeWidth.name,
    LWKey.TextColor.name,
    LWKey.Font.name,
  ...
  static final String[] sTextProperties = {
    LWKey.TextColor.name,
    LWKey.Font.name,
  };
  ...
  public Object getPropertyValue(Object pBean, String key) {
    if (pBean instanceof LWComponent) {
      ...
      // should never happen...
      System.out.println(
        this + " getPropertyValue: unhandled class for " + key + " on " + pBean
      );
    }
    return null;
  }
  ...
  public void setPropertyValue(Object pBean, String pName, Object pValue) {
    if (pBean instanceof LWComponent) {
      ...
      "VueLWCPropertyMapper: can't handle class " +
      pBean +
      " name=" +
      pName +
      " val=" +
  ...
  public VueBeanInfo getBeanInfo(Object pObject) {
    ...
    if (pObject instanceof LWComponent) beanInfo =
      new LWCBeanInfo((LWComponent) pObject);
    return beanInfo;
  }
  ...
  public class LWCBeanInfo implements VueBeanInfo {
    ...
    LWCBeanInfo(LWComponent pLWC) {
      if (pLWC instanceof LWNode) {
        ...
        if (((LWNode) pLWC).isTextNode()) mPropertyNames =
          sTextProperties; else mPropertyNames = sNodeProperties;
    ...
    private VuePropertyDescriptor createDescriptor(String pName) {
      ...
      Class theClass = null;
      if (
        pName.equals(LWKey.FillColor.name) ||
