...
public class VueBeans {
  ...
  private static Map sPropertyMappers = new HashMap();
   ...
   **/
  public static VueBeanInfo getBeanInfo(Object pObject) {
   ...
   * @return the vuale
   **/
  public static Object getPropertyValue(Object pObject, String pName) {
    Object value = null;
  ...
  public static void setPropertyValue(
    ...
    if (mapper != null) {
      ...
      System.out.println(
        "  No mapper fournd for class: " + pObject.getClass().getName()
      );
    }
  }
   ...
   **/
  public static VuePropertyMapper getPropertyMapper(Object pObject) {
    VuePropertyManager mgr = VuePropertyManager.getManager();
    VuePropertyMapper mapper = mgr.getPropertyMapper(pObject);
    return mapper;
  }
   ...
   **/
  public static VueBeanState getState(Object pBean) {
  ...
  public static void applyPropertyValueToSelection(
    LWSelection s,
    String pName,
    Object pValue
  ) {
    ...
    while (i.hasNext()) {
      ...
      if (c instanceof LWLink && pName == LWKey.FillColor.name) continue;
      if (tufts.vue.DEBUG.SELECTION) System.out.println(
        "applying " + pName + " to " + c
      );
