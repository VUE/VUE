...
public class DataFinder extends WidgetStack {
  ...
  private static final org.apache.log4j.Logger Log =
    org.apache.log4j.Logger.getLogger(DataFinder.class);
  ...
  public DataFinder(String name, Class[] included, Class[] excluded) {
    ...
    if (true) {
      ...
      loadingLabel =
        new JLabel(
          VueResources.getString("dockWindow.Resources.loading.label"),
  ...
  private void buildUI() {
    ...
    Widget.setHelpAction(
      browsePane,
      VueResources.getString("dockWindow.Resources.browsePane.helpText")
    );
    Widget.setHelpAction(
      resultsPane,
  ...
  private void buildWidgets() {
    Dimension startSize = new Dimension(
      tufts.vue.gui.GUI.isSmallScreen() ? 250 : 400,
      100
    );
