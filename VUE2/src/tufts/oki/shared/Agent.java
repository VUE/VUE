...
public class Agent implements osid.shared.Agent {
   ...
   *  @author Mark Norton
   */
  public Agent(String display_name, osid.shared.Type type)
   ...
   */
  public osid.shared.TypeIterator getPropertiesTypes()
    throws osid.shared.SharedException {
   ...
   *
   */
  public osid.shared.Properties getPropertiesByType(
    osid.shared.Type propertiesType
  ) throws osid.shared.SharedException {
    for (int i = 0; i < ag_props.size(); i++) {
      Properties prop = (Properties) ag_props.elementAt(i);
    ...
    throw new osid.shared.SharedException(
      osid.shared.SharedException.UNKNOWN_TYPE
    );
  }
