...
public class Group extends Agent implements osid.shared.Group {
   ...
   *  @author Mark Norton
   */
  public Group(String display_name, osid.shared.Type type, String description)
  ...
  public boolean contains(
    osid.shared.Agent memberOrGroup,
   ...
   *  @author Mark Norton
   */
  public osid.shared.AgentIterator getGroupsContainingMember(
    osid.shared.Agent member
  ) throws SharedException {
    Vector temp = new Vector(100);
    for (int i = 0; i < subgroups.size(); i++) {
