...
public class SharedManager
  extends OsidManager
  implements osid.shared.SharedManager {

  public static final String SERIALIZED_FILE_NAME =
    "c:/java/serialized/osid_shared_manager.sid";
   ...
   */
  public osid.shared.Id getId(String idString)
    throws osid.shared.SharedException {
    for (int i = 0; i < ids.size(); i++) {
      Id id = (Id) ids.elementAt(i);
      if (id.getIdString() == idString) return id;
    }
    throw new osid.shared.SharedException(
   ...
   */
  public osid.shared.Agent createAgent(String name, osid.shared.Type agentType)
    throws osid.shared.SharedException {
   ...
   */
  public osid.shared.Group createGroup(
    String name,
    osid.shared.Type groupType,
    String description
  ) throws osid.shared.SharedException {
   ...
   *  @author Mark Norton
   */
  public void deleteAgent(osid.shared.Id id)
    throws osid.shared.SharedException {
   ...
   *  @author Mark Norton
   */
  public void deleteGroup(osid.shared.Id id)
    throws osid.shared.SharedException {
   ...
   */
  public osid.shared.Agent getAgent(osid.shared.Id id)
    throws osid.shared.SharedException {
    for (int i = 0; i < ids.size(); i++) {
   ...
   */
  public osid.shared.Agent getAgent(String name)
    throws osid.shared.SharedException {
   ...
   */
  public osid.shared.TypeIterator getAgentTypes()
    throws osid.shared.SharedException {
   ...
   */
  public osid.shared.AgentIterator getAgentsByType(osid.shared.Type agentType)
    throws osid.shared.SharedException {
    /*  Iterate over all agents, extract type, and add to a HashSet.  */
   ...
   */
  public osid.shared.Group getGroup(osid.shared.Id id)
    throws osid.shared.SharedException {
    for (int i = 0; i < ids.size(); i++) {
   ...
   */
  public osid.shared.TypeIterator getGroupTypes()
    throws osid.shared.SharedException {
    /*  Iterate over all agents, extract type, and add to a HashSet.  */
    HashSet type_set = new HashSet();
    for (int i = 0; i < ids.size(); i++) {
   ...
   */
  public osid.shared.AgentIterator getGroups()
    throws osid.shared.SharedException {
   ...
   */
  public osid.shared.AgentIterator getGroupsByType(osid.shared.Type groupType)
    throws osid.shared.SharedException {
    /*  Iterate over all agents, extract type, and add to a HashSet.  */
  ...
  public void writeState() throws osid.shared.SharedException {
    try {
      FileOutputStream fout = new FileOutputStream(
        tufts.oki.shared.SharedManager.SERIALIZED_FILE_NAME
      );
  ...
  public void readState() throws osid.shared.SharedException {
    ...
    } else throw new osid.shared.SharedException(
