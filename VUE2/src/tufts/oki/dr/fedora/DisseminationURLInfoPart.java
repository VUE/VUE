...
/*
 * DisseminationURLInfoPart.java
 *
 * Created on March 7, 2004, 4:02 PM
 */
...
/*
 *  Asset only stores that url to retrieve the object.  That is sufficient to get the dissemination.
 *  Storing the complete binary of dissemination is un necessary. The url depends on parameters
 *
 */

public class DisseminationURLInfoPart implements osid.dr.InfoPart {
  ...
  private String displayName = "DisseminationURL";
  private String description = "An URL to get dissemination of Fedora Object";
  private osid.shared.Id id = null;
  private boolean populatedByDR = true;
  private boolean mandatory = true;
  private boolean repeatable = false;
  private osid.dr.InfoStructure infoStructure =
    (osid.dr.InfoStructure) disseminationInfoStructure;

  /** Creates a new instance of OutputInfoPart */
  public DisseminationURLInfoPart(osid.dr.InfoStructure infoStructure, DR dr)
    throws osid.dr.DigitalRepositoryException, osid.shared.SharedException {
    this.infoStructure = infoStructure;
    this.id =
      new PID(FedoraUtils.getFedoraProperty(dr, "DisseminationURLInfoPartId"));
  }
