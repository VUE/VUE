...
public class FedoraObject implements osid.dr.Asset {
  ...
  public FedoraObject(osid.shared.Id id, DR dr)
    throws osid.dr.DigitalRepositoryException {
    this(id);
    this.dr = dr;
  }

  public FedoraObject(DR dr, String displayName, osid.shared.Type assetType)
  ...
  public FedoraObject(
    ...
    if (
      !(assetType.getKeyword().equals("fedora:BDEF") ||
        assetType.getKeyword().equals("fedora:BMECH"))
    ) infoRecordVector =
      FedoraSoapFactory.getDissemintionInfoRecords(
        id,
        ((FedoraObjectAssetType) assetType).getDissemiationInfoStructure(),
        dr
      );
    infoRecordVector.add(
      VUEInfoStructure.createVUEInfoRecord(
        id,
        (VUEInfoStructure) ((FedoraObjectAssetType) assetType).getVUEInfoStructure(),
        dr,
        pid,
  ...
  public void copyInfoStructure(
    ...
    osid.shared.Id infoStructureId
  ) throws osid.dr.DigitalRepositoryException {
    throw new osid.dr.DigitalRepositoryException(
      osid.OsidException.UNIMPLEMENTED
    );
   ...
   */
  public osid.dr.InfoRecord createInfoRecord(osid.shared.Id infoStructureId)
    throws osid.dr.DigitalRepositoryException {
    throw new osid.dr.DigitalRepositoryException(
      osid.OsidException.UNIMPLEMENTED
    );
   ...
   *     @throws DigitalRepositoryException if there is a general failure
   */
  public osid.dr.InfoRecordIterator getInfoRecords()
    throws osid.dr.DigitalRepositoryException {
  ...
  public osid.dr.InfoRecordIterator getInfoRecords(
    ...
    for (int i = 0, size = infoRecordVector.size(); i < size; i++) {
      try {
        osid.dr.InfoRecord infoRecord =
          (osid.dr.InfoRecord) infoRecordVector.elementAt(i);
   ...
   *     @throws DigitalRepositoryException if there is a general failure
   */
  public void inheritInfoStructure(
    osid.shared.Id assetId,
    osid.shared.Id infoStructureId
  ) throws osid.dr.DigitalRepositoryException {
    throw new osid.dr.DigitalRepositoryException(
  ...
  public osid.dr.InfoField getInfoField(osid.shared.Id id)
    throws osid.dr.DigitalRepositoryException {
    ...
    while (i.hasNext()) {
      ...
      while (infoFieldIterator.hasNext()) {
        ...
        try {
          if (infoField.getId().isEqual(id)) return infoField;
  ...
  public osid.dr.InfoFieldIterator getInfoFieldByPart(osid.shared.Id id)
    throws osid.dr.DigitalRepositoryException {
    throw new osid.dr.DigitalRepositoryException(
      osid.OsidException.UNIMPLEMENTED
    );
  ...
  public java.io.Serializable getInfoFieldValue(osid.shared.Id id)
    throws osid.dr.DigitalRepositoryException {
    throw new osid.dr.DigitalRepositoryException(
      osid.OsidException.UNIMPLEMENTED
    );
  ...
  public osid.shared.SerializableObjectIterator getInfoFieldValueByPart(
    osid.shared.Id id
  ) throws osid.dr.DigitalRepositoryException {
    throw new osid.dr.DigitalRepositoryException(
      osid.OsidException.UNIMPLEMENTED
  ...
  public osid.dr.InfoRecord getInfoRecord(osid.shared.Id id)
    throws osid.dr.DigitalRepositoryException {
    Iterator i = infoRecordVector.iterator();
    while (i.hasNext()) {
      ...
      try {
        if (
          infoRecord.getId().getIdString().equals(id.getIdString())
        ) return infoRecord;
      } catch (osid.shared.SharedException ex) {
        throw new osid.dr.DigitalRepositoryException(ex.getMessage());
      }
  ...
  public osid.dr.InfoRecordIterator getInfoRecordsByInfoStructure(
    osid.shared.Id id
  ) throws osid.dr.DigitalRepositoryException {
    java.util.Vector result = new java.util.Vector();
    Iterator i = infoRecordVector.iterator();
  ...
  public void updateEffectiveDate(java.util.Calendar calendar)
    throws osid.dr.DigitalRepositoryException {
    throw new osid.dr.DigitalRepositoryException(
      osid.OsidException.UNIMPLEMENTED
    );
  ...
  public void updateExpirationDate(java.util.Calendar calendar)
    throws osid.dr.DigitalRepositoryException {
    throw new osid.dr.DigitalRepositoryException(
      osid.OsidException.UNIMPLEMENTED
    );
