...
public class InfoRecord implements osid.dr.InfoRecord {
   ...
   */
  public osid.dr.InfoField createInfoField(
    osid.shared.Id infoPartId,
    ...
    while (ipi.hasNext()) {
      ...
      try {
        if (infoPartId.isEqual(infoPart.getId())) {
          osid.dr.InfoField infoField = new InfoField(
            infoPartId,
            infoStructure,
            infoPart,
            value
    ...
    throw new osid.dr.DigitalRepositoryException(
      osid.dr.DigitalRepositoryException.UNKNOWN_ID
    );
  }
  ...
  public void deleteInfoField(osid.shared.Id infoFieldId)
    throws osid.dr.DigitalRepositoryException {
    throw new osid.dr.DigitalRepositoryException(
      "An info Record can't be deleted from FEDORA object"
    );
  }
  ...
  public osid.dr.InfoField getInfoField(osid.shared.Id infoPartId)
