...
public class DisseminationInfoStructure implements osid.dr.InfoStructure {
  ...
  private String description =
    "Provides information needed to get the dissemination";
  ...
  public DisseminationInfoStructure(DR dr)
    throws osid.shared.SharedException, osid.dr.DigitalRepositoryException {
    this.id =
      new PID(
        FedoraUtils.getFedoraProperty(dr, "DisseminationInfoStructureId")
      );
  ...
  public osid.dr.InfoPart getBDEFInfoPart()
    throws osid.dr.DigitalRepositoryException {
    if (this.BDEFInfoPart == null) throw new osid.dr.DigitalRepositoryException(
      "BDEF InfoPart doesn't exist"
    );
    return this.BDEFInfoPart;
  }

  public osid.dr.InfoPart getDisseminationURLInfoPart()
    throws osid.dr.DigitalRepositoryException {
    if (
      this.disseminationURLInfoPart == null
    ) throw new osid.dr.DigitalRepositoryException(
      "Dissemination URL InfoPart doesn't exist"
    );
    return this.disseminationURLInfoPart;
  }

  public osid.dr.InfoPart getParameterInfoPart()
    throws osid.dr.DigitalRepositoryException {
    if (
      this.parameterInfoPart == null
    ) throw new osid.dr.DigitalRepositoryException(
      "Parameter InfoPart doesn't exist"
    );
