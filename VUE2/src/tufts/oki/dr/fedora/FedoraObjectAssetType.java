...
public class FedoraObjectAssetType extends osid.shared.Type {
  ...
  public FedoraObjectAssetType(DR dr, String type)
  ...
  public osid.dr.InfoStructure getDissemiationInfoStructure()
    throws osid.dr.DigitalRepositoryException {
    if (
      this.disseminationInfoStructure == null
    ) throw new osid.dr.DigitalRepositoryException(
      "Dissemination InfoStructure doesn't exist"
    );
    return this.disseminationInfoStructure;
  }

  public osid.dr.InfoStructure getVUEInfoStructure()
    throws osid.dr.DigitalRepositoryException {
    if (
      this.sVUEInfoStructure == null
    ) throw new osid.dr.DigitalRepositoryException(
      "VUE InfoStructure doesn't exist"
    );
  ...
  private void loadInfoStructures() throws osid.dr.DigitalRepositoryException {
    try {
      ...
      throw new osid.dr.DigitalRepositoryException(
        "FedoraObjecAssetType.loadInfoStructure  " + ex
      );
    }
  }
