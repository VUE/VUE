...
/*
 * VUEDefaultViewInfoPart.java
 *
 * Created on March 24, 2004, 8:28 PM
 */
 ...
 * @author  akumar03
 */
public class VUEDefaultViewInfoPart implements osid.dr.InfoPart {
  ...
  private String displayName = "VUEDefaultViewInfoPart";
  ...
  public VUEDefaultViewInfoPart(osid.dr.InfoStructure infoStructure, DR dr)
    throws osid.dr.DigitalRepositoryException, osid.shared.SharedException {
    this.infoStructure = infoStructure;
    this.id =
      new PID(FedoraUtils.getFedoraProperty(dr, "VUEDefaultViewInfoPartId"));
  }
