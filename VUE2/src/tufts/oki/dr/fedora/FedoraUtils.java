...
public class FedoraUtils {
  ...
  public static Preferences getDefaultPreferences(URL url)
    ...
    System.out.println(
      "*** " + clazz.getName() + ".getPreferences: node=" + prefs
    );
    System.out.println(
      "*** " +
      clazz.getName() +
      ".getPreferences: loading & caching prefs from \"" +
      url +
      "\""
    );
  ...
  public static String[] getAdvancedSearchFields(DR dr)
    throws osid.dr.DigitalRepositoryException {
    return getFedoraPropertyArray(dr, "fedora.search.advanced.fields");
  }

  public static String[] getAdvancedSearchOperators(DR dr)
    throws osid.dr.DigitalRepositoryException {
  ...
  public static String getAdvancedSearchOperatorsActuals(
    ...
    String[] pOperatorsActuals = getFedoraPropertyArray(
      dr,
  ...
  public static String getSaveFileName(
    osid.shared.Id objectId,
    osid.shared.Id behaviorId,
    osid.shared.Id disseminationId
        ...
        public void actionPerformed(java.awt.event.ActionEvent actionEvent) {
          try {
            ...
            String fedoraUrl = mInfoRecord
              .getInfoField(
                new PID(getFedoraProperty(mDR, "DisseminationURLInfoPartId"))
              )
              .getValue()
              .toString();
