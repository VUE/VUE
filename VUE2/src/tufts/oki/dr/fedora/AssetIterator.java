...
/**
    ...
    */
public class AssetIterator implements osid.dr.AssetIterator {
  ...
  /**
        ...
        */
  public osid.dr.Asset next() throws osid.dr.DigitalRepositoryException {
    if (i >= vector.size()) {
      throw new osid.dr.DigitalRepositoryException(
        osid.dr.DigitalRepositoryException.NO_MORE_ITERATOR_ELEMENTS
      );
    }
