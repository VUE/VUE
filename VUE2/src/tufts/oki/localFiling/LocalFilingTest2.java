...
public class LocalFilingTest2 {
  ...
  public static void test1()
    throws java.io.IOException, osid.filing.FilingException, osid.shared.SharedException {
    ...
    if (entry.isCabinet()) {
      ...
      while (it.hasNext()) System.out.write(it.next());
      ...
      LocalByteStore newStore = (LocalByteStore) parent.createByteStore(
        absolute
      );
