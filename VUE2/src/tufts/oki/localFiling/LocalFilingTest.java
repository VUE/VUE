...
public class LocalFilingTest {
  ...
  private static LocalFilingManager lm = null; //  The local filing manager.
  ...
  public static void printFilesInCurrent()
    throws java.io.IOException, osid.filing.FilingException {
    osid.filing.CabinetEntryIterator it = lm.list();
    System.out.println(
      "Entries in " + (lm.getWorkingDirectory()).getFullName()
    );
    while (it.hasNext()) {
      ...
      } else System.out.println("\tUnknown entry type.");
    }
  }
  ...
  public static void test0()
    ...
    System.out.println(
      "Current working directory is: " + cwd.getRootBase() + cwd.getFullName()
    );
  }
  ...
  public static void test1()
    ...
    System.out.println(
      "Root base via getRoot(): " + lm.getRoot().getRootBase()
    );
  ...
  public static void test2()
    throws java.io.IOException, osid.filing.FilingException, osid.shared.SharedException, osid.OsidException {
  ...
  public static void test3()
    ...
    System.out.println(
      "reassembled test path: " + lm.implodePath(parts, test.separator)
    );
  ...
  public static void test4()
    ...
    System.out.println(
      "Root path via getRoot().getFullName(): " + root.getFullName()
    );
    printFilesInCurrent();
    System.out.flush();
    ...
    System.out.println(
      "Current dir:  " + lm.getWorkingDirectory().getFullName()
    );
    printFilesInCurrent();
    System.out.flush();
  ...
  public static void test5()
    ...
    System.out.println("Root path via getRootPath(): " + lm.getRootPath());
    System.out.println(
      "Root path via getRoot().getFullName(): " + lm.getRoot().getFullName()
    );
    System.out.println(
      "Current working directory: " + lm.getWorkingDirectory().getFullName()
    );
    printFilesInCurrent();
