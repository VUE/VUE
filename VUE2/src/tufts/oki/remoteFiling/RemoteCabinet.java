 ...
 *
 */
public class RemoteCabinet
  extends RemoteCabinetEntry
  ...
  public RemoteCabinet(
    ...
    if (parent == null) updateDisplayName(""); else updateDisplayName(
      displayName
    );
  }
  ...
  public osid.filing.Cabinet createCabinet(String displayName)
    ...
    try {
      ...
      if (
        !client.makeDirectory(entry.getFullName())
      ) throw new osid.filing.FilingException(
   ...
   */
  public osid.filing.CabinetEntryIterator entries()
    throws osid.filing.FilingException {
    ...
    return (osid.filing.CabinetEntryIterator) new RemoteCabinetEntryIterator(
      children
    );
  }
  ...
  public osid.filing.Cabinet getRootCabinet()
    ...
    while (cab.getParent() != null) cab = cab.getParent();
    return cab;
  }
  ...
  public void rename(String newName) throws osid.filing.FilingException {
    ...
    try {
      FTPClient client = rc.getClient();
      if (getParent() == null) client.rename(
        getFullName(),
        rc.getRootBase() + "/" + newName
      ); else client.rename(
        getFullName(),
        ((RemoteCabinet) getParent()).getFullName() + "/" + newName
      );
    } catch (java.io.IOException ex) {
      throw new osid.filing.FilingException(
        osid.filing.FilingException.IO_ERROR
