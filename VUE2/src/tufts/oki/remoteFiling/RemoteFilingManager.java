 ...
 *
 */
public class RemoteFilingManager
   ...
   *  @author Mark Norton
   */
  public void createClient(String host, String username, String password)
    throws osid.filing.FilingException {
    try {
      RemoteClient rc = new RemoteClient(host, username, password);
      FTPClient client = rc.getClient();
      tufts.oki.shared.Agent agent = new tufts.oki.shared.Agent(
        username,
  ...
  public osid.filing.CabinetEntryIterator listRoots()
    ...
    osid.filing.CabinetEntryIterator it =
      (osid.filing.CabinetEntryIterator) new RemoteCabinetEntryIterator(vect);
    return it;
  }
  ...
  public void setWorkingDirectory(RemoteCabinet cabinet)
    throws osid.filing.FilingException {
    throw new osid.filing.FilingException(
      osid.filing.FilingException.UNSUPPORTED_OPERATION
    );
    /**
        cwd = cabinet;
