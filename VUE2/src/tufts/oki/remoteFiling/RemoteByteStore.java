 ...
 *
 */
public class RemoteByteStore
  extends RemoteCabinetEntry
  implements osid.filing.ByteStore {

  protected static final FTPFileListParser __fileListParser =
    new DefaultFTPFileListParser();
  ...
  public String getMimeType() throws osid.filing.FilingException {
    ...
    if (mimeType != null) return mimeType; else return "text/plain";
  }
  ...
  public byte[] getBytes() throws osid.filing.FilingException {
    ...
    long trueLen = length();
    if (
      trueLen > (long) Integer.MAX_VALUE
  ...
  public osid.shared.ByteValueIterator read(java.util.Calendar version)
    ...
    osid.shared.ByteValueIterator it =
      (osid.shared.ByteValueIterator) new ByteValueIterator(buf);
    return it;
  }
   ...
   *  @author Mark Norton
   */
  public void writeBytesAtOffset(byte[] b, int off, int len)
    throws osid.filing.FilingException {
    throw new osid.filing.FilingException(
      osid.filing.FilingException.UNIMPLEMENTED
    );
