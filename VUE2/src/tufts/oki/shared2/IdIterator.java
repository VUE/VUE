 ...
 *
 */
public class IdIterator implements org.osid.shared.IdIterator {
     ...
     */
    public org.osid.shared.Id nextId() {
        org.osid.shared.Id id = (org.osid.shared.Id) id_vector.elementAt(offset);
        offset++;
        return id;
    }
