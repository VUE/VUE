...
public class AgentPersonType extends org.osid.shared.Type {
  ...
  public static final String AGENT_PERSON_TYPE_KEY =
    "org.osid.agent.Agent.Person";

  /** Creates a new instance of AgentPersonType */
  public AgentPersonType() {
    super(
      "org.osid.agent",
      OsidManager.AUTHORITY,
      AGENT_PERSON_TYPE_KEY,
      "This is a person agent as implemented by org.osid.agent.Agent."
    );
  }
}
