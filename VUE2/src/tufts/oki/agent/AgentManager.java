...
public class AgentManager implements org.osid.agent.AgentManager {
  ...
  public static final String SERIALIZED_FILE_NAME =
    "c:/java/serialized/org_osid_agent_manager.sid";
   ...
   */
  public org.osid.agent.Agent createAgent(
    String name,
    org.osid.shared.Type agentType,
    org.osid.shared.Properties props
   ...
   */
  public org.osid.agent.Group createGroup(
    String name,
    org.osid.shared.Type groupType,
    String description,
    org.osid.shared.Properties props
  ) throws org.osid.agent.AgentException {
   ...
   *  @author Mark Norton
   */
  public void deleteAgent(org.osid.shared.Id id)
    throws org.osid.agent.AgentException {
   ...
   *  @author Mark Norton
   */
  public void deleteGroup(org.osid.shared.Id id)
    throws org.osid.agent.AgentException {
   ...
   */
  public org.osid.agent.Agent getAgent(String name)
    throws org.osid.agent.AgentException {
    for (int i = 0; i < agents.size(); i++) {
      org.osid.agent.Agent agent = (Agent) agents.elementAt(i);
      if (agent.getDisplayName().compareTo(name) == 0) return agent;
    }
   ...
   */
  public org.osid.shared.TypeIterator getAgentTypes()
    throws org.osid.agent.AgentException {
    ...
    org.osid.shared.TypeIterator it = new tufts.oki.shared2.TypeIterator(
      type_vector
    );
    return it;
  }
   ...
   */
  public org.osid.agent.AgentIterator getAgentsByType(
    org.osid.shared.Type agentType
  ) throws org.osid.agent.AgentException {
    /*  Iterate over all agents, extract type, and add to a HashSet.  */
    ...
    for (int i = 0; i < ids.size(); i++) {
      Agent agent = (Agent) agents.elementAt(i);
      org.osid.shared.Type type = agent.getType();
      if (type.isEqual(agentType)) agent_set.add(agent);
    }
   ...
   */
  public org.osid.agent.Group getGroup(org.osid.shared.Id id)
    throws org.osid.agent.AgentException {
    try {
      for (int i = 0; i < ids.size(); i++) {
        org.osid.agent.Group group = (Group) groups.elementAt(i);
        if ((group.getId()).isEqual(id)) return group;
      }
    } catch (Throwable t) {
      throw new org.osid.agent.AgentException(t.getMessage());
    }
   ...
   */
  public org.osid.shared.TypeIterator getGroupTypes()
    throws org.osid.agent.AgentException {
    /*  Iterate over all agents, extract type, and add to a HashSet.  */
    HashSet type_set = new HashSet();
    for (int i = 0; i < ids.size(); i++) {
   ...
   */
  public org.osid.agent.AgentIterator getGroups()
    throws org.osid.agent.AgentException {
   ...
   */
  public org.osid.agent.AgentIterator getGroupsByType(
    org.osid.shared.Type groupType
  ) throws org.osid.agent.AgentException {
    /*  Iterate over all agents, extract type, and add to a HashSet.  */
    ...
    for (int i = 0; i < ids.size(); i++) {
      Group group = (Group) groups.elementAt(i);
      org.osid.shared.Type type = group.getType();
      if (type.isEqual(groupType)) group_set.add(group);
    }
  ...
  public org.osid.agent.AgentIterator getAgentsBySearch(
    java.io.Serializable criteria,
  ...
  public org.osid.shared.TypeIterator getGroupSearchTypes()
    throws org.osid.agent.AgentException {
    throw new org.osid.agent.AgentException(
      org.osid.OsidException.UNIMPLEMENTED
    );
  ...
  public void writeState() throws org.osid.agent.AgentException {
    try {
      ...
      throw new org.osid.agent.AgentException(
        "I/O error on writing state data out of SharedManager."
      );
    }
  }
  ...
  public void readState() throws org.osid.agent.AgentException {
    if (this.isEmpty()) {
      ...
      try {
        ...
        throw new org.osid.agent.AgentException(
          "SharedManager exception: " + ex2.getMessage()
        );
      } catch (java.lang.ClassNotFoundException ex4) {
        throw new org.osid.agent.AgentException(
          "Class not found error on reading state data into SharedManager."
        );
      }
    } else throw new org.osid.agent.AgentException(
      "Attempt to read state into an modified SharedManager."
    );
  }
