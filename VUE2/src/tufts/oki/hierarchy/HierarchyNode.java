...
public class HierarchyNode implements osid.hierarchy.Node {
  ...
  public osid.hierarchy.NodeIterator getChildren()
    throws osid.hierarchy.HierarchyException {
    if (treeNode == null) throw new osid.hierarchy.HierarchyException(
      "tree node is null"
    );
    ...
    for (Enumeration e = treeNode.children(); e.hasMoreElements();) {
      ...
      children.addElement(
        (osid.hierarchy.Node) (childTreeNode.getUserObject())
      );
    }
  ...
  public void updateDisplayName(java.lang.String name)
    throws osid.hierarchy.HierarchyException {
    if (name == null) throw new osid.hierarchy.HierarchyException(
  ...
  public void updateDescription(java.lang.String description)
    throws osid.hierarchy.HierarchyException {
    if (description == null) throw new osid.hierarchy.HierarchyException(
      "description is null"
    );
  ...
  public osid.hierarchy.NodeIterator getParents()
    throws osid.hierarchy.HierarchyException {
    if (treeNode == null) throw new osid.hierarchy.HierarchyException(
      "tree node is null"
    );
    ...
    if (parentTreeNode != null) parents.addElement(
      (osid.hierarchy.Node) (parentTreeNode.getUserObject())
    );
  ...
  public void setType(osid.shared.Type type)
    throws osid.hierarchy.HierarchyException {
    this.type = type;
  }
  ...
  public void removeParent(osid.shared.Id nodeId)
    throws osid.hierarchy.HierarchyException {
    //unimplemented
  }

  /**A method that changes a parent to another parent*/
  public void changeParent(osid.shared.Id first, osid.shared.Id second)
    throws osid.hierarchy.HierarchyException {
    //unimplemented
  }
  ...
  public void changeLWComponentLabel(String label)
    throws osid.hierarchy.HierarchyException {
