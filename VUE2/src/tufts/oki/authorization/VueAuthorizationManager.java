 ...
 * @author  Mark Norton
 */
public class VueAuthorizationManager extends tufts.oki.OsidManager implements osid.authorization.AuthorizationManager {
     ...
     */
    public VueAuthorizationManager() {
        super();
     ...
     *  due to the need of resolving agent instances versus their Id's.
     */
    public VueAuthorizationManager(osid.OsidOwner owner, osid.shared.Agent user, osid.shared.SharedManager sharedMgr) {
        super(owner);
        this.user = user;
        this.auths = new Vector(100);
        this.functions = new Vector(100);
