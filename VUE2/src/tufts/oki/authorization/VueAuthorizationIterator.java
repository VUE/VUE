 ...
 * @author  Mark Norton
 */
public class VueAuthorizationIterator
  implements osid.authorization.AuthorizationIterator {
  ...
  public osid.authorization.Authorization next() {
    osid.authorization.Authorization auth =
      (osid.authorization.Authorization) authorization_vector.elementAt(offset);
    offset++;
    return auth;
  }
}
