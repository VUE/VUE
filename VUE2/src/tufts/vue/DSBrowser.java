...
public class DSBrowser extends ContentBrowser {
  ...
  private static final org.apache.log4j.Logger Log =
    org.apache.log4j.Logger.getLogger(DSBrowser.class);

  public static DockWindow dockWindow = null;
  protected Widget librariesPane = new Widget(
    VueResources.getString("dockWindow.contentPanel.datasets.title")
  );
  protected AssociationsPane associationsPane = new AssociationsPane();
  protected Widget browsePane = new Widget(
  ...
  public DSBrowser(DockWindow dw) {
    ...
    Widget.setHelpAction(
      librariesPane,
      VueResources.getString("dockWindow.Datasources.libraryPane.helpText")
    );
  ...
  public DataSource addDataset() {
    ...
    try {
      ...
      xml =
        xml.replaceFirst("DEFAULT_ADDRESS", (address != null ? address : ""));
  ...
  protected void refreshMenuActions() {
    boolean datasetSelected =
      (dataSetViewer.dataSourceList.getSelectedValue() != null);
  ...
  public AbstractAction editLibraryAction = new AbstractAction(
    ...
    public void actionPerformed(ActionEvent event) {
      DataSource ds =
        (DataSource) DataSetViewer.dataSourceList.getSelectedValue();
