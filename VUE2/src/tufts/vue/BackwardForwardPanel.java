...
public class BackwardForwardPanel extends JPanel {
  ...
  public BackwardForwardPanel() {
    ...
    VueButton backwardButton = createButton(
      Actions.ViewBackward,
      VueResources.getIcon("Back.raw")
    ), forwardButton = createButton(
      Actions.ViewForward,
      VueResources.getIcon("Forward.raw")
    );
  ...
  protected VueButton createButton(Action action, Icon icon) {
    ...
    Dimension buttonSize = new Dimension(
      installedIcon.getIconWidth(),
      installedIcon.getIconHeight()
    );
