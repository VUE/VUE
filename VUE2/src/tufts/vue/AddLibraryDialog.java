...
public class AddLibraryDialog extends SizeRestrictedDialog implements ListSelectionListener, ActionListener {
    ...
    public AddLibraryDialog(DataSourceList dataSourceList) {
        ...
        try {
            ...
            t.printStackTrace();
            VueUtil.alert(this, VueResources.getString("dialog.error.message"),
        ...
        if (index != -1) {
            try {
                if (((JList) lse.getSource()).getSelectedValue() instanceof String) {
                    ...
                    org.osid.provider.Provider p = (org.osid.provider.Provider) (((JList) lse.getSource())
                            .getSelectedValue());
            ...
            if (o instanceof String) {
                ...
                if (s.equals(MY_COMPUTER)) {
                   ...
                   */else if (s.equals(DS_FTP)) {
                    ...
                    if (username == null)
                        username = RemoteFileDataSource.ANONYMOUS;
                ...
                try {
                    ...
                    if (proceed && (!provider.isInstalled())) {
                        ...
                        try {
                            ...
                            VueUtil.alert(this, VueResources.getString("dialog.installerror.messaged"),
                                    VueResources.getString("dialog.error.title"));
                            // cancelButton.requestFocus();
                            SwingUtilities.invokeLater(new Runnable() {
                                public void run() {
                    ...
                    if (proceed) {
                        ...
                        try {
                            ...
                            VueUtil.alert(this, VueResources.getString("dialog.loadfailed.message"),
                                    VueResources.getString("dialog.error.title"));
                            return;
                        }
                    ...
                    if (s != null) {
                        if (s.equals(MY_COMPUTER)) {
                            ...
                            try {
                                ...
                                proceed = false;
                                VueUtil.alert(VueResources.getString("dialog.connectftp.message"),
                        ...
                        try {
                            ...
                            proceed = false;
                            VueUtil.alert(this, VueResources.getString("dialog.addresourceerror.message"),
