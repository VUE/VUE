...
public class RichTextBox
  extends com.lightdev.app.shtm.SHTMLEditorPane
  implements
    VueConstants,
    FocusListener,
    KeyListener,
  ...
  public void addNotify() {
    ...
    this.setSize(
        new Dimension((int) getScaledWidth(), (int) getScaledHeight())
      );
  ...
  public void setText(String text) {
    ...
    ////     setSize(getPreferredSize());
    //
    if (lwc.getParent() != null) lwc.getParent().layoutChildren();
    //setSize(getPreferredSize());
  ...
  public void focusLost(FocusEvent e) {
    ...
    if (opposite != null) {
      if (
        (opposite.getName() != null &&
          opposite.getName().equals(FontEditorPanel.SIZE_FIELD_NAME)) ||
        opposite.getClass() == ColorMenuButton.class
      ) return; else if (
        opposite.getClass() == FontEditorPanel.class ||
        ...
        (opposite.getName() != null &&
          opposite
            .getName()
            .equals(tufts.vue.gui.ColorMenuButton.COLOR_POPUP_NAME)) ||
      ...
      if (DEBUG.FOCUS) outc("Focus not lost because opposite component = null");
      requestFocus();
      return;
    }
    ...
    if (TestDebug || DEBUG.FOCUS) outc(
      "focusLost to " + e.getOppositeComponent() + "   " + opposite.getName()
    );
    ...
    if (lwc.getParent() != null && lwc.getParent() instanceof LWNode) lwc
      .getParent()
      .layout();
    lwc.notify(this, LWKey.Repaint);
  }
...
*/
  ...
  public Dimension getPreferredSize() {
    ...
    if (mBounds.width > 0) {
      ...
      Style style =
        ((HTMLDocument) getDocument()).getStyleSheet().getStyle("body");
      Object a = style.getAttribute(
        javax.swing.text.html.CSS.Attribute.FONT_SIZE
      );

      if (a != null) {
        if (DEBUG.TEXT) out("got style");
        int diff = 0;
        Integer i = new Integer(a.toString());
        diff = i.intValue();
        //minS.height = minS.height - diff;
        if (VUE.getActiveViewer() != null) {
          ...
          double zoom = 1.0;
          if (parent != null) zoom =
            ((MapViewer) parent).getZoomFactor(); else {
      ...
      if (position != null) {
        ...
        s =
          new Dimension(
            (int) (mBounds.width > mins2 ? mBounds.width : mins2),
            (int) height
          );
      } else {
        float minSpan = ui.getMinimumSpan(View.X_AXIS);
        s =
          new Dimension(
            (int) (mBounds.width > minSpan ? mBounds.width : minSpan),
            (int) height
          );
      }
    ...
    if (
      this.getBoxBounds() != null && s.height < this.getBoxBounds().getHeight()
    ) {
      s.height = (int) this.getBoxBounds().getHeight();
    }
    ...
    if (a != null) {
      ...
      if (VUE.getActiveViewer() != null) {
        ...
        if (parent != null) {
          ...
          if (VUE.getActiveViewer() != null) diff *=
          VUE.getActiveViewer().getZoomFactor();
...
*/
  ...
  public void paintComponent(Graphics g) {
    ...
    if (true) {
      ...
      g.drawRect(
        -xpad,
        -ypad,
        (int) ((getWidth()) + xpad * 2 - 1),
        (int) ((getHeight()) + ypad * 2 - 1)
      );
    }
  }
  ...
  private String stripHTMLTags(String message) {
    ...
    return org.apache.commons.lang.StringEscapeUtils.unescapeHtml(
      returnMessage.toString().trim()
    );
  }
