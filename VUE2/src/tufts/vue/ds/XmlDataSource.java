...
public class XmlDataSource extends BrowseDataSource {
  ...
  private static final org.apache.log4j.Logger Log =
    org.apache.log4j.Logger.getLogger(XmlDataSource.class);
  ...
  public XmlDataSource(String displayName, String address)
  ...
  public void setConfiguration(java.util.Properties p) {
    ...
    String val = null;
    try {
      if ((val = p.getProperty(ITEM_PATH_KEY)) != null) setItemKey(val);
    } catch (Throwable t) {
      Log.error("val=" + val, t);
    }
    try {
      if ((val = p.getProperty(KEY_FIELD_KEY)) != null) setKeyField(val);
    } catch (Throwable t) {
      Log.error("val=" + val, t);
    }
    try {
      if ((val = p.getProperty(ENCODING_FIELD_KEY)) != null) setEncodingField(
        val
      );
    } catch (Throwable t) {
      Log.error("val=" + val, t);
    ...
    try {
      if ((val = p.getProperty(MATRIX_FIELD_KEY)) != null) setMatrixField(val);
    } catch (Throwable t) {
      Log.error("val=" + val, t);
    }
    try {
      if ((val = p.getProperty(IMAGE_FIELD_KEY)) != null) setImageField(val);
    } catch (Throwable t) {
      Log.error("val=" + val, t);
    }
    try {
      if ((val = p.getProperty(MATRIX_ROW_KEY)) != null) setMatrixRowField(val);
    } catch (Throwable t) {
      Log.error("val=" + val, t);
    }
    try {
      if ((val = p.getProperty(MATRIX_COL_KEY)) != null) setMatrixColField(val);
    } catch (Throwable t) {
      Log.error("val=" + val, t);
    }
    try {
      if ((val = p.getProperty(MATRIX_FORMAT_KEY)) != null) setMatrixColField(
        val
      );
    } catch (Throwable t) {
      Log.error("val=" + val, t);
    ...
    try {
      if ((val = p.getProperty(MATRIX_PIVOT_KEY)) != null) setMatrixPivotField(
        val
      );
    } catch (Throwable t) {
      Log.error("val=" + val, t);
    ...
    try {
      if (
        (val = p.getProperty(MATRIX_STARTROW_KEY)) != null
      ) setMatrixStartRowField(val);
    } catch (Throwable t) {
      Log.error("val=" + val, t);
    }
    try {
      if ((val = p.getProperty(MATRIX_RELATION_KEY)) != null) setMatrixRelField(
        val
      );
    } catch (Throwable t) {
      Log.error("val=" + val, t);
    ...
    try {
      if (
        (val = p.getProperty(MATRIX_MATRIXSIZE_KEY)) != null
    ...
    try {
      if (
        (val = p.getProperty(MATRIX_IGNORE_KEY)) != null
    ...
    try {
      if (
        (val = p.getProperty(MATRIX_RELPROCESS_KEY)) != null
  ...
  public void setImageField(String name) {
    if (NONE_SELECTED.equals(name)) imageField =
      NONE_SELECTED; else imageField = name;
    unloadViewer();
  }
  ...
  public String getEncodingField() {
    if (
      encodingField.equals("(auto detect)")
    ) return "windows-1252"; else return encodingField;
  }
  ...
  public void setKeyField(String k) {
    ...
    if (k != null) {
      k = k.trim();
      if (k.length() < 1) keyField = null; else keyField = k;
    } else {
      keyField = null;
    }
    unloadViewer();
  ...
  public void setEncodingField(String k) {
    ...
    if (k != null) {
      k = k.trim();
      if (k.length() < 1) encodingField = null; else encodingField = k;
    } else {
      encodingField = null;
    }
    unloadViewer();
  ...
  public void setMatrixField(String k) {
    ...
    if (k != null) {
      k = k.trim();
      if (k.length() < 1) matrixField = null; else matrixField = k;
    } else {
      matrixField = null;
    }
    unloadViewer();
  ...
  public void setMatrixColField(String k) {
    ...
    if (k != null) {
      k = k.trim();
      if (k.length() < 1) matrixColField = null; else matrixColField = k;
    } else {
      matrixColField = null;
    }
    //  unloadViewer();
  ...
  public void setMatrixRelProcessField(String k) {
    ...
    if (k != null) {
      k = k.trim();
      if (k.length() < 1) matrixRelProcessField =
        null; else matrixRelProcessField = k;
    } else {
  ...
  public void setMatrixFormatField(String k) {
    ...
    if (k != null) {
      k = k.trim();
      if (k.length() < 1) matrixFormatField = null; else matrixFormatField = k;
    } else {
  ...
  public void setMatrixIgnoreField(String k) {
    ...
    if (k != null) {
      k = k.trim();
      if (k.length() < 1) matrixIgnoreField = null; else matrixIgnoreField = k;
    } else {
  ...
  public void setMatrixPivotField(String k) {
    ...
    if (k != null) {
      k = k.trim();
      if (k.length() < 1) matrixPivotField = null; else matrixPivotField = k;
    } else {
  ...
  public void setMatrixSizeField(String k) {
    ...
    if (k != null) {
      k = k.trim();
      if (k.length() < 1) matrixSizeField = null; else matrixSizeField = k;
    } else {
  ...
  public void setMatrixStartRowField(String k) {
    ...
    if (k != null) {
      k = k.trim();
      if (k.length() < 1) matrixStartRowField = null; else matrixStartRowField =
        k;
    } else {
  ...
  public void setMatrixRelField(String k) {
    ...
    if (k != null) {
      k = k.trim();
      if (k.length() < 1) matrixRelField = null; else matrixRelField = k;
    } else {
      matrixRelField = null;
    }
    //    unloadViewer();
  ...
  public void setMatrixRowField(String k) {
    ...
    if (k != null) {
      k = k.trim();
      if (k.length() < 1) matrixRowField = null; else matrixRowField = k;
    } else {
      matrixRowField = null;
    }
    //  unloadViewer();
  ...
  public java.util.List<ConfigField> getConfigurationUIFields() {
    ConfigField path = new ConfigField(
      ITEM_PATH_KEY,
      "Item Path",
      "XML node path of interest",
      getItemKey()
    ); // current value is inserted here

    String keyFieldName = getKeyField();
    Vector possibleKeyFieldValues = null;

    if (mSchema != null) {
      if (keyFieldName == null) keyFieldName = mSchema.getKeyField().getName();
      possibleKeyFieldValues = mSchema.getPossibleKeyFieldNames();
    }

    ConfigField keyField = new ConfigField(
      KEY_FIELD_KEY,
      "Key Field",
    ...
    ConfigField imageField = new ConfigField(
      IMAGE_FIELD_KEY,
      "Image/Content Field",
    ...
    ConfigField encodingField = new ConfigField(
      ENCODING_FIELD_KEY,
      "Read as",
    ...
    if (!isCSV) fields.add(path);
    fields.add(keyField);
    fields.add(imageField);

    if (isCSV) fields.add(encodingField);

    List<ConfigField> mFields = null;
    if (this.getMatrixField().equals("true")) {
      if (this.getMatrixFormatField().equals(TALL)) mFields =
        this.getMatrixConfigurationUIFields(headerValues); else mFields =
        this.getWideMatrixConfigurationUIFields(headerValues);
  ...
  public Schema ingestCSV(Schema schema, String file, boolean hasColumnTitles)
    ...
    final CSVReader dataStream = new CSVReader(
      new InputStreamReader(new FileInputStream(file), this.getEncodingField())
    );
    ...
    if (schema == null) {
      ...
      schema =
        Schema.getNewAuthorityInstance(
    ...
    if (values == null) throw new IOException(file + ": empty file?");
    ...
    if (values == null) throw new IOException(
      file + ": has column names, but no data"
    );
  ...
  public Schema ingestMatrixCSV(
    ...
    if (hasColumnTitles) {
      if (isMatrixDataset) {
        ...
        if (this.matrixFormatField.equals(NONE_SELECTED)) {
          ...
          if (n == 0) this.setMatrixFormatField(
              WIDE
            ); else this.setMatrixFormatField(TALL);
        } //matrix format

        if (
          this.matrixFormatField.equals(TALL) &&
          ...
          ConfigurationUI cui = new edu.tufts.vue.ui.ConfigurationUI(
            new java.io.ByteArrayInputStream(params.xml.getBytes()),
            params.extraValuesByKey
          );
          cui.setPreferredSize(
            new Dimension(350, (int) cui.getPreferredSize().getHeight())
          );
          ...
          this.matrixFormatField.equals(WIDE) &&
          (this.matrixPivotField.equals(NONE_SELECTED))
        ) {
          ...
          cui.setPreferredSize(
            new Dimension(450, (int) cui.getPreferredSize().getHeight())
          );
    ...
    do {
      if (this.matrixFormatField.equals(TALL)) schema.addMatrixRow(
        this,
        values
      ); else schema.addWideMatrixRow(this, values);
    } while ((values = readLine(dataStream)) != null);

    if (this.matrixFormatField.equals(WIDE)) schema.convertToRows();
  ...
  private UIParams getXMLforWideMatrix(String[] values) {
    ...
    final java.util.Map<String, Vector> extraValuesMap =
      new java.util.HashMap();
    for (ConfigField f : getWideMatrixConfigurationUIFields(values)) {
      EditLibraryPanel.addField(
        b,
        f.key,
        f.title,
        f.description,
      ...
      if (f.values != null) extraValuesMap.put(f.key, f.values);
    }
  ...
  private java.util.List<ConfigField> getWideMatrixConfigurationUIFields(
    String[] values
  ) {
    java.util.List<ConfigField> fields = new ArrayList<ConfigField>();

    ConfigField field1 = new ConfigField(
      MATRIX_PIVOT_KEY,
...
//        field2.values = new Vector(l);
    	...
    	fields.add(field2);
*/
    ConfigField field3 = new ConfigField(
      MATRIX_MATRIXSIZE_KEY,
    ...
    ConfigField field4 = new ConfigField(
      MATRIX_IGNORE_KEY,
    ...
    ConfigField field5 = new ConfigField(
      MATRIX_RELPROCESS_KEY,
  ...
  private java.util.List<ConfigField> getMatrixConfigurationUIFields(
    String[] values
  ) {
    java.util.List<ConfigField> fields = new ArrayList<ConfigField>();
    ...
    ConfigField field2 = new ConfigField(
      MATRIX_COL_KEY,
  ...
  private JComponent loadContentAndBuildViewer() throws java.io.IOException {
    ...
    if (getAddress().toLowerCase().endsWith(".csv")) {
      ...
      if (getMatrixField().equals("true")) schema =
        ingestMatrixCSV(mSchema, getAddress(), true); else schema =
        ingestCSV(mSchema, getAddress(), true);
      mSchema = schema;
      isCSV = true;
    } else {
      ...
      schema =
        XMLIngest.ingestXML((XmlSchema) mSchema, openInput(), getItemKey());
      newIngest = true;
    ...
    if (getKeyField() != null) mSchema.setKeyField(getKeyField());

    if (getEncodingField() != null) mSchema.setEncodingField(
      getEncodingField()
    );
    ...
    if (newIngest) schema.notifyAllRowsAdded();
  ...
  private static void updateAllRuntimeSchemaReferences(
  ...
  private JComponent buildOldStyleTree(Schema schema) {
    ...
    for (DataRow row : schema.getRows()) {
      ...
      if (thumb != null) ((URLResource) r).setURL_Thumb(thumb);
      ...
      for (Map.Entry e : row.dataEntries()) r.addProperty(
        e.getKey().toString(),
        e.getValue().toString()
      );
    ...
    if (mItems.size() == 0) throw new DataSourceException("[Empty XML feed]");
