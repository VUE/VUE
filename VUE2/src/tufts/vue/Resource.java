...
public abstract class Resource implements Cloneable
{
    ...
    public static class DefaultFactory implements Factory {
        ...
        // HO 16/07/2010 BEGIN *****************
        public Resource get(java.net.URI mapURI, java.net.URI componentURI) {
        	return postProcess(WormholeResource.create(mapURI, componentURI), mapURI);
        }
        // HO 16/07/2010 END ********************
        // HO 11/08/2010 BEGIN *****************
    ...
    // HO 16/07/2010 BEGIN **********************
    public static Resource instance(java.net.URI mapURI, java.net.URI componentURI) {return getFactory().get(mapURI, componentURI); }
    // HO 16/07/2010 END **********************
