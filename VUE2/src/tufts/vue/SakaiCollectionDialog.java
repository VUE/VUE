...
public class SakaiCollectionDialog
  ...
  private org.osid.shared.Type _collectionAssetType =
    new edu.tufts.vue.util.Type("sakaiproject.org", "asset", "siteCollection");
  private org.osid.shared.Type _sakaiRepositoryType =
    ...
    try {
      ...
      for (int i = 0; i < dataSources.length; i++) {
        ...
        while (assetIterator.hasNextAsset()) {
          ...
          javax.swing.tree.DefaultMutableTreeNode nextTreeNode =
            new javax.swing.tree.DefaultMutableTreeNode(userObject);
  ...
  public void valueChanged(javax.swing.event.TreeSelectionEvent tse) {
    ...
    SakaiSiteUserObject userObject =
      (SakaiSiteUserObject) (node.getUserObject());
