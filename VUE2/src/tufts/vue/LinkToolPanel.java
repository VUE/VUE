...
public class LinkToolPanel extends ToolPanel {
  ...
  private static class StrokeStyleButton
    extends ComboBoxMenuButton<LWComponent.StrokeStyle> {
    ...
    class ComboBoxRenderer extends DefaultListCellRenderer {
      ...
      public ComboBoxRenderer() {
        ...
        if (GUI.isMacAqua()) setBorder(
          BorderFactory.createEmptyBorder(3, 2, 3, 4)
        ); else setBorder(BorderFactory.createEmptyBorder(5, 5, 2, 2));
      }
  ...
  protected void buildBox() {
    ...
    String[] strokeMenuLabels = VueResources.getStringArray(
      "strokeWeightNames"
    );
    mStrokeButton =
      new StrokeMenuButton(strokeValues, strokeMenuLabels, true, false);
    mStrokeButton.setPropertyKey(LWKey.StrokeWidth);
    //mStrokeButton.setButtonIcon(new LineIcon(16,16));
    mStrokeButton.setToolTipText(
      VueResources.getString("linktoolpanel.strokewidth.tooltip")
    );
    ...
    AbstractButton linkTypeMenu = new VuePopupMenu(
      LWKey.LinkShape,
      LinkTypeActions
    );
    linkTypeMenu.setToolTipText(
      VueResources.getString("linktoolpanel.linkstyle.tooltip")
    );
    ...
    JLabel strokeLabel = new JLabel(
      VueResources.getString("linktoolpanel.stroke")
    );
    ...
    JLabel weightLabel = new JLabel(
      VueResources.getString("linktoolpanel.weight")
    );
