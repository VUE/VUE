...
public class MapFilterModelEditor extends JPanel {
  ...
  public static final String MAP_FILTER_INFO = tufts.vue.VueResources.getString(
    "info.filter.map"
  );
  ...
  private void setMapFilterModelPanel() {
    addButton.setToolTipText(
      VueResources.getString("mapfiltermodelpanel.addbutton.tooltip")
    );
    deleteButton.setToolTipText(
      VueResources.getString("mapfiltermodelpanel.delbutton.tooltip")
    );
    mapFilterTable = new JTable(mapFilterModel);
    mapFilterTable.addFocusListener(
      new FocusListener() {
        public void focusLost(FocusEvent e) {
          if (mapFilterTable.isEditing()) {
            mapFilterTable
              .getCellEditor(
                mapFilterTable.getEditingRow(),
                mapFilterTable.getEditingColumn()
              )
              .stopCellEditing();
          }
  ...
  public class MapFilterModelSelectionListener
    ...
    public MapFilterModelSelectionListener(
  ...
  public class DeleteButtonListener implements ActionListener {
    ...
    public DeleteButtonListener(
      JTable table,
      MapFilterModelSelectionListener sListener
    ) {
      this.table = table;
    ...
    public void actionPerformed(ActionEvent e) {
      ...
      if (
        JOptionPane.showConfirmDialog(
          ...
          tufts.vue.VueResources.getImageIcon("vueIcon32x32")
        ) ==
