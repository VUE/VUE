...
public class NodeFilterEditor
  extends JPanel
  implements
    MapFilterModel.Listener, tufts.vue.ActiveListener<tufts.vue.LWMap> {

  public static final String ADD_ELEMENT = VueResources.getString(
    "nodefilter.definenew.label"
  );
  public static final String SELECT_ELEMENT = VueResources.getString(
    "nodefilter.select.label"
  );
  ...
  JLabel elementLabel = new JLabel(
    VueResources.getString("nodefilter.selectelement.label")
  );
  JComboBox elements;
  ...
  private void setNodeFilterPanel() {
    ...
    addButton.setToolTipText(
      VueResources.getString("nodefilter.addfilter.tooltip")
    );
    deleteButton.setToolTipText(
      VueResources.getString("nodefilter.deletefilter.tooltip")
    );
      ...
      new FocusListener() {
        public void focusLost(FocusEvent e) {
          if (nodeFilterTable.isEditing()) {
            nodeFilterTable
              .getCellEditor(
                nodeFilterTable.getEditingRow(),
                nodeFilterTable.getEditingColumn()
              )
              .stopCellEditing();
          }
    ...
    nodeFilterTable.addKeyListener(
      new KeyAdapter() {
        public void keyPressed(KeyEvent e) {
          if (
            nodeFilterTable.getSelectedRow() ==
              (nodeFilterTable.getRowCount() - 1) &&
    ...
    nodeFilterScrollPane.setBorder(
  ...
  public void setNodeFilter(NodeFilter nodeFilter) {
    ...
    nodeFilterTable
      .getColumnModel()
      .getColumn(NodeFilter.KEY_COL)
      .setCellEditor(keyEditor);
  }
  ...
  public class AddButtonListener implements ActionListener {
    ...
    void addStatement() {
      ...
      if (obj.toString().equals(ADD_ELEMENT)) {
        AddElementDialog addDialog = new AddElementDialog(
          lWMap.getMapFilterModel()
        );
  ...
  public class OperatorCellEditor extends DefaultCellEditor {
    ...
    public Component getTableCellEditorComponent(
      ...
      if (tableModel instanceof NodeFilter) {
        ...
        editor =
          new JComboBox(
            (Vector) ((Statement) (nodeFilter.get(row))).getKey()
              .getType()
              .getSettableOperators()
          );
        return editor;
      }
  ...
  public class AddDialog extends JDialog {
    ...
    public AddDialog(NodeFilter model) {
      ...
      operatorLabel =
        new JLabel(VueResources.getString("nodefilter.operator.label"));
      valueLabel = new JLabel(VueResources.getString("nodefilter.value.label"));
      keyEditor =
        new JComboBox(
          tufts.vue.VUE.getActiveMap().getMapFilterModel().getKeyVector()
        );
  ...
  public class DeleteButtonListener implements ActionListener {
    ...
    public DeleteButtonListener(
      JTable table,
      NodeFilterSelectionListener sListener
    ) {
      this.table = table;
  ...
  public class AddElementDialog extends JDialog {
    ...
    private void updateModelAndNotify() {
      tufts.vue.filter.Key key = new tufts.vue.filter.Key(
        keyEditor.getText(),
        (tufts.vue.filter.Type) typeEditor.getSelectedItem()
      );
      model.addKey(key);
      Statement stmt = new Statement();
      stmt.setKey(key);
