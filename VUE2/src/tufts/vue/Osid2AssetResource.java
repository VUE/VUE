...
public class Osid2AssetResource extends URLResource {
  ...
  private static final org.apache.log4j.Logger Log =
    org.apache.log4j.Logger.getLogger(Osid2AssetResource.class);

  private static final org.osid.shared.Type BrowsePartType =
    new edu.tufts.vue.util.Type("mit.edu", "partStructure", "URL");
  private static final org.osid.shared.Type ThumbnailPartType =
    new edu.tufts.vue.util.Type("mit.edu", "partStructure", "thumbnail");
  private static final org.osid.shared.Type ThumbnailPartType2 =
    new edu.tufts.vue.util.Type("mit.edu", "partStructure", "thumbnailURL");
  private static final org.osid.shared.Type LargeImagePartType =
    new edu.tufts.vue.util.Type("mit.edu", "partStructure", "largeImage");
  private static final org.osid.shared.Type LargeImagePartType2 =
    new edu.tufts.vue.util.Type("mit.edu", "partStructure", "largeImageURL");
  private static final org.osid.shared.Type LargeThumbnailPartType =
    new edu.tufts.vue.util.Type(
      "mit.edu",
      "partStructure",
      "largeThumbnailURL"
    );
  ...
  public void setAsset(org.osid.repository.Asset asset) { //throws org.osid.repository.RepositoryException
    ...
    try {
      if (DEBUG.RESOURCE) dumpField(
        "setAsset",
        Util.tags(asset) + "; " + Util.tags(asset.getDisplayName())
      );
      setAssetImpl(asset);
    } catch (Throwable t) {
  ...
  private static String quoteF(Object o) {
    if (o == null) return "null"; else return quoteF(o.toString());
  }
  ...
  private void setAssetImpl(org.osid.repository.Asset asset)
    ...
    while (recordIterator.hasNextRecord()) {
      ...
      if (DEBUG.DR) {
        if (record == null) recordDesc = "<NULL-RECORD>"; else recordDesc =
          record +
          //+ "\nRepository=" + asset.getRepository().getDisplayName()
          "\nID=" +
          record.getId() +
          "\nRecordStruct=" +
          quoteF(record.getRecordStructure()) +
          "\n";
      ...
      while (partIterator.hasNextPart()) {
        ...
        final org.osid.repository.PartStructure partStructure =
        ...
        if ((part != null) && (partStructure != null)) {
          ...
          if (BrowsePartType.isEqual(partStructureType)) {
            ...
            ThumbnailPartType.isEqual(partStructureType) ||
            ThumbnailPartType2.isEqual(partStructureType)
          ) {
            ...
            LargeImagePartType.isEqual(partStructureType) ||
            FedoraImagePartType.isEqual(partStructureType) ||
            LargeImagePartType2.isEqual(partStructureType) ||
            LargeThumbnailPartType.isEqual(partStructureType)
          ) {
    ...
    if (getSpec() == SPEC_UNSET) {
      ...
      if (defaultURL != null) {
        if (DEBUG.RESOURCE && DEBUG.META) Log.warn(
          "Osid2AssetResource failsafe: using URL property " + defaultURL
        );
        setSpec(defaultURL);
      }
    }
