...
public interface VueConstants {
  public static final FontRenderContext DefaultFontContext =
  ...
  static Font FONT_MEDIUM_UNICODE = new Font(
    "Arial Unicode MS",
    Font.PLAIN,
    12
  );
  ...
  static java.awt.Color COLOR_SELECTION = VueResources.getColor(
    "mapViewer.selection.color"
  );
  ...
  static java.awt.Color COLOR_SELECTION_NOTICE = new java.awt.Color(
    255,
    74,
    74
  );
  ...
  static java.awt.Color COLOR_HIGHLIGHT = VueResources.getColor(
    "mapViewer.highlight.color"
  );
  static java.awt.Color COLOR_TOOLTIP = new Color(255, 255, 192);
  static java.awt.Color COLOR_TOOLTIP_TRANSPARENT = new Color(
    255,
    255,
    192,
    192
  ...
  static Cursor CURSOR_DEFAULT = Cursor.getPredefinedCursor(
  ...
  static java.awt.BasicStroke STROKE_SIXTEENTH = new java.awt.BasicStroke(
    0.0625f
  );
  ...
  static java.awt.BasicStroke STROKE_SELECTION_DYNAMIC =
