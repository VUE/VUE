...
public class ScrollableGrid extends JPanel implements Scrollable {
  ...
  private static final org.apache.log4j.Logger Log =
    org.apache.log4j.Logger.getLogger(ScrollableGrid.class);
  ...
  synchronized void setPaintDisabled(boolean disabled) {
    if (disabled) paintDisabled++; else paintDisabled--;
  }
  ...
  public Dimension getPreferredScrollableViewportSize() {
    ...
    if (DEBUG.SCROLL) Log.debug(
      GUI.name(delegate) + " viewportSize " + GUI.name(d)
    );
    return d;
  }
