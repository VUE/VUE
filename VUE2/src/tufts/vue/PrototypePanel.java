...
public class PrototypePanel
  ...
  protected static final int HALF_GUTTER = 4, GUTTER = 2 * HALF_GUTTER;
  protected static JSlider fadeSlider = null, depthSlider = null;
  protected static JButton zoomSelButton = null, zoomMapButton = null;
  protected static JCheckBox zoomLockCheckBox = null;
  protected static JLabel fadeLabel = null, depthLabel = null, zoomSelLabel =
    null, zoomMapLabel = null;
  protected JPanel fadePanel = null, fadeInnerPanel = null, zoomPanel =
    null, zoomInnerPanel = null, linePanel = null;
  ...
  public PrototypePanel(DockWindow dw) {
    ...
    fadeLabel =
      new JLabel(
        VueResources.getString("interactionTools.opacity"),
    ...
    fadeSlider.setToolTipText(
      VueResources.getString("interactionTools.opacity.toolTip")
    );
    addToGridBag(
      fadeInnerPanel,
      fadeSlider,
    ...
    depthLabel =
      new JLabel(
        VueResources.getString("interactionTools.depth"),
        SwingConstants.RIGHT
      );
    ...
    widgetStack.addPane(
      VueResources.getString("interactionTools.fadeAndDepthWidget"),
      fadePanel
    );
    widgetStack.addPane(
  ...
  static class DepthSelectionListener
    implements ChangeListener, LWSelection.Listener {
    ...
    protected void findChildrenToDepth(
      Collection<LWComponent> collection,
      int depth
    ) {
      ...
      while (nodes.hasNext()) {
        ...
        if (node.getClass() == LWNode.class) {
          ...
          if (depth > 1) {
            ...
            Iterator<LWComponent> links = (Iterator<LWComponent>) (node
                .getConnected()
                .iterator());
