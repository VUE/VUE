...
public class EditLibraryPanel extends JPanel implements ActionListener {
  ...
  private static final org.apache.log4j.Logger Log =
    org.apache.log4j.Logger.getLogger(EditLibraryPanel.class);
  ...
  private UIParams getXMLforOldStyleDataSource(
    tufts.vue.DataSource dataSource
  ) {
    ...
    addField(
      b,
      "name",
      VueResources.getString("dialog.displayname.label"),
  ...
  public static void addField(
    ...
    if (value != null) b.append(
      org.apache.commons.lang.StringEscapeUtils.escapeXml(value)
    );
    b.append("</default>");
  ...
  public void actionPerformed(ActionEvent ae) {
    try {
      ...
      t.printStackTrace();
      VueUtil.alert(
        VueResources.getString("dialog.config.message") + t.getMessage(),
