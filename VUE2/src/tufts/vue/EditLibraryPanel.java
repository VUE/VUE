...
public class EditLibraryPanel extends JPanel implements ActionListener {
    ...
    // edu.tufts.vue.ui.ConfigurationUI uses XML to set up its fields. This is
    // probably
    ...
    private UIParams getXMLforOldStyleDataSource(tufts.vue.DataSource dataSource) {
        ...
        addField(b, "name", VueResources.getString("dialog.displayname.label"), "Name for this data source", name,
                SINGLE_LINE_CLEAR_TEXT_CONTROL, 0);
        ...
        if (dataSource instanceof LocalFileDataSource) {
            ...
            addField(b, "username", "Username", "FTP site username", ds.getUserName(), SINGLE_LINE_CLEAR_TEXT_CONTROL,
                    16);
            addField(b, "pasword", "Password", "FTP site password", ds.getPassword(), SINGLE_LINE_MASKED_TEXT_CONTROL,
                    16);
    ...
    public static void addField(StringBuilder b, String key, String title, String description, String value,
            int uiControl, int max) {
        b.append("<field>");
        ...
        b.append("<mandatory>true</mandatory>"); // currently required as input, but ignored for effect by
                                                 // ConfigurationUI impl
    ...
    public void actionPerformed(ActionEvent ae) {
        try {
            ...
            t.printStackTrace();
            VueUtil.alert(VueResources.getString("dialog.config.message") + t.getMessage(),
                    VueResources.getString("dialog.config.title"));
        }
    }
}
