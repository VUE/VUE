...
/**
 * @version $Revision: 1.31 $ / $Date: 2010-02-03 19:13:45 $ / $Author: mike $ *
...
public class ImageConversion extends VueAction {
  ...
  public static void convert(
    ...
    try {
      ...
      System.out.println(
        "ImageIO.write " + image + " fmt=" + format + " to " + location
      );
  ...
  public static Dimension createActiveMapJpeg(
    File location,
    double zoomFactor
  ) {
  ...
  public static Dimension createActiveMapPng(
    File location,
    LWMap map,
    double zoomFactor
  ) {
  ...
  public void act() {
    try {
      ...
      if (selectedFile != null) createActiveMapJpeg(
        selectedFile,
        tufts.vue.VueResources.getDouble("imageExportFactor")
      );
    } catch (Throwable t) {
