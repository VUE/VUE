...
public class ExitAction extends AbstractAction {
  ...
  public static void exitVue() {
    ...
    try {
      if (VUE.getRootWindow() != null) VUE.getRootWindow().setVisible(false);
      saveResources();
      //             if (false) {
      ...
      if (!(model.getElementAt(i) instanceof String)) {
        ...
        if (ds instanceof FavoritesDataSource) {
          ...
          if (fw.favoritesTree != null) {
            tufts.vue.VueDandDTree ft =
              ((FavoritesWindow) ds.getResourceViewer()).getFavoritesTree();
            ...
            File favf = new File(
              ...
              File.separatorChar +
              ds.getDisplayName() +
              VueResources.getString("save.favorites")
            );
            ((FavoritesWindow) ds.getResourceViewer()).marshallFavorites(
                favf,
                sfavtree
              );
          }
