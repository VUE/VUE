...
public class IMSResourceList {
  ...
  public void convert(LWMap map, java.io.File file) {
    try {
      ...
      org.w3c.dom.Element resourceListElement = document.createElement(
        "resourceList"
      );
      org.w3c.dom.Element resourceListMetadataElement = document.createElement(
        "resourceListMetadata"
      );
      ...
      for (LWComponent lwc : map.getAllDescendents(
        tufts.vue.LWComponent.ChildKind.ANY
      )) {
        if (!(lwc instanceof LWImage)) {
          Resource r = lwc.getResource();
          if (r != null) {
            org.w3c.dom.Element resourceElement = document.createElement(
              "resource"
            );
            org.w3c.dom.Element resourceMetadataElement =
              document.createElement("resourceMetadata");
            org.w3c.dom.Element resourceTitleElement = document.createElement(
              "title"
            );
            org.w3c.dom.Element locationElement = document.createElement(
              "location"
            );

            resourceTitleElement.appendChild(
              document.createTextNode(r.getTitle())
            );
