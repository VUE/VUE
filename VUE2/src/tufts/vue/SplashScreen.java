...
public class SplashScreen extends Frame {
  ...
  private void createSplash() {
    ...
    if (Util.isMacCocoaSupported()) splashProp =
      "splashScreen"; else splashProp = "splashScreenNoTransparency";
    ImageIcon icon = new ImageIcon(VueResources.getURL(splashProp)) {
      public void paintIcon(Component c, Graphics g, int x, int y) {
        ...
        g.drawString(
          VueResources.getString("splashscreen.developedby"),
          202,
          185
        );
        g.drawString(
          (char) 169 +
          " " +
          VueResources.getString("vue.build.date") +
          " Tufts University",
          240,
          205
        );
        g.drawString(
          "Version " + VueResources.getString("vue.version"),
          95,
          215
        );
      }
