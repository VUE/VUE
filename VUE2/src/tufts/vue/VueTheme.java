...
public class VueTheme extends javax.swing.plaf.metal.DefaultMetalTheme {
  ...
  public static VueTheme getTheme(Color toolbarColor) {
    if (Singleton == null) Singleton = new VueTheme(toolbarColor);
    return Singleton;
  }

  public static VueTheme getTheme() {
    if (Singleton == null) throw new IllegalStateException(
      "getTheme(macAquaLAF) must be called first time"
    );
    return Singleton;
  }
  ...
  protected FontUIResource fontMedium = new FontUIResource(
    "SansSerif",
    Font.PLAIN,
    12
  );
  protected FontUIResource fontSmall = new FontUIResource(
    "SansSerif",
    Font.PLAIN,
    11
  );
  protected FontUIResource fontTiny = new FontUIResource(
    "SansSerif",
    Font.PLAIN,
    8
  );
  protected FontUIResource fontControl = new FontUIResource(
    "SansSerif",
    Font.PLAIN,
    12
  );
  ...
  protected FontUIResource getSmallFont() {
    return fontSmall;
  }
  ...
  protected ColorUIResource getSecondary1() {
    return Singleton.VueSecondary1;
  }

  protected ColorUIResource getSecondary2() {
    return Singleton.VueSecondary2;
  }

  protected ColorUIResource getSecondary3() {
    return Singleton.VueSecondary3;
  }
  ...
  public static class VueTabbedPaneUI extends MetalTabbedPaneUI {
    ...
    protected void paintTabBackground(
      ...
      if (isSelected) {
        ...
        if (Singleton.ToolbarColor.equals(c)) g.setColor(c); else g.setColor(
          Singleton.VueSecondary2
        );
      }
      switch (tabPlacement) {
        case LEFT:
