...
public class SaveVueJTree {
  ...
  public static final org.osid.shared.Type favoritesType =
    new edu.tufts.vue.util.Type("edu.tufts", "favorites", "Asset");

  private static final org.apache.log4j.Logger Log =
    org.apache.log4j.Logger.getLogger(SaveVueJTree.class);
  ...
  private String cleanFileName(String fileName) {
    if (fileName.startsWith("file://")) return fileName.substring(
      7
