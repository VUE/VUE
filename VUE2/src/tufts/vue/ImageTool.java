...
public class ImageTool extends VueTool {
  ...
  public Class getSelectionType() {
    return LWImage.class;
  }

  public JPanel createToolPanel() {
    return new LWCToolPanel() {
  ...
  private static class RotationSlider
    ...
    private static final int SnapIncrement = 5;
    ...
    public Object getPropertyKey() {
      return LWImage.KEY_Rotation;
    }

    public Object getPropertyValue() {
      return new Double(Math.toRadians(getValue()));
    }
    ...
    public void stateChanged(ChangeEvent e) {
      ...
      if (getValueIsAdjusting() == false) {
        ...
        // so ignore the first.
        if (!getSnapToTicks() || isSnappedValue(getValue())) isFinalValue =
          true;
      }
