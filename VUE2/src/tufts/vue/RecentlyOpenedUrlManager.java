...
public class RecentlyOpenedUrlManager {
  ...
  private static VuePreference openFilePref = StringPreference.create(
    ...
    "Number of Recently Opened Urls to maintain",
    maxSize,
    false
  );
  ...
  private int maxsize;
  private static RecentlyOpenedUrlManager _instance;

  // For lazy initialization
  public static synchronized RecentlyOpenedUrlManager getInstance() {
    if (_instance == null) {
      _instance = new RecentlyOpenedUrlManager();
    }
    return _instance;
  }
  ...
  private RecentlyOpenedUrlManager() {
    StringTokenizer tokens = new StringTokenizer(
      (String) openFilePref.getValue(),
      "*"
    );
  ...
  public String[] getRecentlyOpendUrlsArray() {
    List l = getRecentlyOpenedUrls();
    String[] strings = new String[l.size()];
    Iterator i = l.iterator();
    int index = 0;
    while (i.hasNext()) {
      strings[index++] = (String) i.next();
    }
    return strings;
  }

  public List getRecentlyOpenedUrls() {
    return list.subList(1, list.size());
  }

  public void updateRecentlyOpenedUrls(String s) {
