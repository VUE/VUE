...
public class SearchData {
  ...
  private static final org.apache.log4j.Logger Log =
    org.apache.log4j.Logger.getLogger(SearchData.class);
  ...
  private static Operator decodeSavedLogicalOp(String saved) {
    if (
      Operator.AND.key.equals(saved) || Operator.AND.localized.equals(saved)
    ) return Operator.AND; else return Operator.OR;
  }
