...
public class FontEditorPanel
  extends JPanel
  implements CaretListener, ComponentListener //,ActiveListener
//implements LWEditor
//    implements ActionListener, VueConstants//, PropertyChangeListener//implements PropertyChangeListener
{
  ...
  public static final String SIZE_FIELD_NAME = "richFontSizeEditor";
  ...
  private final AbstractButton orderedListButton = new VueButton(
    "list.button.ordered"
  );
  private final AbstractButton unorderedListButton = new VueButton(
  ...
  //rich text actions
  private final SHTMLEditorKitActions.BoldAction richBoldAction =
    new SHTMLEditorKitActions.BoldAction(null);
  private final SHTMLEditorKitActions.ItalicAction richItalicAction =
    new SHTMLEditorKitActions.ItalicAction(null);
  private final SHTMLEditorKitActions.UnderlineAction richUnderlineAction =
    new SHTMLEditorKitActions.UnderlineAction(null);
  private final SHTMLEditorKitActions.ToggleListAction toggleBulletsAction =
    new SHTMLEditorKitActions.ToggleListAction(
      null,
      "toggleListAction",
      HTML.Tag.UL
    );
  private final SHTMLEditorKitActions.ToggleListAction toggleNumbersAction =
    new SHTMLEditorKitActions.ToggleListAction(
      null,
      "toggleNumbersAction",
      HTML.Tag.OL
    );
  private final SHTMLEditorKitActions.ToggleAction paraAlignLeftAction =
    new SHTMLEditorKitActions.ToggleAction(
      null,
      "paraAlignLeftAction",
      CSS.Attribute.TEXT_ALIGN,
      com.lightdev.app.shtm.Util.CSS_ATTRIBUTE_ALIGN_LEFT
    );
  private final SHTMLEditorKitActions.ToggleAction paraAlignCenterAction =
    new SHTMLEditorKitActions.ToggleAction(
      null,
      "paraAlignCenterAction",
      CSS.Attribute.TEXT_ALIGN,
      com.lightdev.app.shtm.Util.CSS_ATTRIBUTE_ALIGN_CENTER
    );
  private final SHTMLEditorKitActions.ToggleAction paraAlignRightAction =
    new SHTMLEditorKitActions.ToggleAction(
      null,
      "paraAlignRightAction",
      CSS.Attribute.TEXT_ALIGN,
      com.lightdev.app.shtm.Util.CSS_ATTRIBUTE_ALIGN_RIGHT
    );
  private final SHTMLEditorKitActions.FontFamilyAction fontFamilyAction =
    new SHTMLEditorKitActions.FontFamilyAction(null);
  private final SHTMLEditorKitActions.FontSizeAction fontSizeAction =
    new SHTMLEditorKitActions.FontSizeAction(null);
  private final SHTMLEditorKitActions.FontColorAction fontColorAction =
    new SHTMLEditorKitActions.FontColorAction(null);
  ...
  public FontEditorPanel(Object propertyKey) {
    ...
    globalBoldListener =
      new ActionListener() {
        public void actionPerformed(ActionEvent fe) {
          ...
          SHTMLDocument srcDoc =
            (SHTMLDocument) lwtext.richLabelBox.getDocument();
          ...
          while (characterAttributeEnum.hasMoreElements()) {
            ...
            if (
              (o.toString().equals("font-weight") &&
                charSet.getAttribute(o).toString().equals("bold")) ||
              o.toString().equals("b")
            ) {
              isBold = true;
            }
          ...
          Util
            .styleSheet()
            .addCSSAttribute(set, CSS.Attribute.FONT_WEIGHT, bold);
          ...
          if (lwtext.getParent() != null) lwtext.getParent().layout();

          lwtext.notify(lwtext.richLabelBox, LWKey.Repaint);
        }
      };
    globalItalicListener =
      new ActionListener() {
        public void actionPerformed(ActionEvent fe) {
          if (lwtext == null) return;
          if (EditorManager.isEditorLoading()) return;
          ...
          while (characterAttributeEnum.hasMoreElements()) {
            ...
            if (
              (o.toString().equals("font-style") &&
                charSet.getAttribute(o).toString().equals("italic")) ||
              o.toString().equals("i")
            ) {
              isBold = true;
            }
          ...
          Util
            .styleSheet()
            .addCSSAttribute(set, CSS.Attribute.FONT_STYLE, bold);
          //	set.addAttribute(HTML.Attribute.TEXT_WEIGHT, );
          lwtext.richLabelBox.applyAttributes(set, false);
          lwtext.richLabelBox.select(0, 0);
      ...
      new ActionListener() {
        public void actionPerformed(ActionEvent fe) {
          ...
          while (characterAttributeEnum.hasMoreElements()) {
            ...
            if (
              (o.toString().equals("text-decoration") &&
                charSet.getAttribute(o).toString().equals("underline")) ||
              o.toString().equals("u")
            ) {
              isBold = true;
            }
          ...
          Util
            .styleSheet()
            .addCSSAttribute(set, CSS.Attribute.TEXT_DECORATION, bold);
          //	set.addAttribute(HTML.Attribute.TEXT_WEIGHT, );
          lwtext.richLabelBox.applyAttributes(set, false);
          lwtext.richLabelBox.select(0, 0);
    ...
    globalSizeListener =
      new ActionListener() {
        public void actionPerformed(ActionEvent fe) {
          ...
          Util
            .styleSheet()
            .addCSSAttribute(set, CSS.Attribute.FONT_SIZE, textSize);
    ...
    if (sFontSizes == null) sFontSizes =
      VueResources.getStringArray("fontSizes");
    ...
    if (mSizeField.getEditor().getEditorComponent() instanceof JTextField) {
      JTextField sizeEditor = (JTextField) mSizeField
        .getEditor()
        .getEditorComponent();
    ...
    sizeHandler =
      new LWPropertyHandler<Integer>(LWKey.FontSize, mSizeField) {
    ...
    styleChangeHandler =
      new LWPropertyHandler<Integer>(LWKey.FontStyle) {
        public Integer produceValue() {
          ...
          if (mItalicButton.isSelected()) style |= Font.ITALIC;
          if (mBoldButton.isSelected()) style |= Font.BOLD;
    ...
    underlineChangeHandler =
      new LWPropertyHandler<String>(LWKey.FontUnderline) {
        public String produceValue() {
          String style = "";
          if (mUnderlineButton.isSelected()) style = "underline"; else style =
            "normal";
          return style;
        }
        ...
        public void displayValue(String propertyValue) {
          ...
          if (style.equals("underline")) mUnderlineButton.setSelected(
            true
          ); else mUnderlineButton.setSelected(false);
        }
      };
    ...
    mItalicButton =
      new VueButton.Toggle("font.button.italic", styleChangeHandler);
    mUnderlineButton =
      new VueButton.Toggle("font.button.underline", underlineChangeHandler); // regular components don't support this style
    ...
    alignmentHandler =
      new LWPropertyHandler<LWComponent.Alignment>(LWKey.Alignment) {
        public LWComponent.Alignment produceValue() {
          if (
            mLeftAlignButton.isSelected()
          ) return LWComponent.Alignment.LEFT; else if (
            mCenterAlignButton.isSelected()
          ) return LWComponent.Alignment.CENTER; else if (
            mRightAlignButton.isSelected()
          ) return LWComponent.Alignment.RIGHT; else return LWComponent.Alignment.LEFT;
        }
    ...
    mTextColorButton.setToolTipText(
      VueResources.getString("fonteditorpanel.textcolor")
    );
  ...
  private class FontPropertyHandler extends LWPropertyHandler<String> {
    ...
    public String produceValue() {
      return (String) mFontCombo.getSelectedItem();
    }

    public void displayValue(String value) {
      mFontCombo.setSelectedItem(value);
    }
  }
  ...
  static String[] getFontNames() {
    synchronized (sFontNamesLock) {
      if (sFontNames == null) {
        if (DEBUG.INIT) new Throwable("FYI: loading system fonts...")
          .printStackTrace();
        sFontNames =
          GraphicsEnvironment
  ...
  private void setSpecialEditorsEnabled(boolean enabled) {
    ...
    Color c = null;
    if (VUE.getActiveViewer().getFocal() instanceof LWSlide) c =
      ((LWSlide) VUE.getActivePathway().getMasterSlide()).getMasterSlide()
        .getTextStyle()
        .getTextColor(); else c = mTextColorButton.getColor();
  ...
  private final PropertyChangeListener RichTextColorChangeListener =
    new PropertyChangeListener() {
      public void propertyChange(PropertyChangeEvent e) {
        if (e instanceof LWPropertyChangeEvent == false) return;

        final RichTextBox activeRTB = (RichTextBox) VUE.getActive(
          RichTextBox.class
        );
        ...
        if (lwtext != null) lwtext.richLabelBox.selectAll();
        ...
        Util
          .styleSheet()
          .addCSSAttribute(set, CSS.Attribute.COLOR, colorString);

        set.addAttribute(HTML.Attribute.COLOR, colorString);
        if (activeRTB != null) activeRTB.applyAttributes(
          set,
          false
        ); else lwtext.richLabelBox.applyAttributes(set, false);
  ...
  private void establishLWTextListeners(LWComponent activeText) {
    if (DEBUG_FONTPANEL) System.out.println("ESTABLISH LWT Listeners");
  ...
  private void breakdownLWTextListeners() {
    if (DEBUG_FONTPANEL) System.out.println("BREAKDOWN LWT Listeners");
    lwtext = null;
  ...
  private void breakdownRichTextListeners() {
    if (DEBUG_FONTPANEL) System.out.println("BREAKDOWN RTB Listeners");
  ...
  private void stripAllListeners(AbstractButton b) {
    ...
    for (int i = 0; i < l.length; i++) b.removeActionListener(l[i]);

    return;
  }

  private void establishRichTextListeners(RichTextBox activeText) {
    if (DEBUG_FONTPANEL) System.out.println("ESTABLISH RTB Listeners");
    breakdownDefaultListeners();
  ...
  public void establishDefaultListeners() {
    if (DEBUG_FONTPANEL) System.out.println("ESTABLISH Default Listeners");
    VUE.getFormatDock().setFocusable(true);
    VUE.getFormatDock().setFocusableWindowState(true);
    clearAlignmentSelection();
    mLeftAlignButton.setEnabled(false);
  ...
  public void breakdownDefaultListeners() {
    if (DEBUG_FONTPANEL) System.out.println("BREAKDOWN Default Listeners");
    // EditorManager.unregisterEditor(sizeHandler);
    //   EditorManager.unregisterEditor(fontPropertyHandler);
    //clearAlignmentSelection();
    mLeftAlignButton.setEnabled(false);
  ...
  public void activeChanged(final ActiveEvent e, LWComponent activeText) {
    ...
    if (RTBListenersAdded) breakdownRichTextListeners();

    if (e.oldActive instanceof LWText) {
      if (LWTextListenersAdded) breakdownLWTextListeners();
    }

    if (
      e.active != null &&
      e.oldActive != null &&
      e.active instanceof LWText &&
      e.oldActive instanceof LWText
    ) {
    ...
    if (e.active instanceof LWText) {
      ...
      if (!defaultListenersAdded) establishDefaultListeners();
    }
    suspendItemListeners = false;
  }

  public void activeChanged(ActiveEvent e, RichTextBox activeText) {
    if (e.active == e.oldActive) return;
    ...
    if (e.active != null) {
      if (LWTextListenersAdded) breakdownLWTextListeners();
      if (!RTBListenersAdded) establishRichTextListeners(activeText);
  ...
  public AttributeSet getMaxAttributes(
    ...
    final Element paragraphElement =
      ((SHTMLDocument) text.getDocument()).getParagraphElement(caretPosition);
    final StyleSheet styleSheet =
      ((SHTMLDocument) text.getDocument()).getStyleSheet();
  ...
  AttributeSet getMaxAttributes(RichTextBox editorPane, String elemName) {
    ...
    final MutableAttributeSet maxAttributes =
      (MutableAttributeSet) SHTMLPanelImpl.getMaxAttributes(e, s);
    final StyledEditorKit editorKit =
      (StyledEditorKit) editorPane.getEditorKit();
  ...
  private final void updateFormatControls(CaretEvent e) {
    ...
    if (e != null) updateFormatControlsTB(
      (RichTextBox) e.getSource()
    ); else updateFormatControlsTB(null);
  }
  ...
  public final void updateFormatControlsTB(RichTextBox text) {
    ...
    if (
      paragraphElement.getName().equals("p-implied")
    ) paragraphElement = paragraphElement.getParentElement(); //we're in a list item

    AttributeSet paragraphAttributeSet = paragraphElement.getAttributes();
    Element charElem = null;
    if (so != eo && Math.abs(eo - so) > 1) charElem =
      doc.getCharacterElement(caretPosition); else charElem =
      doc.getCharacterElement(caretPosition > 0 ? caretPosition - 1 : 1);
    AttributeSet charSet = charElem.getAttributes();
    Enumeration characterAttributeEnum = charSet.getAttributeNames();
    ...
    if (VUE.getActiveViewer().getFocal() instanceof LWSlide) {
      ...
      if (s.length() > 1) mFontCombo.getEditor().setItem(s);
    }
    ...
    } else mTextColorButton.setColor(Color.black);
    ...
    while (elementEnum.hasMoreElements()) {
      ...
      if (
        o.toString().equals("text-align") &&
        paragraphAttributeSet.getAttribute(o).toString().equals("left") &&
        !isAlignSet
        ...
        o.toString().equals("text-align") &&
        paragraphAttributeSet.getAttribute(o).toString().equals("center") &&
        !isAlignSet
      ) {
        ...
        o.toString().equals("text-align") &&
        paragraphAttributeSet.getAttribute(o).toString().equals("right") &&
        !isAlignSet
      ) {
        //	isAlignSet = true;
        mRightAlignButton.setSelected(true);
      ...
      if ((o.toString().equals("font-size")) || (o.toString().equals("size"))) {
        mSizeField
          .getEditor()
          .setItem(paragraphAttributeSet.getAttribute(o).toString());

        EditorManager.setEditorLoading(true);
        mSizeField
          .getModel()
          .setSelectedItem(paragraphAttributeSet.getAttribute(o).toString());
        EditorManager.setEditorLoading(false);
      } else if (
        (o.toString().equals("font-family")) ||
        (o.toString().equals("font-face")) ||
    ...
    while (characterAttributeEnum.hasMoreElements()) {
      ...
      if ((o.toString().equals("color"))) mTextColorButton.setColor(
        edu.tufts.vue.style.Style.hexToColor(charSet.getAttribute(o).toString())
      );
      ...
      if ((o.toString().equals("font-size")) || (o.toString().equals("size"))) {
        ...
        mSizeField
          .getModel()
          .setSelectedItem(charSet.getAttribute(o).toString());
        EditorManager.setEditorLoading(false);
        suspendItemListeners = false;
      }
  ...
  public void componentMoved(ComponentEvent arg0) {
    if (mTextColorButton.getPopupWindow().isVisible()) mTextColorButton
      .getPopupWindow()
      .setVisible(false);
  }
