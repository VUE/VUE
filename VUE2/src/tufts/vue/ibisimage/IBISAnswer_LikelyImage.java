...
public class IBISAnswer_LikelyImage extends IBISImage {
	...
	private static BufferedImage mImage = VueResources.getBufferedImage("IBISNodeTool.answer_likely.image");
	private static File mImageFile = createImageFile(VueResources.getString("IBISNodeTool.answer_likely.image.filename"), mImage);
	private static Resource mImageResource = new LWMap("dummy map").getResourceFactory().get(mImageFile);
	...
	public void setIcon() {
		...
		mIcon = new IBISAnswer_LikelyIcon();
	}
