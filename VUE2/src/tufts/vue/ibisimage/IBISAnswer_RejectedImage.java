...
public class IBISAnswer_RejectedImage extends IBISImage {
	...
	private static BufferedImage mImage = VueResources.getBufferedImage("IBISNodeTool.answer_rejected.image");
	private static File mImageFile = createImageFile(VueResources.getString("IBISNodeTool.answer_rejected.image.filename"), mImage);
	private static Resource mImageResource = new LWMap("dummy map").getResourceFactory().get(mImageFile);
