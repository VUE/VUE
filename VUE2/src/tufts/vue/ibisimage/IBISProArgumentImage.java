...
public class IBISProArgumentImage extends IBISImage {
	...
	private static BufferedImage mImage = VueResources.getBufferedImage("IBISNodeTool.pro_argument.image");
	private static File mImageFile = createImageFile(VueResources.getString("IBISNodeTool.pro_argument.image.filename"), mImage);
	private static Resource mImageResource = new LWMap("dummy map").getResourceFactory().get(mImageFile);
