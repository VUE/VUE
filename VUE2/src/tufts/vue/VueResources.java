...
public class VueResources {
  ...
  private static final org.apache.log4j.Logger Log =
    org.apache.log4j.Logger.getLogger(VueResources.class);
  ...
  protected static Map Cache = new HashMap() {
    public Object put(Object key, Object value) {
      ...
      if (DEBUG.INIT) Log.debug(
        "cached(" + key + ") = " + tufts.Util.tags(value)
      );
  ...
  static {
    final class VueResourceBundle extends ResourceBundle {
       ...
       */
      public VueResourceBundle(
        ResourceBundle baseNameList,
        ResourceBundle childNameList
      ) {
    ...
    if (DEBUG.INIT) tufts.Util.printStackTrace(
      "VueResources; FYI: static init block"
    );

    Locale locale = new Locale(
      languagePref.getLanguage(),
      languagePref.getCountry()
    );
    ResourceBundle langBundle = ResourceBundle.getBundle(
      "tufts.vue.VueResources",
      locale
    );
    platformBundle =
      ResourceBundle.getBundle(
        "tufts.vue.VueResources",
        new Locale("", "", (tufts.Util.isMacPlatform() ? "Mac" : "Win"))
      );
    ...
    javax.swing.UIManager.put(
      ...
      VueResources.getString("OptionPane.okButtonText")
    );
    javax.swing.UIManager.put(
      "OptionPane.cancelButtonText",
      VueResources.getString("OptionPane.cancelButtonText")
    );
    javax.swing.UIManager.put(
      "OptionPane.yesButtonText",
      VueResources.getString("OptionPane.yesButtonText")
    );
    javax.swing.UIManager.put(
      "OptionPane.noButtonText",
      VueResources.getString("OptionPane.noButtonText")
    );
    javax.swing.UIManager.put(
    ...
    javax.swing.UIManager.put(
      ...
      VueResources.getString("FileChooser.saveDialogTitleText")
    ); // wrong!!
    javax.swing.UIManager.put(
      "FileChooser.fileNameLabelText",
      VueResources.getString("FileChooser.fileNameLabelText")
    );
    javax.swing.UIManager.put(
      "FileChooser.lookInLabelText",
      VueResources.getString("FileChooser.lookInLabelText")
    );
    javax.swing.UIManager.put(
      "FileChooser.saveInLabelText",
      VueResources.getString("FileChooser.saveInLabelText")
    );
    javax.swing.UIManager.put(
      "FileChooser.filesOfTypeLabelText",
      VueResources.getString("FileChooser.filesOfTypeLabelText")
    ); // wrong!!
    javax.swing.UIManager.put(
      "FileChooser.openButtonText",
      VueResources.getString("FileChooser.openButtonText")
    );
    javax.swing.UIManager.put(
      "FileChooser.saveButtonText",
      VueResources.getString("FileChooser.saveButtonText")
    );
    javax.swing.UIManager.put(
      "FileChooser.updateButtonText",
      VueResources.getString("FileChooser.updateButtonText")
    );
    javax.swing.UIManager.put(
      "FileChooser.cancelButtonText",
      VueResources.getString("FileChooser.cancelButtonText")
    );
    javax.swing.UIManager.put(
      "FileChooser.newFolderButtonText",
      VueResources.getString("FileChooser.newFolderButtonText")
    );
    javax.swing.UIManager.put(
      "FileChooser.openButtonToolTipText",
      VueResources.getString("FileChooser.openButtonToolTipText")
    );
    javax.swing.UIManager.put(
      "FileChooser.saveButtonToolTipText",
      VueResources.getString("FileChooser.saveButtonToolTipText")
    );
    javax.swing.UIManager.put(
      "FileChooser.updateButtonToolTipText",
      VueResources.getString("FileChooser.updateButtonToolTipText")
    );
    javax.swing.UIManager.put(
      "FileChooser.cancelButtonToolTipText",
      VueResources.getString("FileChooser.cancelButtonToolTipText")
    );
    javax.swing.UIManager.put(
      "FileChooser.upFolderToolTipText",
      VueResources.getString("FileChooser.upFolderToolTipText")
    );
    javax.swing.UIManager.put(
      "FileChooser.newFolderToolTipText",
      VueResources.getString("FileChooser.newFolderToolTipText")
    );
    javax.swing.UIManager.put(
      "FileChooser.listViewButtonToolTipText",
      VueResources.getString("FileChooser.listViewButtonToolTipText")
    );
    javax.swing.UIManager.put(
      "FileChooser.detailsViewButtonToolTipText",
      VueResources.getString("FileChooser.detailsViewButtonToolTipText")
    );
    javax.swing.UIManager.put(
      "FileChooser.fileNameHeaderText",
      VueResources.getString("FileChooser.fileNameHeaderText")
    ); // wrong!!
    javax.swing.UIManager.put(
      "FileChooser.fileSizeHeaderText",
      VueResources.getString("FileChooser.fileSizeHeaderText")
    ); // wrong!!
    javax.swing.UIManager.put(
      "FileChooser.fileTypeHeaderText",
      VueResources.getString("FileChooser.fileTypeHeaderText")
    ); // wrong!!
    javax.swing.UIManager.put(
      "FileChooser.fileDateHeaderText",
      VueResources.getString("FileChooser.fileDateHeaderText")
    ); // wrong!!
    javax.swing.UIManager.put(
      "FileChooser.byNameText",
      VueResources.getString("FileChooser.byNameText")
    ); // wrong!!
    javax.swing.UIManager.put(
      "FileChooser.byDateText",
      VueResources.getString("FileChooser.byDateText")
    ); // wrong!!
    javax.swing.UIManager.put(
      "FileChooser.acceptAllFileFilterText",
      VueResources.getString("FileChooser.acceptAllFileFilterText")
    );
    javax.swing.UIManager.put(
      "InternalFrame.closeButtonToolTip",
      VueResources.getString("InternalFrame.closeButtonToolTip")
    ); // wrong!!
...
//			}
    ...
    if (DEBUG.INIT) System.out.println(
      "Got bundle: " +
      sResourceBundle +
      " in locale [" +
      sResourceBundle.getLocale() +
      "]"
    );
  ...
  public static ImageIcon getImageIcon(Class clazz, String keyOrPath) {
    ...
    if (clazz == null) key = keyOrPath; else key = clazz.getName() + keyOrPath;

    if (Cache.containsKey(key)) return (ImageIcon) Cache.get(key);

    ImageIcon icon = null;
    if (clazz == null) {
      String str = getString(key);
      if (str != null) icon = loadImageIcon(VueResources.class, str);
    } else {
  ...
  public static Image getImage(String key) {
    ImageIcon icon = null;
    if (key.charAt(0) == '/') icon =
      getImageIcon(VueResources.class, "images" + key); else icon =
      getImageIcon(key);

    if (icon != null) return icon.getImage(); else {
  ...
  public static ImageIcon getImageIconResource(String path) {
    if (Cache.containsKey(path)) return (ImageIcon) Cache.get(path);
  ...
  private static ImageIcon loadImageIcon(Class clazz, String file) {
    ...
    try {
      ...
      if (resource != null) {
        ...
        if (icon.getImageLoadStatus() != MediaTracker.COMPLETE) alert(
          "Unable to load image resource " + file + "; URL = '" + resource + "'"
        );
      } else {
    ...
    if (DEBUG.INIT && DEBUG.META) System.out.println(
      "\tloadImageIcon[" + file + "] = " + icon
    );
    return icon;
  }

  public static Dimension getSize(String key) {
    if (Cache.containsKey(key)) return (Dimension) Cache.get(key);
    ...
    if (data.length > 0) {
      ...
      if (data.length > 1) d.height = parseInt(data[1]);
    }
    Cache.put(key, d);
    return d;
  }
    ...
    try {
      file =
        new File(
          sResourceBundle
            .getClass()
            .getResource(getString(pLookupKey))
            .getFile()
            .replaceAll("%20", " ")
        );
      ...
      if (!file.exists()) {
        System.out.println(
          "getFile is doing class loader thing hopefully YA!!"
        );
        ...
        if (file == null) System.err.println(
          "error in getFile method"
        ); else if (!file.exists()) {
      ...
      System.out.println(
        "URL found for plookupkey = " + pLookupKey + "  : " + file
      );
    } catch (Exception e) {
      alert("  !!! failed to lead due to " + e.toString());
    }
  ...
  public static final String getString(String key) {
    ...
    if (DEBUG.INIT) {
      if (DEBUG.META/*|| result != null*/) Log.debug(
        "lookup(" +
        key +
        ") = " +
  ...
  public static final String getString(String key, String defaultString) {
  ...
  public static final String local(String key) {
  ...
  public static int[] getIntArray(String key) {
    if (Cache.containsKey(key)) return (int[]) Cache.get(key);
  ...
  private static int[] _getIntArray(String key, int minSize) {
    ...
    if (s != null) {
      ...
      for (int i = 0; i < s.length; i++) value[i] = parseInt(s[i]);
    }
    return value;
  }
  ...
  public static float[] getFloatArray(String key) {
    if (Cache.containsKey(key)) return (float[]) Cache.get(key);
    ...
    if (s != null) {
      ...
      for (int i = 0; i < s.length; i++) value[i] = parseFloat(s[i]);
    }
    Cache.put(key, value);
    return value;
  }
  ...
  public static int getInt(String key) {
    int value = 0;
    String s = getString(key);
    if (s != null) value = Integer.parseInt(s);
    return value;
  }
   ...
   */
  public static int getInt(String key, int pDefault) {
    int value = pDefault;
    String s = getString(key);
    if (s != null) {
  ...
  public static Font getFont(String key, Font defaultFont) {
    if (Cache.containsKey(key)) return (Font) Cache.get(key);
  ...
  public static Color getColor(String key, Color defaultColor) {
    if (Cache.containsKey(key)) return (Color) Cache.get(key);
    ...
    if (value == null) {
      if (defaultColor != null) value = defaultColor;
      //if (dr >= 0)
      //value = new Color(dr, dg, db);
      else if (DEBUG.INIT) alert("No such resource (color): " + key);
    }
  ...
  public static Color parseColor(String txt) {
    ...
    txt = txt.trim();
    if (txt.indexOf(',') > 0) return parseIntColor(
      txt
    ); else return parseHexColor(txt);
  }

  static Color parseIntColor(String commaText) {
    int[] rgb = makeIntArray(commaText, 3);

    if (rgb.length > 3) return new Color(
      rgb[0],
      rgb[1],
      rgb[2],
      rgb[3]
    ); else return new Color(rgb[0], rgb[1], rgb[2]);
  }
   ...
   */
  public static Color getColor(String key, int dR, int dG, int dB) {
  ...
  public static boolean getBool(String key) {
    ...
    try {
      ...
      if (str != null) value = str.equalsIgnoreCase("true");
    } catch (Exception e) {
   ...
   **/
  public static String getMessageString(String key, Object[] pArgs) {
    String msg = VueResources.getString(key);
    msg = MessageFormat.format(msg, pArgs);
    return msg;
  }

  protected static void alert(String pMsg) {
    if (
      DEBUG.Enabled || sDebug || (get("alerts") != null)
  ...
  public static void initComponent(JComponent pObj, String pKey) {
    Font font = getFont(pKey + ".font");
    Color background = getColor(pKey + ".background");

    if (font != null) pObj.setFont(font);
    if (
      background != null && !tufts.vue.gui.GUI.isMacAqua()
    ) pObj.setBackground(background);

    if (pObj instanceof JTabbedPane) pObj.setFocusable(false);
  }
  ...
  protected static void debug(String pStr) {
