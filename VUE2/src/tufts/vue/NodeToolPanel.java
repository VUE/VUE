...
public class NodeToolPanel extends ToolPanel {
  ...
  public void buildBox() {
    ...
    JLabel shapeLabel = new JLabel(
      VueResources.getString("nodetoolpanel.shape")
    );
    ...
    JLabel strokeLabel = new JLabel(
      VueResources.getString("nodetoolpanel.link")
    );
  ...
  static class ShapeMenuButton
    extends VueComboMenu<Class<? extends RectangularShape>> {
    ...
    protected Icon makeIcon(Class<? extends RectangularShape> shapeClass) {
      try {
        return new GUI.ProxyEnabledIcon(
          new NodeTool.SubTool.ShapeIcon(shapeClass.newInstance()),
          ShapeMenuButton.this
        );
      } catch (Throwable t) {
    ...
    class ShapeComboRenderer extends javax.swing.DefaultListCellRenderer {
      ...
      public Component getListCellRendererComponent(
        ...
        setIcon(icon);
        if (DEBUG.TOOL && !isEnabled()) System.out.println(
          "RENDERER SET DISABLED ICON: " + icon + " for value " + value
        );
