...
public class VueButtonIcon implements Icon {
  ...
  public static void installGenerated(
    AbstractButton b,
    Icon raw,
    Icon selected,
    Dimension s
  ...
  public static void installGenerated(
    ...
    if (DEBUG.INIT || DEBUG.TOOL) System.out.println(
      b + " generating button states from " + raw
    );
  ...
  private static final AlphaComposite DisabledAlpha =
  ...
  // icon stays centered.
  private static final boolean OffsetWhenDown = false;
  ...
  public VueButtonIcon(Icon rawIcon, int t, int width, int height) {
    ...
    if (isPressIcon) mColor = Color.lightGray;
    if (debug) {
  ...
  public void paintIcon(Component c, Graphics g, int x, int y) {
    if (debug || DEBUG.PAINT) System.out.println(
      "painting " +
      mRawIcon +
      " type " +
      mType +
