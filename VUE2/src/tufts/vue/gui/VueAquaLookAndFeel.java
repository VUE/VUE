...
public class VueAquaLookAndFeel extends apple.laf.AquaLookAndFeel {
  ...
  public static final Font SystemFont = new Font(
    "Lucida Grande",
    Font.PLAIN,
    13
  );
  public static final Font SmallSystemFont = new Font(
    "Lucida Grande",
    Font.PLAIN,
    11
  );
  public static final Font SmallSystemFont12 = new Font(
    "Lucida Grande",
    Font.PLAIN,
    12
  );
  public static final Font MiniSystemFont = new Font(
    "Lucida Grande",
    Font.PLAIN,
    9
  );
  public static final Font EmphasizedMiniSystemFont = new Font(
    "Lucida Grande",
    Font.BOLD,
    9
  );
  ...
  public String getDescription() {
    return super.getDescription() + " (VUE Derivative)";
  }
  ...
  public void initComponentDefaults(UIDefaults table) {
    ...
    if (false) table.put(
      "textHighlight",
      new javax.swing.plaf.ColorUIResource(255, 255, 0)
    );
    ...
    if (false) {
      ...
      table.put(
        ...
        "tufts.vue.VueAquaLookAndFeel$FloatingToolbarTitleUI"
      );
