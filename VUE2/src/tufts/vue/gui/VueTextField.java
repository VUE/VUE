...
public class VueTextField
  extends JTextField
  implements
    MouseListener,
    FocusListener //, java.beans.PropertyChangeListener, CaretListener
{
  ...
  public void X_select(int start, int end) {
    tufts.Util.printStackTrace(
      this + " select, start=" + start + " end=" + end
    );
  ...
  public void focusGained(FocusEvent e) {
    ...
    if (DEBUG.FOCUS) System.out.println(
      "\t" + this + " focusGained: hasFocus=" + hasFocus()
    );
  }
  ...
  public void focusLost(FocusEvent e) {
    ...
    if (DEBUG.FOCUS) System.out.println(
      "\t" + this + " focusLost: hasFocus=" + hasFocus()
    );
    //if(super.isEditable())
