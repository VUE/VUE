  ...
  implements CaretListener // KeyListener // ,
{
  ...
  private VueColorButton colorButton = new VueColorButton(
    new Dimension(18, 18)
  );
  ...
  public void setActiveTextControl(tufts.vue.TextBox box) {
    ...
    if (textBox != null) textBox.removeCaretListener(this);

    textBox = box;

    if (textBox != null) textBox.addCaretListener(this);

    if (textBox == null) activateAll(false); else activateAll(true);
  }
...
*/
  ...
  private void addComponents() {
    ...
    JLabel label = new JLabel(
      VueResources.getString("formatting.text.font.label")
    );
    JLabel fontSizeLabel = new JLabel(
      VueResources.getString("formatting.text.size.label")
    );
    JLabel fontColorLabel = new JLabel(
      VueResources.getString("formatting.text.color.label")
    );
  ...
  public void caretUpdate(CaretEvent arg0) {
    ...
    if (textBox != null) {
      ...
      } else boldButton.setSelected(false);

      b = (Boolean) attsSet.getAttribute(StyleConstants.Underline);
      if (b != null) underlineButton.setSelected(
        b.booleanValue()
      ); else underlineButton.setSelected(false);

      b = (Boolean) attsSet.getAttribute(StyleConstants.Italic);
      if (b != null) italicButton.setSelected(
        b.booleanValue()
      ); else italicButton.setSelected(false);

      Integer ival = ((Integer) attsSet.getAttribute(StyleConstants.Alignment));
      int align = 0;
      if (ival != null) align = ival.intValue();
      ...
      Integer sizeInt =
        ((Integer) attsSet.getAttribute(StyleConstants.FontSize));

      if (sizeInt != null) size = sizeInt.intValue();
  ...
  private void out(String s) {
    System.out.println(
      "TextPropsPane@" + Integer.toHexString(hashCode()) + " " + s
    );
  }
