...
//             });
        ...
        // HO 07/07/2010 BEGIN *******************
        // HO 27/08/2010 BEGIN *******************
        final JMenuItem addWormholeToExistingMapItem = new JMenuItem(Actions.AddWormholeToExistingMapAction);
        // HO 27/08/2010 BEGIN *******************
...
/*        helpMenu.add(new ShowURLAction(VueResources.getString("helpMenu.releaseNotes.label"), VueResources.getURL("helpMenu.releaseNotes.file"),
    ...
    public void rebuildWindowsMenu()
    {
        ...
        if (VUE.getIBISFormatDock() != null)
        	windowMenu.add(createWindowItem(VUE.getIBISFormatDock(), KeyEvent.VK_B, "Blorf"));
        // HO 25/06/2010 END ************************
