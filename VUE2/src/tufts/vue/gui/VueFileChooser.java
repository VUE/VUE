...
public class VueFileChooser extends JFileChooser {
  ...
  public static VueFileChooser getVueFileChooser() {
    ...
    if (!Util.isMacPlatform()) {
      ...
      // }
      if (VueUtil.isCurrentDirectoryPathSet()) chooser.setCurrentDirectory(
        new File(VueUtil.getCurrentDirectoryPath())
      );
    } else {
      if (VueUtil.isCurrentDirectoryPathSet()) {
         ...
         */
        chooser =
          new VueFileChooser(new File(VueUtil.getCurrentDirectoryPath()));
      } else chooser = new VueFileChooser();
    }
    return chooser;
  }
  ...
  private void checkForChooser() {
    boolean enhancedChooserEnabled = PreferencesManager.getBooleanPrefValue(
      edu.tufts.vue.preferences.implementations.EnhancedFileChooserPreference.getInstance()
    );
    if (!enhancedChooserEnabled) putClientProperty(
