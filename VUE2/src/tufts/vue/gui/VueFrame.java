...
public class VueFrame
  ...
  private static final org.apache.log4j.Logger Log =
    org.apache.log4j.Logger.getLogger(VueFrame.class);
  ...
  public void windowStateChanged(WindowEvent e) {
    ...
    if (VUE.getActiveViewer() != null) VUE
      .getActiveViewer()
      .setFastPaint("windowStateChanged");
  }
  ...
  protected void X_processEvent(java.awt.AWTEvent e) {
    ...
    if (VUE.getRootWindow() != VUE.getMainWindow()) {
      Log.warn(
        "VueFrame: processEvent: root != main: forcing root visible & front"
      );
  ...
  private String getViewerTitle(MapViewer viewer) {
    ...
    title += " (";
    if ((displayZoom / 100) * 100 == displayZoom) title +=
    (displayZoom / 100) + "%"; else title +=
    (((float) displayZoom) / 100f) + "%";
    title += ")";
    return title;
  }

  public void setTitle(String title) {
    if (title.endsWith(".vpk") || title.endsWith(".vue")) super.setTitle(title);
  }
