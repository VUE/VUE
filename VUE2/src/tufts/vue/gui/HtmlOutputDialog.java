 ...
 */
  private static final String TITLE = VueResources.getString(
    "htmloutput.title"
  );
  private JLabel heightPixels = new JLabel(
    VueResources.getString("htmloutput.pixels")
  );
  private JLabel widthPixels = new JLabel(
    VueResources.getString("htmloutput.pixels")
  );
  private JButton okButton = new JButton(
    VueResources.getString("htmloutput.ok")
  );
  private JButton cancelButton = new JButton(
    VueResources.getString("htmloutput.cancel")
  );
  private JLabel widthLabel = new JLabel(
    VueResources.getString("htmloutput.width")
  );
  private JLabel heightLabel = new JLabel(
    VueResources.getString("htmloutput.height")
  );
  private JLabel formatLabel = new JLabel(
    VueResources.getString("htmloutput.format")
  );
  ...
  private void buildUI() {
    ...
    JLabel dimLabel = new JLabel(
      VueResources.getString("htmloutput.dimensions")
    );
  ...
  public void actionPerformed(ActionEvent e) {
    if (e.getSource().equals(okButton)) returnVal = 1;
