...
set CP=%VUE_HOME%;%VUE_LIB%castor-0.9.4.3.jar;%VUE_LIB%castor-0.9.4.3-xml.jar;%VUE_LIB%batik-svggen.jar;%VUE_LIB%batik-awt-util.jar;%VUE_HOME%tufts\dr;%VUE_LIB%batik-util.jar;%VUE_LIB%fop.jar;%VUE_LIB%osid.jar;%VUE_LIB%fedorautilities.jar;%VUE_LIB%fedoragentypes.jar;%VUE_LIB%axis.jar;%VUE_LIB%axis-ant.jar;%VUE_LIB%commons-discovery.jar;%VUE_LIB%commons-logging.jar;%VUE_LIB%jaxrpc.jar;%VUE_LIB%log4j-1.2.4.jar;%VUE_LIB%saaj.jar;%VUE_LIB%xerces-2_4_0/xercesImpl.jar;%VUE_LIB%xerces-2_4_0/xml-apis.jar;
