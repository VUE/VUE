...
public class MacOSX extends tufts.macosx.MacOSX16Safe {
  static {
    if (System.getProperty("tufts.macosx.debug") != null) DEBUG = true;
  }
  ...
  public static void adjustMacWindows(
    final String mainWindowTitleStart,
  ...
  private static void eout(NoSuchMethodError e) {
    ...
    errout(
      e +
      "; tufts.macosx.MacOSX needs rebuild and/or VUE-MacOSX.jar needs updating"
    );
    e.printStackTrace();
  }
  ...
  private static void eout(NoClassDefFoundError e) {
    ...
    errout(
      e + ": Not MacOSX Platform or /System/Library/Java not in classpath"
    );
    e.printStackTrace();
  }
}
