package edu.mit.osidimpl.repository;

/**
 This class forces any search criteria to lowercase.  Search properties are not adjusted.
 */
public class LowercaseQueryAdjuster implements edu.tufts.vue.fsm.QueryAdjuster {
