...
public class SelectorType extends org.osid.shared.Type {
  ...
  public static final SelectorType defaultType = new SelectorType(
    "Default Selector",
    "edu.tufts",
    "default"
  );
  public static final SelectorType link = new SelectorType(
    "Link Selector",
    "edu.tufts",
    "link"
  );
  public static final SelectorType node = new SelectorType(
    "Node Selector",
    "edu.tufts",
    "node"
  );

  public SelectorType(String authority, String domain, String keyword) {
