...
public class OntologyBrowser extends JPanel {
  ...
  JPanel ontologiesPanel = new Widget(
    VueResources.getString("dockWindow.ontologies.title")
  );
  ...
  private ArrayList<OntologySelectionListener> ontologySelectionListenerList =
    new ArrayList<OntologySelectionListener>();
  ...
  public static int getSelectedIndex(TypeList tlist) {
    ...
    for (int i = 0; i < comps.length; i++) {
      if (tlist == comps[i]) return i;
    }

    return -1;
  }

  public Widget addTypeList(
    final edu.tufts.vue.ontology.ui.TypeList list,
    String name,
    URL url
  ) {
    list
  ...
  public static OntologyBrowser getBrowser() {
    if (singleton == null) singleton = new OntologyBrowser();
  ...
  private OntologyOpenAction ontologyOpenAction =
    new edu.tufts.vue.ontology.action.OntologyOpenAction(
      VueResources.getString("ontology.openaction"),
      this
    );
  ...
  protected tufts.vue.VueAction removeOntology = new tufts.vue.VueAction() {
    ...
    public void actionPerformed(java.awt.event.ActionEvent e) {
      try {
        edu.tufts.vue.ontology.Ontology ont =
          (edu.tufts.vue.ontology.Ontology) getBrowser()
            .getViewer()
            .getList()
            .getSelectedValue();
        ...
        Widget w = widgetMap.get(
          new OntologyBrowserKey(
            edu.tufts.vue.ontology.Ontology.getLabelFromUrl(ont.getBase()),
            ontURL
          )
        );
        ...
        System.out.println(
          "OntologyBrowser: remove ontology url exception" + mue
        );
      }
  ...
  protected tufts.vue.VueAction applyStyle = new tufts.vue.VueAction() {
    ...
    public void actionPerformed(java.awt.event.ActionEvent e) {
      ...
      if (chooser.getSelectedFile() != null) {
        ...
        edu.tufts.vue.ontology.Ontology ont =
          ((edu.tufts.vue.ontology.Ontology) (getViewer()
                .getList()
                .getModel()
                .getElementAt(selectedOntology)));
        ...
        try {
          ...
          TypeList tlist = (TypeList) widgetMap
            .get(
              new OntologyBrowserKey(
                edu.tufts.vue.ontology.Ontology.getLabelFromUrl(ont.getBase()),
                url
  ...
  public Widget getWidgetForOntology(edu.tufts.vue.ontology.Ontology o) {
    ...
    return widgetMap.get(
      new OntologyBrowserKey(
        edu.tufts.vue.ontology.Ontology.getLabelFromUrl(o.getBase()),
        ontURL
      )
    );
  }
  ...
  public void initializeBrowser(boolean delayedLoading, DockWindow typeDock) {
    ...
    for (edu.tufts.vue.ontology.Ontology o : edu.tufts.vue.ontology.OntManager
      .getOntManager()
      .getOntList()) {
      ...
      try {
        ...
        list.loadOntology(
          new URL(o.getBase()),
          o.getStyle(),
          OntologyChooser.getOntType(new URL(o.getBase())),
          this,
          w
        );
      } catch (Exception ex) {
  ...
  public void buildSingleDockWindow() {
    ...
    Widget.setHelpAction(
      ontologiesPanel,
      VueResources.getString("dockWindow.Ontologies.helpText")
    );
    Widget.setMiscAction(
      ontologiesPanel,
      new MiscWidgetAction(),
  ...
  private void fireOntologySelectionChanged(TypeList selection) {
    Iterator<OntologySelectionListener> i =
      ontologySelectionListenerList.iterator();
    while (i.hasNext()) {
  ...
  public class OntologyBrowserKey {
    ...
    public boolean equals(Object o) {
      if (!(o instanceof OntologyBrowserKey)) return false; else {
        OntologyBrowserKey key = (OntologyBrowserKey) o;
        return (
          displayName.equals(key.displayName) &&
          identifyingURL.toString().equals(key.identifyingURL.toString())
        );
      }
    }
  }
