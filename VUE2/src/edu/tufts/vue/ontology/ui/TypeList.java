...
public class TypeList extends JList implements MouseListener, ActionListener {
    ...
    addMouseMotionListener(
      new java.awt.event.MouseMotionAdapter() {
        public void mouseDragged(java.awt.event.MouseEvent me) {
          ...
          //try
          //{
          if (comp != null) GUI.startLWCDrag(TypeList.this, me, comp); else {
            comp = createLWComponent(getSelectedValue());
            GUI.startLWCDrag(TypeList.this, me, comp);
          }
          //}
  ...
  public LWComponent createLWComponent(Object type) {
    ...
    if (type instanceof OntType) {
      ...
      if (ontType != null) {
        ...
        if (isNode(ontType)) {
          ...
          if (image == null) {
            ...
            if (DEBUG_LOCAL) {
              System.out.println(
                "TypeList background-image-relative: " +
                image +
                " cssURL " +
                cssURL
              );
          ...
          if (image != null && (relative == false || cssURL != null)) {
            ...
            if (relative && cssURL != null) {
              ...
              if (fs != -1) image = cssURL.substring(0, fs) + "/" + image;
          ...
          } else compFor = new LWNode(ontType.getLabel());
        } else {
          LWLink r = new LWLink();
          r.setHeadPoint(15, 5);
      ...
      } else compFor = new LWNode("null ont type");
    } else {
  ...
  public class LWComponentView extends javax.swing.JComponent {
    ...
    public LWComponentView(/*OntType t*/) {
      ...
      setBorder(
        javax.swing.BorderFactory.createMatteBorder(
          ...
          1,
          0,
          tufts.vue.VueResources.getColor(
    ...
    public void paintComponent(java.awt.Graphics g) {
      ...
      if (!isNode(type)) {
        ...
        old = g.getColor();
        Style style = type.getStyle();
        java.awt.Color fillColor = tufts.vue.VueResources.getColor(
          "node.fillColor"
        );
        if (style != null) {
      ...
      g.drawString(
        type.getLabel(),
        60,
        18 - 2 + g.getFontMetrics().getHeight() / 2
      );
      ...
      if (s != null) {
        ...
        if (
          icon == null &&
          cssURL != null &&
          !(s.getAttribute("background-image-relative") == null)
        ) {
          ...
          icon =
            ...
            s.getAttribute("background-image-relative");
        ...
        if (icon != null) {
          ...
          g.drawImage(
            ii.getImage(),
            OntologyBrowser.getBrowser().getWidth() - 40,
            5,
            26,
            26,
            null
  ...
  class TypeCellRenderer implements ListCellRenderer {
    ...
    public java.awt.Component getListCellRendererComponent(
      ...
      if (
        ...
        OntologyBrowser.getSelectedOntology() == null
      ) {
        ...
        lwcv.setBackground(unselected);
      } else //if(value == getSelectedValue() && (OntologyBrowser.getSelectedOntology()).equals(ontology.getBase() +":" + ontology.getClass()) )
      //if(value == getSelectedValue() && (OntologyBrowser.getSelectedOntology()).equals(ontology +":" + ontology.getClass()) )
      if (
        value == getSelectedValue() &&
        (OntologyBrowser.getSelectedList() == TypeList.this)
      ) {
  ...
  public void loadOntology(
    URL ontologyURL,
    URL cssURL,
    org.osid.shared.Type ontType,
    boolean fromFile
  ) {
    ontology =
      OntManager
        .getOntManager()
        .readOntologyWithStyle(ontologyURL, cssURL, ontType);
  ...
  public void loadOntology(
    final URL ontologyURL,
    final URL cssURL,
    final org.osid.shared.Type ontType,
    final OntologyBrowser browser,
    final tufts.vue.gui.Widget widget
  ) {
    Thread t = new Thread() {
      public void run() {
        JLabel loadingLabelText = new JLabel(
          VueResources.getString("addLibrary.loading.label")
        );
        JLabel loadingLabelImage = new JLabel(
          tufts.vue.VueResources.getImageIcon("dsv.statuspanel.waitIcon")
        );
        JPanel loadingLabel = new JPanel();
        loadingLabel.setLayout(
        ...
        try {
          if (ontType.isEqual(OntologyType.RDFS_TYPE)) ontology =
            new RDFSOntology(ontologyURL.toString()); else if (
            ontType.isEqual(OntologyType.OWL_TYPE)
          ) ontology = new OWLLOntology(ontologyURL.toString()); else { // make a guess, but ontology population will return
          ...
          try {
            ...
            System.out.println(
              "TypeList: exception while updating ontology browser list ui -- " +
              e
            );
          }
          ...
          if (cssURL != null) {
            OntManager
              .getOntManager()
              .populateStyledOntology(ontologyURL, cssURL, ontology);
          } else {
            edu.tufts.vue.ontology.OntManager
              .getOntManager()
          ...
          JLabel fileNotFound = new JLabel(
            VueResources.getString("actionutil.filenotfound.title")
          );
          if (!ontologyURL.toString().contains("file:")) {
            fileNotFound.setText(
              VueResources.getString(
                VueResources.getString("actionutil.locationnotfound.tooltip")
              )
            );
          }
          fileNotFound.setBorder(
            javax.swing.BorderFactory.createEmptyBorder(10, 5, 10, 0)
          );
        ...
        widget.setName(
          widget.getName().substring(7, widget.getName().length())
        );
        ...
        try {
          OntManager
            .getOntManager()
            .getOntology(new URL(ontology.getBase()))
            .setEnabled(true);
        } catch (java.net.MalformedURLException mue) {
          System.out.println(
            "TypeList: malformed url exception attempting to enable ontology " +
            mue
          );
        } catch (Exception npe) {
          System.out.println(
            "TypeList: Exception, likely npe enabling ontology  -- " + npe
          );
        }
        /*try
          {
  ...
  public static boolean isNode(OntType type) {
    ...
    if (style != null) return style
      .getType()
      .equals(SelectorType.getNodeType()); else return SelectorType
      .getDefaultType()
      .equals(SelectorType.getNodeType());
  ...
  public static class OntologyTypeListModel implements ListModel {
    ...
    public Object getElementAt(int index) {
      if (DEBUG_LOCAL) {
        ...
        if (ontology != null) return element; else return null;
      } else {
    ...
    public int getSize() {
      ...
      if (ontology != null) return ontology.getOntTypes().size();
  ...
  private void displayContextMenu(MouseEvent e) {
    ...
    if (o instanceof LWNode) addToMap.setText(
      VueResources.getString("typelist.addnodetomap.tooltip")
    );
    if (o instanceof LWLink) addToMap.setText(
      VueResources.getString("typelist.addlinktomap.tooltip")
    );
  ...
  private final JMenuItem addToMap = new JMenuItem(
    VueResources.getString("menu.addtomap")
  );
  private final JMenuItem addToNode = new JMenuItem(
    VueResources.getString("menu.addtonode")
  );
  ...
  public void actionPerformed(ActionEvent e) {
    if (e.getSource().equals(addToNode)) {
      ...
      if (DEBUG_LOCAL) {
        System.out.println(
          "TypeList --  add to node -- style: " + ((OntType) type).getStyle()
        );
      }
      ...
      if (type != null) {
        ...
        if (resource != null) comp.setResource(resource);
    ...
    if (e.getSource().equals(addToMap)) {
      ...
      if (o instanceof LWNode) active.add((LWNode) o); else if (
        o instanceof LWLink
      ) active.add((LWLink) o);
      ...
      o.setLocation(
        viewer.getVisibleWidth() / 2 - o.getWidth() / 2,
