...
public class OntologyChooser
  ...
  public static final String stepOneMessage =
    "<html>" + VueResources.getString("ontology.step1of2") + "</html>";
  public static final String stepTwoMessage =
    "<html>" + VueResources.getString("ontology.step2of2") + "</html>";
  public static final String browseFileMessage = VueResources.getString(
    "ontology.browsetofile"
  );
  ...
  public static final String styleSheetMessage =
    "<html>" + VueResources.getString("ontology.stylesheet") + "</html>";
  ...
  public static org.osid.shared.Type getOntType(URL ontURL) {
    ...
    if (
      ...
      type.equals("owl")
    ) return edu.tufts.vue.ontology.OntologyType.OWL_TYPE; else return edu.tufts.vue.ontology.OntologyType.OWL_TYPE;
  }
      ...
      if (step == STEP_ONE) {
        ...
        if (ontURLText != null) {
          ...
          try {
            ...
            System.out.println(
              "OntologyChooser: Improper URL, will try file field instead"
            );
            try {
              if (ontFile != null) {
              ...
              System.out.println(
                "OntologyChooser: File also produced Malformed URL " + mue2
              );
            }
          }
          if (!(typeURLField.getText().trim().length() == 0)) {
            ...
            try {
              ...
              //VueUtil.alert("Improper URL, try file field instead?","URL Error");
              System.out.println(
                "OntologyChooser: Improper CSS URL, will try file field instead"
              );
              try {
                if (cssFile != null) {
                ...
                System.out.println(
                  "OntologyChooser: CSS File also produced Malformed URL " +
                  mue2
                );
              }
            }
