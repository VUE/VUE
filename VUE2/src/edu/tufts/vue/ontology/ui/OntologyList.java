...
public class OntologyList
  ...
  implements OntologySelectionListener, MouseListener, ActionListener {
  ...
  public void ontologySelected(OntologySelectionEvent ose) {
    ...
    for (int i = 0; i < getModel().getSize(); i++) {
      if (getModel().getElementAt(i).equals(ont)) setSelectedIndex(i);
    }
  }
  ...
  public static class OntologyListModel extends javax.swing.DefaultListModel {
    ...
    public Object getElementAt(int index) {
      if (
        index >
        edu.tufts.vue.ontology.OntManager.getOntManager().getOntList().size() -
          1
      ) return null; else return edu.tufts.vue.ontology.OntManager
        .getOntManager()
        .getOntList()
        .get(index);
    }
    ...
    public int getSize() {
      return edu.tufts.vue.ontology.OntManager
        .getOntManager()
        .getOntList()
        .size();
    }
  ...
  public static class OntologyListRenderer
    extends javax.swing.DefaultListCellRenderer {

    private Border dividerBorder = new tufts.vue.gui.DashBorder(
    ...
    public OntologyListRenderer() {
      ...
      renderer.setLayout(
        new javax.swing.BoxLayout(renderer, javax.swing.BoxLayout.X_AXIS)
      );
    ...
    public java.awt.Component getListCellRendererComponent(
      ...
      if (index != 0) renderer.setBorder(
        dividerBorder
      ); else renderer.setBorder(emptyBorder);

      edu.tufts.vue.ontology.Ontology ontology =
        (edu.tufts.vue.ontology.Ontology) value;
  ...
  JPopupMenu m = null;
  private static final JMenuItem addStyleSheet = new JMenuItem(
    VueResources.getString("menu.addstylesheet")
  );
  private static final JMenuItem deleteOntology = new JMenuItem(
    VueResources.getString("menu.deleteontology")
  );
  ...
  private JPopupMenu getPopup(MouseEvent e) {
    ...
    edu.tufts.vue.ontology.Ontology o =
      (edu.tufts.vue.ontology.Ontology) this.getModel().getElementAt(index);
    if (o.getCssFileName() != null) addStyleSheet.setLabel(
      "Replace Style Sheet"
    ); else addStyleSheet.setLabel("Add Style Sheet");
