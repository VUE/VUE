...
public class OntologyChooser2
  ...
  public static final String ontTitle =
    "<html><b>" + VueResources.getString("ontology2.title") + "</b><html>";
  //public static final String cssTitle = "<html><b>Ontology Style Sheet*</b></html>";
  public static final String cssTitle =
    "<html><b>" +
    VueResources.getString("ontology2.stylesheet") +
    "</b></html>";
  public static final String browseFileMessage = VueResources.getString(
    "ontology2.selectfile"
  );
  public static final String cssFileMessage = VueResources.getString(
    "ontology2.selectfile"
  );
  public static final String typeURLMessage = VueResources.getString(
    "ontology.typeinurl"
  );
  ...
  public OntologyChooser2(
    ...
    String[] choices = {
      VueResources.getString("ontology2.inlocalfolder"),
      VueResources.getString("ontology2.ontheweb"),
    };
  ...
  public void setUpPanels() {
    ...
    tufts.vue.PolygonIcon lineIcon2 = new tufts.vue.PolygonIcon(
      new java.awt.Color(153, 153, 153)
    );
  ...
  public void setUpOntChoicePanel() {
    ...
    JLabel fileLabel = new JLabel(
      VueResources.getString("ontology2.filelocation")
    );
    c.anchor = GridBagConstraints.WEST;
  ...
  public static org.osid.shared.Type getOntType(URL ontURL) {
    String type = ontURL
      .toString()
      .substring(ontURL.toString().lastIndexOf(".") + 1);
    if (
      type.equals("rdfs")
    ) return edu.tufts.vue.ontology.OntologyType.RDFS_TYPE; else if (
      type.equals("owl")
    ) return edu.tufts.vue.ontology.OntologyType.OWL_TYPE; else return null;
    ...
    if (e.getSource() == nextButton) {
      ...
      if (ontChoice.getSelectedIndex() == BROWSE) {
        try {
          ...
          System.out.println(
            "OntologyChooser: File load produced Malformed URL for ontology " +
            mue2
          );
        }
      }
      ...
      if (ontChoice.getSelectedIndex() == BROWSE) {
        try {
          ...
          System.out.println(
            "OntologyChooser: File load produced Malformed URL for css " + mue2
          );
        }
      }
    ...
    if (e.getSource() == ontBrowseButton) {
      ...
      if (lastDirectory != null) {
        try {
          ...
          System.out.println(
            "OntologyChooser2: Exception opening last ontology directory " + exc
          );
        }
      }
      int success = ontChooser.showOpenDialog(
    ...
    if (e.getSource() == cssBrowseButton) {
      ...
      if (lastDirectory != null) {
        try {
          ...
          System.out.println(
            "OntologyChooser2: Exception opening last css directory " + exc
          );
        }
      }
      int success = cssChooser.showOpenDialog(
        tufts.vue.VUE.getDialogParentAsFrame()
      );
