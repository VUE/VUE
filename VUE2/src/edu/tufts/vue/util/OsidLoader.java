    ...
    public static org.osid.OsidManager getManager(
        ...
        try {
            if ((null != context) && (null != osidPackageManagerName) &&
                ...
                OsidClassLoader osid_class_loader = new OsidClassLoader(
                    Thread.currentThread().getContextClassLoader(),
                    plugins_directory);
                Class osidInterface = Class.forName(osidInterfaceName,
                    true, osid_class_loader);
                            ...
                            if (null != manager) {
                                ...
                                try {
                                    ...
                                    if (null != additionalConfiguration) {
                                        java.util.Enumeration enum2 = additionalConfiguration.propertyNames();

                                        while (enum2.hasMoreElements()) {
                                            java.io.Serializable key = (java.io.Serializable) enum2.nextElement();
