...
public class Utilities {
  ...
  private static String DATE_FORMAT = tufts.vue.VueResources.getString(
    "dataSourceProviderDataFormat"
  );
  ...
  public static org.osid.shared.Id getRepositoryIdFromLoadKey(String loadKey) {
    try {
      ...
      org.osid.id.IdManager idManager = edu.tufts.vue.dsm.impl.VueOsidFactory
        .getInstance()
  ...
  public static String dateToString(java.util.Date date) {
    try {
      return (
        sdf.format(date, new StringBuffer(), new java.text.FieldPosition(0))
      ).toString();
    } catch (Throwable t) {
      edu.tufts.vue.util.Logger.log(
        t,
        "Trying to convert date to string " + date
      );
    }
    return null;
  }
  ...
  public static java.util.Date stringToDate(String dateString) {
    try {
      ...
      edu.tufts.vue.util.Logger.log(
        t,
        "Trying to convert date string to date " + dateString
      );
      return null;
    }
  }
