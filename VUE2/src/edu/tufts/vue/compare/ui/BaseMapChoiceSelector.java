...
public class BaseMapChoiceSelector extends javax.swing.JComboBox {
  ...
  class BaseMapChoiceModel implements javax.swing.ComboBoxModel {
    ...
    private java.util.List<ListDataListener> listeners =
      new java.util.ArrayList<ListDataListener>();
    ...
    public Object getElementAt(int index) {
      if (index == 0) return SELECT_STRING;
      if (index == (getSize() - 1)) return OTHER_STRING; else return getMaps()
        .get(index - 1)
        .getLabel();
    }
    ...
    private java.util.List<LWMap> getMaps() {
      java.util.Iterator<LWMap> allMaps = tufts.vue.VUE
        .getLeftTabbedPane()
        .getAllMaps();
      ...
      while (allMaps.hasNext()) {
        ...
        if (
          !obj.hasClientData(tufts.vue.MergeMapFactory.class)
    ...
    private boolean isBaseMapSelected() {
      if (!(getSelectedItem().equals(SELECT_STRING))) if (
        getSelectedItem().equals(OTHER_STRING) && userSelectedMap == null
    ...
    public LWMap getSelectedMap() {
      if (isBaseMapSelected()) {
        if (
          getSelectedItem().equals(OTHER_STRING)
        ) return userSelectedMap; else {
  ...
  class BorderSeparatorRenderer extends javax.swing.DefaultListCellRenderer {
    ...
    public java.awt.Component getListCellRendererComponent(
      ...
      if (index == 0) label.setBorder(
        javax.swing.BorderFactory.createMatteBorder(
          0,
          0,
          1,
          0,
          new java.awt.Color(140, 140, 140)
        )
      );

      if (index == (getModel().getSize() - 1)) label.setBorder(
        javax.swing.BorderFactory.createMatteBorder(
          1,
          0,
          0,
