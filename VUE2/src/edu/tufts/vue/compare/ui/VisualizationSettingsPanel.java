 ...
 * @author dhelle01
 */
public class VisualizationSettingsPanel
  extends JPanel
  ...
  private String SetParamaterFor = VueResources.getString(
    "dialog.visualizationsettings.SetParamaterFor"
  );
  private String VOTE_STRING = VueResources.getString(
    "dialog.visualizationsettings.vote"
  );
  private String WEIGHT_STRING = VueResources.getString(
    "dialog.visualizationsettings.weight"
  );
  private String visualizationSettingsChoiceMessage = VueResources.getString(
    "dialog.visualizationsettings.ChoiceMessage"
  );
  ...
  private VoteVisualizationSettingsPanel votePanel =
    VoteVisualizationSettingsPanel.getSharedPanel();
  ...
  public VisualizationSettingsPanel() {
    ...
    weightPanel =
      new WeightVisualizationSettingsPanel(weightParameterChoiceDisplayedHere);
    ...
    JLabel visualizationSettingsChoiceLabel = new JLabel(
      visualizationSettingsChoiceMessage
    );
    ...
    gridBag.setConstraints(
      visualizationSettingsChoiceLabel,
      gridBagConstraints
    );
