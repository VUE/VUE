...
public class VoteVisualizationSettingsPanel extends JPanel {
  ...
  public static final String defineThresholdMessage = VueResources.getString(
    "dialog.visualizationsettings.definethreshold"
  );
  ...
  private static VoteVisualizationSettingsPanel panel =
    new VoteVisualizationSettingsPanel();
  ...
  public VoteVisualizationSettingsPanel() {
    ...
    nodeThresholdSlider =
      new JSlider(0, 100, tufts.vue.MergeMapFactory.THRESHOLD_DEFAULT);
    nodeThresholdSlider.addChangeListener(
      new ChangeListener() {
        public void stateChanged(ChangeEvent e) {
          ...
          percentageDisplay.setText(
            VueResources.getFormatMessage(
              node,
              "dialog.visualizationsettings.nodespercentage"
            )
          );
    ...
    linkThresholdSlider.addChangeListener(
      new ChangeListener() {
        public void stateChanged(ChangeEvent e) {
          Object link[] = { linkThresholdSlider.getValue() };
          linkPercentageDisplay.setText(
            VueResources.getFormatMessage(
              link,
              "dialog.visualizationsettings.linkspercentage"
            )
