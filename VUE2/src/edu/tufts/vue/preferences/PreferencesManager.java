...
public class PreferencesManager {
  ...
  static {
    ...
    AlchemyAPIPreference alchemyPref =
      edu.tufts.vue.preferences.implementations.AlchemyAPIPreference.getInstance();

    if (tufts.Util.isWindowsPlatform()) PreferencesManager.registerPreference(
      edu.tufts.vue.preferences.implementations.EnhancedFileChooserPreference.class
    );
  ...
  public static PreferencesManager getSingletonObject() {
    if (ref == null) ref = new PreferencesManager();
    return ref;
  }
  ...
  public static int getIntegerPrefValue(Object s) {
    ...
    return java.util.prefs.Preferences
      .userNodeForPackage(PreferencesManager.class)
      .getInt(p.getPrefName(), ((Integer) p.getDefaultValue()).intValue());
  }
  ...
  public static boolean getBooleanPrefValue(Object s) {
    ...
    return java.util.prefs.Preferences
      ...
      .getBoolean(
        p.getPrefName(),
        ((Boolean) p.getDefaultValue()).booleanValue()
      );
  }
