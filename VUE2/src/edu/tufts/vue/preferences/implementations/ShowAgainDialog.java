...
public class ShowAgainDialog
  ...
  private void setUpUI(JPanel panel) {
    ...
    gbc.fill = GridBagConstraints.BOTH;
    showAgainBox.setText(
      VueResources.getString("showagaindialog.donotshow.tooltip")
    );
    showAgainBox.setSelected(
      !((Boolean) showAgainPref.getValue()).booleanValue()
    );
    ...
    if (cancelLabel != null) dialogContentPane.add(cancelButton, gbc);
    ...
    if (okLabel != null) dialogContentPane.add(okButton, gbc);
  ...
  public static void main(String[] args) {
    ...
    ShowAgainDialog sad = new ShowAgainDialog(
      null,
      "blah",
      "Delete Pathway",
      "OK",
