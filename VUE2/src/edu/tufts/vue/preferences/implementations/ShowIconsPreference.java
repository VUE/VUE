...
public class ShowIconsPreference extends BasePref implements ItemListener {
  ...
  public ShowIconsPreference() {
    ...
    this.description =
      VueResources.getString("preference.showicon.decsription");
  ...
  public JComponent getPreferenceUI() {
    ...
    resourceCheckbox.setSelected(
      ((Boolean) getValue(resourceIconName)).booleanValue()
    );
    //behaviorCheckbox.setSelected(((Boolean)getValue(behaviorIconName)).booleanValue());
    notesCheckbox.setSelected(
      ((Boolean) getValue(notesIconName)).booleanValue()
    );
    pathwayCheckbox.setSelected(
      ((Boolean) getValue(pathwayIconName)).booleanValue()
    );
    metaDataCheckbox.setSelected(
      ((Boolean) getValue(metaDataIconName)).booleanValue()
    );
    hierarchyCheckbox.setSelected(
      ((Boolean) getValue(hierarchyIconName)).booleanValue()
    );
  ...
  public void itemStateChanged(ItemEvent e) {
    ...
    if (box.equals(resourceCheckbox)) setValue(
      resourceIconName,
    ...
    else if (box.equals(notesCheckbox)) setValue(
      notesIconName,
      Boolean.valueOf(box.isSelected())
    ); else if (box.equals(pathwayCheckbox)) setValue(
      pathwayIconName,
      Boolean.valueOf(box.isSelected())
    ); else if (box.equals(metaDataCheckbox)) setValue(
      metaDataIconName,
      Boolean.valueOf(box.isSelected())
    ); else if (box.equals(hierarchyCheckbox)) setValue(
      hierarchyIconName,
      Boolean.valueOf(box.isSelected())
    );
  }
  ...
  public void setValue(String prefName, Object b) {
    if (prefName.equals(resourceIconName)) previousResourceValue =
      Boolean.valueOf(resourceCheckbox.isSelected());
    //else if (prefName.equals(behaviorIconName))
    //	previousBehaviorValue = Boolean.valueOf(behaviorCheckbox.isSelected());
    else if (prefName.equals(notesIconName)) previousNotesValue =
      Boolean.valueOf(notesCheckbox.isSelected()); else if (
      prefName.equals(pathwayIconName)
    ) previousPathwayValue =
      Boolean.valueOf(pathwayCheckbox.isSelected()); else if (
      prefName.equals(metaDataIconName)
    ) previousMetaDataValue =
      Boolean.valueOf(metaDataCheckbox.isSelected()); else if (
      prefName.equals(hierarchyIconName)
  ...
  public Object getPreviousValue(String prefName) {
    if (prefName.equals(resourceIconName)) return (
        previousResourceValue == null
      )
    ...
    else if (prefName.equals(notesIconName)) return (previousNotesValue == null)
      ? getDefaultValue(prefName)
      : previousNotesValue; else if (prefName.equals(pathwayIconName)) return (
        previousPathwayValue == null
      )
      ? getDefaultValue(prefName)
      : previousPathwayValue; else if (
      prefName.equals(metaDataIconName)
    ) return (previousMetaDataValue == null)
      ? getDefaultValue(prefName)
      : previousMetaDataValue; else if (
      prefName.equals(hierarchyIconName)
    ) return (previousHierarchyValue == null)
      ? getDefaultValue(prefName)
      : previousHierarchyValue; else return new Boolean(true);
  }

  public Object getDefaultValue(String prefName) {
    if (prefName.equals(resourceIconName)) return resourceIconDefault;
    //else if (prefName.equals(behaviorIconName))
    //	return behaviorIconDefault;
    else if (prefName.equals(notesIconName)) return notesIconDefault; else if (
      prefName.equals(pathwayIconName)
    ) return pathwayIconDefault; else if (
      prefName.equals(metaDataIconName)
    ) return metaDataIconDefault; else if (
      prefName.equals(hierarchyIconName)
    ) return hierarchyIconDefault; else return new Boolean(true);
  }
