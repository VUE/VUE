...
public class LanguagePreference
  extends edu.tufts.vue.preferences.generics.GenericListPreference {

  protected static final org.apache.log4j.Logger Log =
    org.apache.log4j.Logger.getLogger(LanguagePreference.class);
  ...
  private LanguagePreference(
    ...
    this.defaultValue =
      (defaultValue != null
          ? defaultValue
          : fixCaps(Locale.getDefault().getDisplayName()));
        ...
        public void run() {
          ...
          try {
              ...
              while (jarEntries.hasMoreElements()) {
                ...
                if (
                  ...
                  String foundLanguage =
                    foundLocale.getLanguage(), localizedDisplayName = fixCaps(
                    foundLocale.getDisplayName(new Locale(foundLanguage))
                  );
                  ...
                  if (localizedDisplayName.length() > 0) {
                    ...
                    foundLocales.add(
                      new StringPair(
                        ...
                        foundLanguage +
                        (foundCountry.length() < 2 ? "" : ("_" + foundCountry))
                      )
                    );
                  }
                }
            ...
            for (int index = 0; index < modelSize; index++) {
              if (
                prefValue.equals(
                  ((StringPair) model.getElementAt(index)).getValue()
                )
              ) {
    ...
    return Preferences
      ...
      .get(
        ...
        Preferences
          ...
          .get(getPrefName() + ".code", Locale.getDefault().toString())
      );
  }
