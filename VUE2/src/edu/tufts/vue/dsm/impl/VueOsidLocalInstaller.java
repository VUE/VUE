...
public class VueOsidLocalInstaller
  ...
  private static edu.tufts.vue.dsm.OsidLocalInstaller installer =
    new VueOsidLocalInstaller();
  ...
  /**
	...
	*/
  public void installPlugin(String filename, java.io.InputStream in) {
    try {
      java.io.File file = new java.io.File(
        edu.tufts.vue.util.Utilities.getOsidDownloadDirectory() + filename
      );
