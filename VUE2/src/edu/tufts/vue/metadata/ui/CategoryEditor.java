...
public class CategoryEditor extends JPanel {
  ...
  public static final int ROW_INSET = 0;
  ...
  public CategoryEditor(
    ...
    customCategoryTable.setDefaultRenderer(
      java.lang.Object.class,
      new CustomCategoryTableRenderer()
    );
    customCategoryTable.setDefaultEditor(
      java.lang.Object.class,
      new CustomCategoryTableEditor()
    );
    ((DefaultCellEditor) customCategoryTable.getDefaultEditor(
        java.lang.Object.class
      )).setClickCountToStart(1);
    customCategoryTable
      .getColumnModel()
      .getColumn(0)
      .setHeaderRenderer(new CustomCategoryTableHeaderRenderer());
    customCategoryTable
      .getColumnModel()
      .getColumn(1)
      .setHeaderRenderer(new CustomCategoryTableHeaderRenderer());
    ...
    customCategoryTable
      .getColumnModel()
      .getColumn(0)
      .setMinWidth(editorWidth - BUTTON_COL_WIDTH);
    customCategoryTable
      .getColumnModel()
      .getColumn(1)
    ...
    customCategoryTable.setGridColor(
      new java.awt.Color(
      ...
      .addMouseListener(
        new java.awt.event.MouseAdapter() {
          public void mousePressed(java.awt.event.MouseEvent evt) {
            if (
              evt.getX() > customCategoryTable.getWidth() - BUTTON_COL_WIDTH
            ) {
          ...
          public void mouseEntered(java.awt.event.MouseEvent e) {
            ...
            if (
              (customCategoryTable.getCellEditor() != null)
              /* && (e.getX()>customCategoryTable.getWidth()-BUTTON_COL_WIDTH)*/
            ) {
              customCategoryTable.getCellEditor().stopCellEditing();
            }
          }
  ...
  class CustomCategoryTableRenderer extends DefaultTableCellRenderer {
    ...
    tufts.vue.gui.VueButton deleteButton = new tufts.vue.gui.VueButton(
      "keywords.button.delete"
    );
        ...
        deleteButton.addMouseListener(
          new java.awt.event.MouseAdapter() {
            public void mouseReleased(java.awt.event.MouseEvent evt) {
              ...
              //{
              CategoryModel vueCategoryModel = tufts.vue.VUE.getCategoryModel();
              java.util.List<OntType> ontTypes = vueCategoryModel
                .getCustomOntology()
                .getOntTypes();
              //int selectedRow = customCategoryTable.getSelectedRow();
              //if(customCategoryTable.getSelectedColumn()== 1 && ontTypes.size() > selectedRow)
              //{
              if (ontTypes.size() > row) ontTypes.remove(row);
              //customCategoryTable.repaint();
              //requestFocusInWindow();
              tufts.vue.VUE.getCategoryModel().saveCustomOntology();
          ...
          new java.awt.event.FocusAdapter() {
            public void focusLost(java.awt.event.FocusEvent fe) {
              ...
              if (
                ...
                CategoryModel cats = tufts.vue.VUE.getCategoryModel();
                cats.addCustomCategory(
                  label.getText(),
                  cats.getCustomOntology().getOntTypes().get(row)
                );
  ...
  class MetadataCategoryTableModel extends AbstractTableModel {
    ...
    public int getRowCount() {
      ...
      if (
        customOntology == null ||
        vueCategoryModel.getCustomOntology().getOntTypes().size() == 0
      ) {
        newCategoryRequested = true;
        return 1;
      }
      ...
      if (
        /*(customOntology !=null) &&*/!newCategoryRequested
      ) return vueCategoryModel
        .getCustomOntology()
        .getOntTypes()
        .size(); else if (customOntology != null) return (
        vueCategoryModel.getCustomOntology().getOntTypes().size() + 1
      ); else return 0;
    ...
    public Object getValueAt(int row, int col) {
      ...
      if (
        col == 0 &&
        row < vueCategoryModel.getCustomOntology().getOntTypes().size()
      ) {
        OntType category = vueCategoryModel
          .getCustomOntology()
          .getOntTypes()
          .get(row);
        return category;
