 ...
 * @author dhelle01
 */
public class OntologicalMembershipPane
  extends javax.swing.JPanel
  implements ActiveListener, OntologySelectionListener {
  ...
  public OntologicalMembershipPane() {
    ...
    JLabel label = new JLabel(
      VueResources.getString("ontologicalmembership.association"),
      JLabel.LEFT
    );
      ...
      new java.awt.event.MouseAdapter() {
        ...
        public void mousePressed(java.awt.event.MouseEvent e) {
          ...
          if (
            ...
            !current.getMetadataList().hasOntologicalMetadata()
          ) {
            return;
          }

          if (
            e.getPoint().x < OntologicalMembershipPane.this.getWidth() - 40
          ) return;

          int categoryIndex =
            ((edu.tufts.vue.metadata.MetadataList.CategoryFirstList) current
                .getMetadataList()
                .getMetadata()).getCategoryEndIndex();
    ...
    addSelectedTerm =
      new JButton(VueResources.getString("ontologicalmembership.selectedterm"));
    addSelectedTerm.setFont(tufts.vue.gui.GUI.LabelFace);

    addSelectedTerm.addActionListener(
      new ActionListener() {
        public void actionPerformed(ActionEvent e) {
          TypeList selectedList = OntologyBrowser
            .getBrowser()
            .getSelectedList();
  ...
  class OntologyTypeListRenderer extends javax.swing.DefaultListCellRenderer {
    ...
    public OntologyTypeListRenderer() {
      ...
      javax.swing.border.Border emptyBorder2 =
        javax.swing.BorderFactory.createEmptyBorder(5, 5, 5, 5);
      javax.swing.border.Border innerCompoundBorder =
        javax.swing.BorderFactory.createCompoundBorder(emptyBorder, lineBorder);
      javax.swing.border.Border outerCompoundBorder =
    ...
    public java.awt.Component getListCellRendererComponent(
      ...
      String ontValue =
        ((edu.tufts.vue.metadata.VueMetadataElement) value).getValue();
      if (ontValue == null) return panel;
      String label = ontValue.substring(
        ontValue.indexOf("#") + 1,
        ontValue.length()
      );
      setText(label);
  ...
  class OntologyTypeListModel extends javax.swing.DefaultListModel {
    ...
    public int getSize() {
      if (current != null) return current
        .getMetadataList()
        .getOntologyListSize(); else return 0;
    }
