...
public class DatasetLoader {
  ...
  public static final String LOADER_LABEL = VueResources.getString(
    "dialog.datasettype.title"
  );
  JDialog dialog;
  Dataset ds;
  ...
  private JPanel createDatasetsTypePanel() {
    ...
    radioButtons[0] =
      new JRadioButton(VueResources.getString("jbutton.list.label"));
    radioButtons[0].setActionCommand(listDS);

    radioButtons[1] =
      new JRadioButton(VueResources.getString("jbutton.relational.label"));
    radioButtons[1].setActionCommand(relationalDS);

    radioButtons[2] =
      new JRadioButton(VueResources.getString("jbutton.folder.label"));
    ...
    JButton loadButton = new JButton(
      VueResources.getString("jbutton.load.label")
    );
    ...
    return createPane(
      VueResources.getString("pane.dataset.message"),
      radioButtons,
      loadButton
    );
  }
