...
public class Factory {
  ...
  public static Object createInstance(String clazzName) {
    ...
    try {
      ...
      try {
        ...
        throw new RuntimeException(
          "Provider's class not found in classpath..." + clazzName,
          ne
        );
      }
    }
    ...
    try {
      ...
      throw new RuntimeException(
        "cannot invoke the constructor a InferenceService!",
        ite
      );
      ...
      throw new RuntimeException(
        "cannot instantiate a InferenceService!",
        inse
      );
    }
    ...
    if (!providerClass.isInstance(result)) {
      throw new RuntimeException(
        "the supplied class '" +
        clazzName +
        "' does not support the InferenceService API!"
      );
    }
    return result;
  }

  private static Object createHandlerService(
    String clazzName,
    Class[] paramTypes,
    Object[] paramValues
  ) {
