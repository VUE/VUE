...
public class Query {
  ...
  private static final org.apache.log4j.Logger Log =
    org.apache.log4j.Logger.getLogger(Query.class);
  ...
  private static final String QueryStart =
    "PREFIX vue: <" +
    RDFIndex.VUE_ONTOLOGY +
    ">" +
    "\nSELECT ?rid ?val WHERE { ";
  private static final String QueryForProperty =
    "?rid <%s> ?val FILTER regex(?val, \"%s%s\", \"i\") .";
  ...
  public String createSPARQLQuery() {
    final StringBuilder query = new StringBuilder(
      QueryStart.length() + QueryForProperty.length() + 16
    );
