...
public class VueFederatedSearchManager
  ...
  private edu.tufts.vue.fsm.SourcesAndTypesManager sourcesAndTypesManager =
    VueSourcesAndTypesManager.getInstance();
  private static final org.apache.log4j.Logger Log =
    org.apache.log4j.Logger.getLogger(VueFederatedSearchManager.class);
  ...
  private static final String ARTIFACT_SEARCH_TYPE =
    "search/artifact@tufts.edu";
  private static final String ARTIFACT_CLASS_NAME =
    "edu.tufts.artifact.ui.ArtifactQueryEditor";

  private static edu.tufts.vue.fsm.FederatedSearchManager federatedSearchManager =
    new VueFederatedSearchManager();
  ...
  private java.util.Vector queryAdjusterRepositoryIdStringVector =
    new java.util.Vector();
  private java.util.Vector queryAdjusterClassNameVector =
    new java.util.Vector();
  ...
  private String[] getXMLFilenames() {
    ...
    try {
      String targetFilename = tufts.vue.VueResources.getString(
        "extensionsSaveToXmlFilename"
      );
      //System.out.println("target filename " + targetFilename);
      String installDirectory = tufts.vue.VueResources.getString(
        "dataSourceInstallDirectory"
      );
      //System.out.println("install Directory " + installDirectory);
      Log.info(
        "listing " + installDirectory + " to find \"" + targetFilename + "\""
      );
    ...
    filenameVector.addElement(
      userFolder.getAbsolutePath() +
      "/" +
      tufts.vue.VueResources.getString("extensionsSaveToXmlFilename")
    );
  ...
  private VueFederatedSearchManager() {
    try {
      ...
      if (!file.exists()) {
        ...
        org.w3c.dom.Element searchtype = document.createElement(
          SEARCH_TYPE_TAG
        );
        ...
        org.w3c.dom.Element artifactEditor = document.createElement(
          QUERY_EDITOR_TAG
        );
        org.w3c.dom.Element artifactSearchtype = document.createElement(
          SEARCH_TYPE_TAG
        );
        artifactSearchtype.appendChild(
          document.createTextNode(ARTIFACT_SEARCH_TYPE)
        );
        org.w3c.dom.Element artifactClassname = document.createElement(
          CLASS_NAME_TAG
        );
        artifactClassname.appendChild(
          document.createTextNode(ARTIFACT_CLASS_NAME)
        );
      ...
      for (int f = 0; f < files.length; f++) {
        ...
        org.w3c.dom.NodeList queryEditors = document.getElementsByTagName(
          QUERY_EDITORS_TAG
        );
        int numQueryEditors = queryEditors.getLength();
        for (int i = 0; i < numQueryEditors; i++) {
          org.w3c.dom.Element queryEditor =
            (org.w3c.dom.Element) queryEditors.item(i);

          org.w3c.dom.NodeList typeNodeList = queryEditor.getElementsByTagName(
            SEARCH_TYPE_TAG
          );
          int numTypes = typeNodeList.getLength();

          org.w3c.dom.NodeList classNameNodeList =
            queryEditor.getElementsByTagName(CLASS_NAME_TAG);
          int numClassNames = classNameNodeList.getLength();

          for (int j = 0; j < numTypes; j++) {
            org.w3c.dom.Element typeElement =
              (org.w3c.dom.Element) typeNodeList.item(j);
            if (typeElement.hasChildNodes()) {
              queryEditorTypeVector.addElement(
                typeElement.getFirstChild().getNodeValue()
              );

              // ensure there is some entry in the vector
              if (numClassNames >= j) {
                org.w3c.dom.Element classNameElement =
                  (org.w3c.dom.Element) classNameNodeList.item(j);
                if (classNameElement.hasChildNodes()) {
                  queryEditorClassNameVector.addElement(
                    classNameElement.getFirstChild().getNodeValue()
                  );
                } else {
        ...
        org.w3c.dom.NodeList queryAdjusters = document.getElementsByTagName(
          QUERY_ADJUSTERS_TAG
        );
        int numQueryAdjusters = queryAdjusters.getLength();
        for (int i = 0; i < numQueryAdjusters; i++) {
          org.w3c.dom.Element queryAdjuster =
            (org.w3c.dom.Element) queryAdjusters.item(i);

          org.w3c.dom.NodeList repositoryIdNodeList =
            queryAdjuster.getElementsByTagName(REPOSITORY_ID_TAG);
          int numRepositoryIds = repositoryIdNodeList.getLength();

          org.w3c.dom.NodeList classNameNodeList =
            queryAdjuster.getElementsByTagName(CLASS_NAME_TAG);
          int numClassNames = classNameNodeList.getLength();

          for (int j = 0; j < numRepositoryIds; j++) {
            org.w3c.dom.Element repositoryIdElement =
              (org.w3c.dom.Element) repositoryIdNodeList.item(j);
            if (repositoryIdElement.hasChildNodes()) {
              queryAdjusterRepositoryIdStringVector.addElement(
                repositoryIdElement.getFirstChild().getNodeValue()
              );
              ...
              if (numClassNames >= j) {
                org.w3c.dom.Element classNameElement =
                  (org.w3c.dom.Element) classNameNodeList.item(j);
                if (classNameElement.hasChildNodes()) {
                  queryAdjusterClassNameVector.addElement(
                    classNameElement.getFirstChild().getNodeValue()
                  );
                } else {
        ...
        org.w3c.dom.NodeList assetViewers = document.getElementsByTagName(
          ASSET_VIEWERS_TAG
        );
        int numAssetViewers = assetViewers.getLength();
        for (int i = 0; i < numAssetViewers; i++) {
          org.w3c.dom.Element assetViewer =
            (org.w3c.dom.Element) assetViewers.item(i);

          org.w3c.dom.NodeList typeNodeList = assetViewer.getElementsByTagName(
            ASSET_TYPE_TAG
          );
          int numTypes = typeNodeList.getLength();

          org.w3c.dom.NodeList classNameNodeList =
            assetViewer.getElementsByTagName(CLASS_NAME_TAG);
          int numClassNames = classNameNodeList.getLength();
          ...
          for (int j = 0; j < numTypes; j++) {
            org.w3c.dom.Element typeElement =
              (org.w3c.dom.Element) typeNodeList.item(j);
            if (typeElement.hasChildNodes()) {
              assetViewerTypeVector.addElement(
                typeElement.getFirstChild().getNodeValue()
              );
              ...
              if (numClassNames >= j) {
                org.w3c.dom.Element classNameElement =
                  (org.w3c.dom.Element) classNameNodeList.item(j);
                if (classNameElement.hasChildNodes()) {
                  assetViewerClassNameVector.addElement(
                    classNameElement.getFirstChild().getNodeValue()
                  );
                } else {
  ...
  /*
	 ...
	 */
  public edu.tufts.vue.fsm.QueryEditor getQueryEditorForType(
    ...
    try {
      if (searchType == null) {
        ...
        String searchTypeString = edu.tufts.vue.util.Utilities.typeToString(
          searchType
        );
        int startIndex = 0;
        int index = -1;
        while (
          (index =
              queryEditorTypeVector.indexOf(searchTypeString, startIndex)) !=
          -1
        ) {
          String className = (String) queryEditorClassNameVector.elementAt(
            index
          );
  ...
  public edu.tufts.vue.fsm.QueryAdjuster getQueryAdjusterForRepository(
    ...
    try {
      ...
      while (
        (index =
            queryAdjusterRepositoryIdStringVector.indexOf(
              repositoryIdString,
              startIndex
            )) !=
        -1
      ) {
        String className = (String) queryAdjusterClassNameVector.elementAt(
          index
        );
        //TODO: we need to find this via Provider
        try {
  ...
  public edu.tufts.vue.fsm.AssetViewer getAssetViewerForType(
    org.osid.shared.Type assetType
  ) {
    try {
      String assetTypeString = edu.tufts.vue.util.Utilities.typeToString(
        assetType
      );
      int startIndex = 0;
      int index = -1;
      ...
      while (
        (index = assetViewerTypeVector.indexOf(assetTypeString, startIndex)) !=
        -1
      ) {
  ...
  public edu.tufts.vue.fsm.ResultSetManager getResultSetManager(
    ...
    try {
      ...
      edu.tufts.vue.fsm.Query queries[] =
        new edu.tufts.vue.fsm.Query[repositories.length];
      for (int i = 0; i < repositories.length; i++) {
        ...
        edu.tufts.vue.fsm.QueryAdjuster adjuster =
          getQueryAdjusterForRepository(repository.getId());
        if (adjuster != null) {
          queries[i] =
            adjuster.adjustQuery(
              repository,
              searchCriteria,
              searchType,
              searchProperties
          ...
          queries[i] =
            new VueQuery(
              dataSources[i].getId().getIdString(),
              repository,
              searchCriteria,
              searchType,
              searchProperties
