...
public class DefaultQueryEditor
  ...
  private org.osid.shared.Type keywordSearchType = new edu.tufts.vue.util.Type(
    "mit.edu",
    "search",
    "keyword"
  );
  private org.osid.shared.Type multiFieldSearchType =
    new edu.tufts.vue.util.Type("mit.edu", "search", "multiField");
  ...
  private static final String SearchLabel = VueResources.getString(
    "defaultqueryeditor.search"
  );
  private static final String StopLabel = VueResources.getString(
    "defaultqueryeditor.stopsearch"
  );

  private static final javax.swing.JButton searchButton1 =
    new javax.swing.JButton(SearchLabel);
  private static final javax.swing.JButton searchButton2 =
    new javax.swing.JButton(SearchLabel);

  private static final String SELECT_A_LIBRARY = VueResources.getString(
    "defaultqueryeditor.pleaseselect"
  );
  //private static final String NO_MESSAGE = "";
  private final javax.swing.JLabel selectMessage = new javax.swing.JLabel(
    SELECT_A_LIBRARY,
    javax.swing.JLabel.CENTER
  );

  private javax.swing.JButton moreOptionsButton = new tufts.vue.gui.VueButton(
    "advancedSearchMore"
  );
  ...
  private javax.swing.JButton fewerOptionsButton = new tufts.vue.gui.VueButton(
    "advancedSearchLess"
  );
  ...
  private java.util.Vector advancedSearchUniverseOfTypeStringsVector =
  ...
  private static final javax.swing.JCheckBox mapBasedSearchCheckBox =
    new javax.swing.JCheckBox(
      VueResources.getString("defaultQueryEditor.mapBasedSearchLabel")
    );
  ...
  public DefaultQueryEditor() {
    ...
    try {
      ...
      // make button panels
      java.awt.GridBagLayout moreOptionsButtonPanelgbLayout =
        new java.awt.GridBagLayout();
      java.awt.GridBagConstraints moreOptionsButtonPanelgbConstraints =
        new java.awt.GridBagConstraints();
      ...
      moreOptionsButtonPanelgbConstraints.fill =
        java.awt.GridBagConstraints.NONE;
      moreOptionsButtonPanelgbConstraints.weightx = 0;
      moreOptionsButtonPanel.add(
        moreOptionsButton,
        moreOptionsButtonPanelgbConstraints
      );

      moreOptionsButtonPanelgbConstraints.gridx = 1;
      moreOptionsButtonPanelgbConstraints.fill =
        java.awt.GridBagConstraints.NONE;
      moreOptionsButtonPanelgbConstraints.anchor =
      ...
      java.awt.GridBagLayout fewerOptionsButtonPanelgbLayout =
        new java.awt.GridBagLayout();
      java.awt.GridBagConstraints fewerOptionsButtonPanelgbConstraints =
        new java.awt.GridBagConstraints();
      ...
      fewerOptionsButtonPanelgbConstraints.fill =
        java.awt.GridBagConstraints.NONE;
      fewerOptionsButtonPanelgbConstraints.weightx = 0;
      fewerOptionsButtonPanel.add(
        fewerOptionsButton,
        fewerOptionsButtonPanelgbConstraints
      );

      fewerOptionsButtonPanelgbConstraints.gridx = 1;
      fewerOptionsButtonPanelgbConstraints.fill =
        java.awt.GridBagConstraints.NONE;
      fewerOptionsButtonPanelgbConstraints.anchor =
        java.awt.GridBagConstraints.EAST;
  ...
  public static int getSelectedRepositoryCount() {
    if (repositories != null) return repositories.length; else return 0;
  }
...
*/
  ...
  private void makeBasicPanel() {
    ...
    javax.swing.JLabel searchTypeLabel = new javax.swing.JLabel(
      VueResources.getString("defaultQueryEditor.searchTypeLabel")
    );
    ...
    mapBasedSearchCheckBox.addActionListener(
      new ActionListener() {
        public void actionPerformed(ActionEvent e) {
          ...
          if (
            mapBasedSearchCheckBox.isSelected() &&
            !(selection.size() == 1 &&
              selection.get(0) instanceof tufts.vue.LWNode)
          ) {
    ...
    gbConstraints.weightx = 0;
    gbConstraints.anchor = java.awt.GridBagConstraints.EAST;
    javax.swing.JLabel keywordLbl = new javax.swing.JLabel(
    ...
    javax.swing.JLabel moreOptionLbl = new javax.swing.JLabel(
      VueResources.getString("jlabel.moreoption")
    );
  ...
  private class AdvancedFieldKeyListener extends KeyAdapter {
    ...
    public void keyReleased(KeyEvent ke) {
      ...
      for (int i = 0; i < len; i++) {
        sum +=
        ((String) (advancedFields[i].getText())).replaceAll(" ", "").length();
      }
  ...
  private void makeAdvancedIntersectionPanel() {
    gbConstraints.gridx = 0;
    gbConstraints.gridy = 0;
    AdvancedFieldKeyListener advancedKeyListener =
      new AdvancedFieldKeyListener();
    ...
    gbConstraints.gridx = 0;
    add(
      new javax.swing.JLabel(VueResources.getString("jlabel.feweroption")),
      gbConstraints
    );
  ...
  private void makeAdvancedUnionPanel() {
    ...
    if (size == 0) {
      ...
      add(
        new javax.swing.JLabel(VueResources.getString("jlabel.nodublin")),
        gbConstraints
      );
      gbConstraints.gridy++;
      //searchButton2.setEnabled(false);
      ...
      for (int i = 0; i < size; i++) {
        ...
        gbConstraints.weightx = 0;
        add(
          new javax.swing.JLabel((String) typesVector.elementAt(i)),
          gbConstraints
        );
        gbConstraints.gridx = 1;
        advancedFields[i] = new javax.swing.JTextField(8);
        ...
        if (searchButton1.getText() == StopLabel) {
          ...
          for (int i = 0; i < listeners.length; i += 2) {
            if (listeners[i] == edu.tufts.vue.fsm.event.SearchListener.class) {
              ((edu.tufts.vue.fsm.event.SearchListener) listeners[i +
                  1]).searchPerformed(null);
            }
          }
  ...
  public void addSearchListener(
    edu.tufts.vue.fsm.event.SearchListener listener
  ) {
  ...
  private void fireSearch(edu.tufts.vue.fsm.event.SearchEvent evt) {
    ...
    for (int i = 0; i < listeners.length; i += 2) {
      if (listeners[i] == edu.tufts.vue.fsm.event.SearchListener.class) {
        ((edu.tufts.vue.fsm.event.SearchListener) listeners[i +
            1]).searchPerformed(evt);
      }
    }

    if (evt == null) completeSearch();
  }
      ...
      for (int i = 0; i < repositories.length; i++) {
        ...
        try {
          org.osid.shared.TypeIterator typeIterator =
            repositories[i].getAssetTypes();
          while (typeIterator.hasNextType()) {
            org.osid.shared.Type nextAssetType = typeIterator.nextType();

            org.osid.repository.RecordStructureIterator recordStructureIterator =
              repositories[i].getMandatoryRecordStructures(nextAssetType);
            while (recordStructureIterator.hasNextRecordStructure()) {
              org.osid.repository.PartStructureIterator partStructureIterator =
                recordStructureIterator
                  .nextRecordStructure()
                  .getPartStructures();
              while (partStructureIterator.hasNextPartStructure()) {
                org.osid.shared.Type nextType = partStructureIterator
                  .nextPartStructure()
                  .getType();
                String nextTypeString =
                  edu.tufts.vue.util.Utilities.typeToString(nextType);

                int index = advancedSearchUniverseOfTypeStringsVector.indexOf(
                  nextTypeString
                );
                if (index != -1) {
                  String prompt =
                    (String) advancedSearchPromptsVector.elementAt(index);
  ...
  private java.util.Vector getIntersectionSearchFields() {
    ...
    try {
      ...
      if (numIntersections == 0) {
        ...
        java.util.Vector intersection =
          (java.util.Vector) intersections.firstElement();
        for (int j = 1; j < numIntersections; j++) {
          java.util.Vector nextIntersection =
            (java.util.Vector) intersections.elementAt(j);
  ...
  private void populateAdvancedSearchUniverseOfTypeStringsVector() {
    advancedSearchUniverseOfTypeStringsVector.addElement(
    ...
    for (int i = 0; i < advancedFields.length; i++) {
      ...
      if (value.trim().length() > 0) {
        ...
        if (index == -1) {
          ...
          typeString =
            (String) advancedSearchUniverseOfTypeStringsVector.elementAt(index);
        }
  ...
  public void selectionChanged(LWSelection selection) {
    if (
      mapBasedSearchCheckBox.isSelected() &&
      !(selection.size() == 1 && selection.get(0) instanceof tufts.vue.LWNode)
    ) {
