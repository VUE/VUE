...
public class ConfigurationUI extends javax.swing.JPanel {
  ...
  private static final org.apache.log4j.Logger Log =
    org.apache.log4j.Logger.getLogger(ConfigurationUI.class);
  ...
  public ConfigurationUI(
    ...
    java.util.Map<String, Vector> extraValues
  ) {
          ...
          switch (uiCode.intValue()) {
            ...
            case BOOLEAN_CONTROL:
              try {
                ...
                this.errorMessage =
                  "Default value for " + key + " must be true or false";
                return;
              }
              break;
            case INTEGER_CONTROL:
              try {
                ...
                this.errorMessage =
                  "Default value for " + key + " must be an integer";
                return;
              }
              break;
            case FLOAT_CONTROL:
              try {
                ...
                this.errorMessage =
                  "Default value for " + key + " must be a float";
                return;
              }
              break;
            case DATE_TIME_CONTROL:
              try {
                ...
                this.errorMessage =
                  "Default value for " + key + " must be a date";
                return;
              }
              break;
        ...
        switch (uiCode) {
          ...
          case COMBO_BOX_CONTROL:
            ...
            if (extraValues == null || extraValues.size() == 0) {
              ...
              if (extraValues == null) extraValues = new Vector();

              if (
                valuesVector != null && valuesVector.size() > i
              ) extraValues.addAll((Vector) valuesVector.elementAt(i));
            }
            Log.info(
              String.format(
                "creating JComboBox: default=[%s]; extra fields for key [%s]: %s",
                defaultValue,
                key,
          ...
          case SINGLE_LINE_CLEAR_TEXT_CONTROL:
            ...
            break;
          case SINGLE_LINE_MASKED_TEXT_CONTROL:
            javax.swing.JPasswordField textField1 =
          ...
          case INTEGER_CONTROL:
            ...
            if (defaultValue != null) {
              textField4 =
                new javax.swing.JFormattedTextField(new Integer(defaultValue));
            } else {
          ...
          case FLOAT_CONTROL:
            ...
            if (defaultValue != null) {
              textField5 =
                new javax.swing.JFormattedTextField(new Float(defaultValue));
            } else {
            ...
            if (defaultValue != null) {
              textField6 =
                new javax.swing.JFormattedTextField(
                  new java.util.Date(defaultValue)
                );
            } else {
              textField6 =
                new javax.swing.JFormattedTextField(new java.util.Date());
            }
          ...
          case FILECHOOSER_CONTROL:
            ...
            chooser =
              new JButton(
                VueResources.getString("resourceInstallation.chooserOpen")
              );

            chooserActionListener =
              new ActionListener() {
                public void actionPerformed(ActionEvent e) {
                  VueFileChooser fileChooser =
                    VueFileChooser.getVueFileChooser();
                  fileChooser.setCurrentDirectory(new java.io.File("."));
                  fileChooser.setDialogTitle(
                    VueResources.getString("resourceInstallation.chooserTitle")
                  );
                  fileChooser.setFileSelectionMode(
                    VueFileChooser.FILES_AND_DIRECTORIES
                  );
                  if (
                    fileChooser.showOpenDialog(chooser) ==
                    VueFileChooser.APPROVE_OPTION
                  ) {
                    textField8.setText(
  ...
  private void populateField(
    ...
    if (tufts.vue.DEBUG.BOXES) component.setBorder(
  ...
  private void populateField(
    ...
    add(component, gbConstraints);
    if (tufts.vue.DEBUG.BOXES) component.setBorder(
      javax.swing.BorderFactory.createLineBorder(java.awt.Color.orange)
    );
      ...
      switch (uiCode) {
        case COMBO_BOX_CONTROL:
          javax.swing.JComboBox combo =
            (javax.swing.JComboBox) fieldVector.elementAt(i);
          String value = (String) combo.getSelectedItem();
          if (value != null) properties.setProperty(key, value);
          break;
        case SINGLE_LINE_CLEAR_TEXT_CONTROL:
          javax.swing.JTextField field0 =
            (javax.swing.JTextField) fieldVector.elementAt(i);
          String field0Value = field0.getText();
          properties.setProperty(key, field0Value);
          break;
        case SINGLE_LINE_MASKED_TEXT_CONTROL:
          javax.swing.JPasswordField field1 =
            (javax.swing.JPasswordField) fieldVector.elementAt(i);
          ...
          break;
        case MULTI_LINE_TEXT_CONTROL:
          javax.swing.JTextArea field2 =
            (javax.swing.JTextArea) fieldVector.elementAt(i);
    ...
    try {
      ...
      if (
        VueUtil.option(
          ...
          new Object[] {
            VueResources.getString("button.cancel.lable"),
            VueResources.getString("button.update.lable"),
          },
          VueResources.getString("button.update.lable")
        ) ==
        1
