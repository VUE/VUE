...
public class AdvancedQueryEditor
  ...
  private javax.swing.JPanel AdvancedSearch = new javax.swing.JPanel(
  ...
  public AdvancedQueryEditor() {
    ...
    conditionsTable.setPreferredScrollableViewportSize(
      ...
      new java.awt.event.FocusListener() {
        public void focusLost(java.awt.event.FocusEvent e) {
          if (conditionsTable.isEditing()) {
            conditionsTable
              .getCellEditor(
                conditionsTable.getEditingRow(),
                conditionsTable.getEditingColumn()
              )
              .stopCellEditing();
          }
    ...
    javax.swing.JScrollPane conditionsScrollPane = new javax.swing.JScrollPane(
      conditionsTable
    );
    ...
    innerConditionsPanel.add(
      conditionsScrollPane,
      java.awt.BorderLayout.CENTER
    );

    // GRID: addConditionButton
    javax.swing.JButton addConditionButton = new javax.swing.JButton(
      VueResources.getString("button.add.label")
    );
    addConditionButton.setBackground(this.getBackground());
    addConditionButton.setToolTipText(
      VueResources.getString("advancedqueryeditor.addcondition")
    );
    // GRID: deleteConditionButton
    javax.swing.JButton deleteConditionButton = new javax.swing.JButton(
    ...
    try {
      ...
      javax.swing.JComboBox operatorsComboBox = new javax.swing.JComboBox(
        operators
      );
      ...
      this.defaultCellEditor =
        conditionsTable.getColumnModel().getColumn(2).getCellEditor();
    } catch (Exception ex) {
      System.out.println("Can't set the editors" + ex);
    }

    ConditionSelectionListener sListener = new ConditionSelectionListener(
    ...
    javax.swing.JPanel topPanel = new javax.swing.JPanel(
      new java.awt.FlowLayout(java.awt.FlowLayout.RIGHT, 2, 0)
    );
    ...
    javax.swing.JPanel returnPanel = new javax.swing.JPanel(
      new java.awt.FlowLayout(java.awt.FlowLayout.RIGHT, 2, 0)
    );
    returnPanel.setBorder(
      javax.swing.BorderFactory.createEmptyBorder(4, 6, 6, 0)
    );
  ...
  public class ConditionsTableModel
    ...
    public void setValueAt(Object value, int row, int col) {
      Condition cond;
      if (row == -1) cond = new Condition(); else cond =
        (Condition) m_conditions.get(row);
      ...
      if (row == -1) m_conditions.add(cond); else m_conditions.set(row, cond);
  ...
  public class ConditionSelectionListener
    ...
    public ConditionSelectionListener(
  ...
  public class DeleteConditionButtonListener
    ...
    public DeleteConditionButtonListener(
