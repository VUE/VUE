...
public class ImageAssetViewer implements edu.tufts.vue.fsm.AssetViewer {

  org.osid.shared.Type mediumImageType = new edu.tufts.vue.util.Type(
    "mit.edu",
    "partStructure",
    "mediumImage"
  );
  ...
  public java.awt.Component viewAsset(org.osid.repository.Asset asset) {
    ...
    try {
      ...
      while (recordIterator.hasNextRecord()) {
        org.osid.repository.PartIterator partIterator = recordIterator
          .nextRecord()
          .getParts();
  ...
  public java.awt.Component viewAssets(
    org.osid.repository.AssetIterator assetIterator
  ) {
    javax.swing.JPanel panel = new javax.swing.JPanel();
    try {
      while (assetIterator.hasNextAsset()) {
        org.osid.repository.RecordIterator recordIterator = assetIterator
          .nextAsset()
          .getRecords();
        while (recordIterator.hasNextRecord()) {
          org.osid.repository.PartIterator partIterator = recordIterator
