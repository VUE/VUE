...
public class Export {
  ...
  public void export(String inputFile, String outputFile, String option)
    throws Exception {
  ...
  public void export(String inputFile, String outputFile, int option)
    throws Exception {
    switch (option) {
      case 0:
  ...
  public void printHelp() {
    System.out.println(
      "Usage: java -jar VUEExport.jar <input file(vue map)> <output file> [option]"
    );
    System.out.println();
    System.out.println("The arguments  are:");
    System.out.println("-h or --help  : prints this informaion");
    System.out.println(
      "<input file>  : this is a vue map of the type .vue or .vpk extention"
    );
