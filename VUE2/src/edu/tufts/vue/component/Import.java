...
public class Import {
  ...
  public static final String[] LAYOUT_SHORTCUT = {
    "default",
    "random",
    "circle",
    "filled",
   ...
   */
  public void createMap(String inputFile, String outputFile, int layoutId)
    throws Exception {
    String className =
      LAYOUT_PACKAGE + LAYOUT_CLASS_NAME[layoutId] + LAYOUT_EXTENSION;
   ...
   * @throws java.lang.Exception
   */
  public void createMap(String inputFile, String outputFile, String layout)
    throws Exception {
  ...
  public void createMap(String inputFile, String outputFile, Layout layout)
    throws Exception {
    Schema schema = Schema.getInstance(
      Resource.instance(inputFile),
      edu.tufts.vue.util.GUID.generate()
    );
  ...
  public void printHelp() {
    System.out.println(
      "Usage: java -jar VUEInport.jar <input file> <output file(vue map)> [option]"
    );
    System.out.println();
    System.out.println("The arguments  are:");
    System.out.println("-h or --help  : prints this informaion");
    System.out.println(
      "<input file>  :  this is a data file in csv or tab delimited format"
    );
    System.out.println("<output file> : location to output vue file");
    System.out.println(
      "[option]      : a number or format specifying the layout"
    );
