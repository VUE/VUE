...
public class ArtifactQueryEditor
  ...
  public class TitleSearchPane
    ...
    JButton searchButton = new JButton(
      VueResources.getString("button.search.label")
    );
    ...
    public String getSearchURL() {
      ...
      searchURL += "&class_num=";
      if (
        !(classField.getSelectedItem() == null ||
          classField
            .getSelectedItem()
            .toString()
            .equals(ArtifactQueryEditor.DEFAULT_VALUE))
      ) {
        searchURL += classField.getSelectedItem();
      }
      searchURL += "&subject=";
      if (
        !(subjectField.getSelectedItem() == null ||
          subjectField
            .getSelectedItem()
            .toString()
            .equals(ArtifactQueryEditor.DEFAULT_VALUE))
      ...
      searchURL += "&origin=";
      if (
        !(originField.getSelectedItem() == null ||
          originField
            .getSelectedItem()
            .toString()
            .equals(ArtifactQueryEditor.DEFAULT_VALUE))
      ...
      if (
        !(resultsField.getSelectedItem() == null ||
          resultsField
            .getSelectedItem()
            .toString()
            .equals(ArtifactQueryEditor.DEFAULT_VALUE))
