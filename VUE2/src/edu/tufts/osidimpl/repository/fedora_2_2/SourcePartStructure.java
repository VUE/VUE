...
public class SourcePartStructure implements org.osid.repository.PartStructure {
  ...
  private static SourcePartStructure sourcePartStructure =
    new SourcePartStructure();

  public static SourcePartStructure getInstance() {
