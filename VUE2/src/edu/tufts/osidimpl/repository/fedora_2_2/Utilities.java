...
public class Utilities {
  ...
  private static final String ID_IMPLEMENTATION =
    "comet.osidimpl.id.no_persist";
  private static final String LOGGING_IMPLEMENTATION =
  ...
  public static String formatObjectUrl(
    String objectId,
    String methodId,
  ...
  private static void setupLogging() {
    if (_log == null) {
      try {
        ...
        _log.assignPriorityType(
          new Type(
            LOGGING_TYPE_AUTHORITY,
            LOGGING_TYPE_DOMAIN,
            LOGGING_TYPE_PRIORITY
          )
        );
      } catch (Throwable t) {}
    }
