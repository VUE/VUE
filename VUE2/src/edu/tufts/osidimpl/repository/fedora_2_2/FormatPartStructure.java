...
public class FormatPartStructure implements org.osid.repository.PartStructure {
  ...
  private static FormatPartStructure formatPartStructure =
    new FormatPartStructure();

  public static FormatPartStructure getInstance() {
