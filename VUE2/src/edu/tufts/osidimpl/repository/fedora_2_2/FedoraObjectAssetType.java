...
public class FedoraObjectAssetType extends org.osid.shared.Type {
  ...
  private org.osid.repository.RecordStructure disseminationRecordStructure =
    null;
  ...
  public FedoraObjectAssetType(Repository repository, String type)
  ...
  public org.osid.repository.RecordStructure getDissemiationRecordStructure()
    throws org.osid.repository.RepositoryException {
    if (
      this.disseminationRecordStructure == null
    ) throw new org.osid.repository.RepositoryException(
      "Dissemination RecordStructure doesn't exist"
    );
    return this.disseminationRecordStructure;
  }

  public org.osid.repository.RecordStructure getImageRecordStructure()
    throws org.osid.repository.RepositoryException {
    if (
      this.sImageRecordStructure == null
    ) throw new org.osid.repository.RepositoryException(
      "Image RecordStructure doesn't exist"
    );
    return this.sImageRecordStructure;
  }

  public org.osid.repository.RecordStructure getDefaultRecordStructure()
    throws org.osid.repository.RepositoryException {
    if (
      this.sDefaultRecordStructure == null
    ) throw new org.osid.repository.RepositoryException(
      "Default RecordStructure doesn't exist"
    );
    return this.sDefaultRecordStructure;
  }

  private void loadRecordStructures()
    throws org.osid.repository.RepositoryException {
    try {
      disseminationRecordStructure =
        new DisseminationRecordStructure(repository);
      ...
      throw new org.osid.repository.RepositoryException(
        "FedoraObjecAssetType.loadRecordStructure  " + ex
      );
    }
  }
