...
public class FedoraUtils {
  ...
  public static final String OP_ACTUALS =
    "fedora.search.advanced.operators.actuals";
  ...
  public static String getFedoraProperty(
    ...
    try {
      ...
      throw new org.osid.repository.RepositoryException(
        "FedoraUtils.getFedoraProperty: " + ex
      );
    }
  }
  ...
  public static String[] getFedoraPropertyArray(
    Repository repository,
    String pLookupKey
  ) throws org.osid.repository.RepositoryException {
  ...
  public static String[] getAdvancedSearchFields(Repository repository)
    throws org.osid.repository.RepositoryException {
    return getFedoraPropertyArray(repository, "fedora.search.advanced.fields");
  }

  public static String[] getAdvancedSearchOperators(Repository repository)
    throws org.osid.repository.RepositoryException {
    return getFedoraPropertyArray(
      repository,
      "fedora.search.advanced.operators"
    );
  }

  public static String getAdvancedSearchOperatorsActuals(
    Repository repository,
    String pOperator
  ) throws org.osid.repository.RepositoryException {
  ...
  public static String getSaveFileName(
    org.osid.shared.Id objectId,
    org.osid.shared.Id behaviorId,
    org.osid.shared.Id disseminationId
  ) throws org.osid.OsidException {
    String saveFileName = processId(
      objectId.getIdString() +
      "-" +
      behaviorId.getIdString() +
      "-" +
      disseminationId.getIdString()
    );
    return saveFileName;
  }
  ...
  public static AbstractAction getFedoraAction(
    ...
    try {
      AbstractAction fedoraAction = new AbstractAction(
        record.getId().getIdString()
      ) {
        public void actionPerformed(java.awt.event.ActionEvent actionEvent) {
          try {
            org.osid.shared.Id id = new PID(
              getFedoraProperty(mRepository, "DisseminationURLInfoPartId")
            );
      ...
      throw new org.osid.repository.RepositoryException(
        "FedoraUtils.getFedoraAction " + t.getMessage()
      );
    }
  }
