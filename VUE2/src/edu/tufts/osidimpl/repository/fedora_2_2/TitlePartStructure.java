...
public class TitlePartStructure implements org.osid.repository.PartStructure {
  ...
  private static TitlePartStructure titlePartStructure =
    new TitlePartStructure();

  public static TitlePartStructure getInstance() {
    return titlePartStructure;
  }

  protected TitlePartStructure() {
    try {
