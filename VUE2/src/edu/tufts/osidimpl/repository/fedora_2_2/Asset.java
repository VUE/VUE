...
public class Asset implements org.osid.repository.Asset {
  ...
  public Asset(org.osid.shared.Id id, Repository repository)
  ...
  public Asset(
    ...
    if (
      !(assetType.getKeyword().equals(Repository.BDEF) ||
        assetType.getKeyword().equals(Repository.BMECH))
    ) {
      if (
        assetType
          .getKeyword()
          .equals(repository.getFedoraProperties().getProperty("type.image"))
      ) {
        recordVector.add(
          ImageRecordStructure.createImageRecord(
            id,
        ...
        repository.getConfiguration() != null &&
        repository.getConfiguration().getProperty("thumbnailSuffix") != null &&
        repository.getConfiguration().getProperty("thumbnailSuffix").length() >
          0
      ) {
        ImageRecordStructure imageRecordStructure =
          (ImageRecordStructure) ((FedoraObjectAssetType) assetType).getImageRecordStructure();
        Record record = new Record(pid, imageRecordStructure);
        record.createPart(
          imageRecordStructure.getThumbnailPartStructure().getId(),
          Utilities.formatObjectUrl(
            pid.getIdString(),
            repository.getConfiguration().getProperty("thumbnailSuffix"),
            repository
          )
        );
        recordVector.add(record);
        recordVector.add(
          DefaultRecordStructure.createDefaultRecord(
            id,
            (DefaultRecordStructure) ((FedoraObjectAssetType) assetType).getDefaultRecordStructure(),
            repository,
            pid,
            (FedoraObjectAssetType) assetType,
            getDisplayName(),
   ...
   *     @throws RepositoryException if there is a general failure
   */
  public void copyInfoStructure(
    org.osid.shared.Id assetId,
    org.osid.shared.Id infoStructureId
  ) throws org.osid.repository.RepositoryException {
    throw new org.osid.repository.RepositoryException(
      org.osid.OsidException.UNIMPLEMENTED
    );
        ...
        while (pi.hasNextPart()) {
          ...
          if (
            p
              .getPartStructure()
              .getDisplayName()
              .equals("VUE Default View Part Structure")
          ) {
            return p.getValue();
          }
        }
    ...
    for (int i = 0, size = recordVector.size(); i < size; i++) {
      try {
        org.osid.repository.Record record =
          (org.osid.repository.Record) recordVector.elementAt(i);
  ...
  public org.osid.repository.Part getPart(org.osid.shared.Id id)
    throws org.osid.repository.RepositoryException {
  ...
  public org.osid.repository.PartIterator getPartByPart(org.osid.shared.Id id)
    throws org.osid.repository.RepositoryException {
    throw new org.osid.repository.RepositoryException(
      org.osid.OsidException.UNIMPLEMENTED
    );
  ...
  public java.io.Serializable getPartValue(org.osid.shared.Id id)
    throws org.osid.repository.RepositoryException {
    throw new org.osid.repository.RepositoryException(
      org.osid.OsidException.UNIMPLEMENTED
    );
  ...
  public org.osid.shared.ObjectIterator getPartValueByPartStructure(
  ...
  public org.osid.repository.Record getRecord(org.osid.shared.Id id)
    throws org.osid.repository.RepositoryException {
    Iterator i = recordVector.iterator();
    while (i.hasNext()) {
      ...
      try {
        if (
          record.getId().getIdString().equals(id.getIdString())
        ) return record;
      } catch (org.osid.shared.SharedException ex) {
        throw new org.osid.repository.RepositoryException(ex.getMessage());
      }
  ...
  public org.osid.repository.RecordIterator getRecordsByInfoStructure(
    org.osid.shared.Id id
  ) throws org.osid.repository.RepositoryException {
    java.util.Vector result = new java.util.Vector();
    Iterator i = recordVector.iterator();
  ...
  public void updateEffectiveDate(long date)
    throws org.osid.repository.RepositoryException {
    throw new org.osid.repository.RepositoryException(
      org.osid.OsidException.UNIMPLEMENTED
    );
  ...
  public void updateExpirationDate(long date)
    throws org.osid.repository.RepositoryException {
    throw new org.osid.repository.RepositoryException(
      org.osid.OsidException.UNIMPLEMENTED
    );
