...
public class Repository implements org.osid.repository.Repository {
  ...
  private org.osid.shared.Type keywordSearchType = new Type(
    "mit.edu",
    "search",
    "keyword"
  );
  private org.osid.shared.Type multiFieldSearchType = new Type(
    "mit.edu",
    "search",
    "multiField"
  );
  private org.osid.shared.Type repositoryType = new Type(
    "tufts.edu",
    "repository",
    "fedora_2_2"
  );
  ...
  public Repository(Properties configuration, String id)
    throws org.osid.repository.RepositoryException {
    try {
      this.id = new PID(id);
  ...
  public void setFedoraProperties() {
    ...
    try {
      ...
      fedoraProperties.setProperty(
        "url.seastar.fedora.get",
        "http://seastar.lib.tufts.edu:8080/fedora/get/"
      );
      fedoraProperties.setProperty(
        "fedora.types",
        "TUFTS_STD_IMAGE,XML_TO_HTMLDOC,TUFTS_BINARY_FILE,TUFTS_VUE_CONCEPT_MAP,UVA_EAD_FINDING_AID,UVA_STD_IMAGE,UVA_MRSID_IMAGE,SIMPLE_DOC,MassIngest"
      );
      fedoraProperties.setProperty(
        "ImageRecordStructureId",
        "edu.mit.image.recordStructureId"
      );
      fedoraProperties.setProperty(
        "VUEDefaultViewInfoPartId",
        "edu.tufts.defaultView.partStructureId"
      );
      fedoraProperties.setProperty(
        "ThumbnailPartStructureId",
        "mit.edu.thumbnail.partStructureId"
      );
      fedoraProperties.setProperty(
        "URLPartStructureId",
        "mit.edu.partStructureId"
      );
      fedoraProperties.setProperty(
        "dissemination.dc",
        "bdef:TuftsMetadata/getDublinCore/"
      );
      fedoraProperties.setProperty("type.image", "tufts/image/archival");
      fedoraProperties.setProperty(
        "assetDef.fullView",
        "bdef:AssetDef/getFullView"
      );
    } catch (Exception ex) {
      ex.printStackTrace();
  ...
  public FedoraObjectAssetType createFedoraObjectAssetType(String type)
    ...
    org.osid.repository.RecordStructureIterator iter =
      fedoraObjectAssetType.getRecordStructures();
    while (iter.hasNextRecordStructure()) {
      org.osid.repository.RecordStructure recordStructure =
        (org.osid.repository.RecordStructure) iter.nextRecordStructure();
      if (recordStructures.indexOf(recordStructure) < 0) recordStructures.add(
        recordStructure
      );
    }
  ...
  public org.osid.repository.Asset createAsset(
    ...
    try {
      org.osid.repository.Asset obj = new Asset(
        this,
        displayName,
        description,
        assetType
  ...
  public org.osid.repository.RecordStructureIterator getRecordStructures()
    throws org.osid.repository.RepositoryException {
    return (org.osid.repository.RecordStructureIterator) new RecordStructureIterator(
      recordStructures
    );
  }
  ...
  public org.osid.repository.Asset getAsset(org.osid.shared.Id assetId)
    ...
    org.osid.repository.AssetIterator mAssetIterator =
      FedoraRESTSearchAdapter.advancedSearch(this, searchCriteria);
    if (
      mAssetIterator.hasNextAsset()
    ) return mAssetIterator.nextAsset(); else throw new org.osid.repository.RepositoryException(
  ...
  public org.osid.repository.AssetIterator getAssets(
    ...
    if (
      (searchCriteria instanceof String) &&
      (searchType.isEqual(keywordSearchType) ||
        searchType.isEqual(multiFieldSearchType))
    ) {
