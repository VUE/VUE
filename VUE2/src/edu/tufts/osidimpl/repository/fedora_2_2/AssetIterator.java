...
public class AssetIterator implements org.osid.repository.AssetIterator {
  ...
  // }
  public AssetIterator(List<Asset> assetList)
    throws org.osid.repository.RepositoryException {
  ...
  public AssetIterator(
    ...
    try {
      if (
        ...
        org.osid.repository.AssetIterator ai = FedoraRESTSearchAdapter.search(
          repository,
          lSearchCriteria
        );
        ...
        lSearchCriteria.setConditions(
          (fedora.server.types.gen.Condition[]) conditions.toArray(
            new Condition[0]
          )
        );
        lSearchCriteria.setMaxReturns(numberToAskForString);
        ...
        org.osid.repository.AssetIterator ai =
          FedoraRESTSearchAdapter.advancedSearch(repository, lSearchCriteria);
        java.util.Vector v = new java.util.Vector();
        while (ai.hasNextAsset()) v.addElement(ai.nextAsset());
        this.iterator = v.iterator();
      } else {
  ...
  private java.util.List getConditions(String xml) {
    ...
    try {
      ...
      document =
        db.parse(new java.io.ByteArrayInputStream(xml.toString().getBytes()));
      ...
      for (int i = 0; i < numFields; i++) {
        ...
        if (numNodes > 0) {
          ...
          if (e.hasChildNodes()) {
            ...
            org.w3c.dom.NodeList nodeList2 = field.getElementsByTagName(
              "value"
            );
            ...
            if (numNodes2 > 0) {
              ...
              if (e2.hasChildNodes()) {
                ...
                fedora.server.types.gen.Condition cond =
                  new fedora.server.types.gen.Condition();
