...
public class LastModifiedTimePartStructure
  ...
  private static LastModifiedTimePartStructure lastModifiedTimePartStructure =
    new LastModifiedTimePartStructure();
  ...
  protected LastModifiedTimePartStructure() {
    try {
      this.lastModifiedTimePartStructureId =
        Utilities.getIdManager().getId("LastModifiedTimePartStructureId");
    } catch (Throwable t) {}
  }
