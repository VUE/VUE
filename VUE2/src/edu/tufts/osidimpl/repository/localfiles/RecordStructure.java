...
{
    private String idString = "LocalFilesRecordStructureId";
    private String displayName = "Local Files, various time parts";
    private String description = "Holds metadata for an local file asset";
    ...
    throws org.osid.repository.RepositoryException
    {
        ...
        try
        {
            results.addElement(CreatedTimePartStructure.getInstance());
            results.addElement(LastAccessedTimePartStructure.getInstance());
            results.addElement(LastModifiedTimePartStructure.getInstance());
