...
public class ThumbnailPartStructure
  ...
  private static ThumbnailPartStructure thumbnailPartStructure =
    new ThumbnailPartStructure();

  protected static ThumbnailPartStructure getInstance() {
    return thumbnailPartStructure;
  }
  ...
  protected ThumbnailPartStructure() {
    try {
      this.THUMBNAIL_PART_STRUCTURE_ID =
        Utilities.getIdManager().getId("ThumbnailPartStructureId");
    } catch (Throwable t) {}
  }
  ...
  public org.osid.shared.Id getId()
    throws org.osid.repository.RepositoryException {
    return this.THUMBNAIL_PART_STRUCTURE_ID;
  }
