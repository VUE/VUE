...
public class CulturePartStructure implements org.osid.repository.PartStructure {
  ...
  private static CulturePartStructure culturePartStructure =
    new CulturePartStructure();

  protected static CulturePartStructure getInstance() {
    return culturePartStructure;
  }
  ...
  protected CulturePartStructure() {
    try {
      this.culturePartStructureId =
        Utilities.getIdManager().getId("Culture.PartStructureId");
    } catch (Throwable t) {}
  }
  ...
  public org.osid.shared.Id getId()
    throws org.osid.repository.RepositoryException {
    return this.culturePartStructureId;
  }
