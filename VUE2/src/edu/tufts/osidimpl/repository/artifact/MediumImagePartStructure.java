...
public class MediumImagePartStructure
  ...
  private static MediumImagePartStructure mediumImagePartStructure =
    new MediumImagePartStructure();
  ...
  protected MediumImagePartStructure() {
    try {
      this.MEDIUM_IMAGE_PART_STRUCTURE_ID =
        Utilities.getIdManager().getId("MediumImagePartStructureId");
    } catch (Throwable t) {}
  }
