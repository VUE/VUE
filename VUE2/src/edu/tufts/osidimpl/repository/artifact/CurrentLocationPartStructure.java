...
public class CurrentLocationPartStructure
  ...
  private static CurrentLocationPartStructure currentLocationPartStructure =
    new CurrentLocationPartStructure();

  protected static CurrentLocationPartStructure getInstance() {
    return currentLocationPartStructure;
  }
  ...
  protected CurrentLocationPartStructure() {
    try {
      this.currentLocationPartStructureId =
        Utilities.getIdManager().getId("CurrentLocationPartStructureId");
    } catch (Throwable t) {}
  }
  ...
  public org.osid.shared.Id getId()
    throws org.osid.repository.RepositoryException {
    return this.currentLocationPartStructureId;
  }
