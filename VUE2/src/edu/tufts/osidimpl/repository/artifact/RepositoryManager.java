  ...
  public void assignConfiguration(java.util.Properties configuration)
    ...
    try {
      ...
      this.repositoryId =
        Utilities
          .getIdManager()
          .getId("72012680-81CF-4E5C-A07F-07841CB97B0B-1194-000002C24B7AA681");
      ...
      this.searchTypeVector.addElement(
    ...
    try {
      ...
      while (repositoryIterator.hasNextRepository()) {
        org.osid.repository.Repository nextRepository =
          repositoryIterator.nextRepository();
        try {
          org.osid.repository.Asset asset = nextRepository.getAssetByDate(
            assetId,
            date
          );
          return asset;
  ...
  public org.osid.shared.LongValueIterator getAssetDates(
    ...
    try {
      ...
      while (repositoryIterator.hasNextRepository()) {
        org.osid.repository.Repository nextRepository =
          repositoryIterator.nextRepository();
        org.osid.shared.LongValueIterator longValueIterator =
          repository.getAssetDates(assetId);
