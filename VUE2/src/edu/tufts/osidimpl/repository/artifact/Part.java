...
implements org.osid.repository.Part
{
    ...
    throws org.osid.repository.RepositoryException
    {
        ...
        try
        {
			...
			if (partStructureId.isEqual(ArtifactPartStructure.getInstance().getId())) {
				this.partStructure = ArtifactPartStructure.getInstance();
			} else if (partStructureId.isEqual(ArtistPartStructure.getInstance().getId())) {
				this.partStructure = ArtistPartStructure.getInstance();
			} else if (partStructureId.isEqual(CulturePartStructure.getInstance().getId())) {
				this.partStructure = CulturePartStructure.getInstance();
			} else if (partStructureId.isEqual(CurrentLocationPartStructure.getInstance().getId())) {
				this.partStructure = CurrentLocationPartStructure.getInstance();
			} else if (partStructureId.isEqual(LargeImagePartStructure.getInstance().getId())) {
				this.partStructure = LargeImagePartStructure.getInstance();
			} else if (partStructureId.isEqual(MaterialPartStructure.getInstance().getId())) {
				this.partStructure = MaterialPartStructure.getInstance();
			} else if (partStructureId.isEqual(MediumImagePartStructure.getInstance().getId())) {
				this.partStructure = MediumImagePartStructure.getInstance();
			} else if (partStructureId.isEqual(OriginPartStructure.getInstance().getId())) {
				this.partStructure = OriginPartStructure.getInstance();
			} else if (partStructureId.isEqual(PeriodPartStructure.getInstance().getId())) {
			...
			} else if (partStructureId.isEqual(ThumbnailPartStructure.getInstance().getId())) {
			...
			} else if (partStructureId.isEqual(ViewPartStructure.getInstance().getId())) {
