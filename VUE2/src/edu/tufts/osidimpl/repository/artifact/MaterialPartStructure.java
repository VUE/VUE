...
public class MaterialPartStructure
  ...
  private static MaterialPartStructure materialPartStructure =
    new MaterialPartStructure();

  protected static MaterialPartStructure getInstance() {
  ...
  protected MaterialPartStructure() {
    try {
      this.materialPartStructureId =
        Utilities.getIdManager().getId("MaterialPartStructureId");
    } catch (Throwable t) {}
  }
  ...
  public org.osid.shared.Id getId()
    throws org.osid.repository.RepositoryException {
    return this.materialPartStructureId;
  }
