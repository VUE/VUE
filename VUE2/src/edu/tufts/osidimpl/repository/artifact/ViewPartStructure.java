...
public class ViewPartStructure implements org.osid.repository.PartStructure {
  ...
  private static ViewPartStructure viewPartStructure = new ViewPartStructure();

  protected static ViewPartStructure getInstance() {
    return viewPartStructure;
  }
  ...
  protected ViewPartStructure() {
    try {
      viewPartStructureId =
        Utilities.getIdManager().getId("ViewPartStructureId");
    } catch (Throwable t) {}
  }
