...
public class OriginPartStructure implements org.osid.repository.PartStructure {
  ...
  private static OriginPartStructure originPartStructure =
    new OriginPartStructure();

  protected static OriginPartStructure getInstance() {
    return originPartStructure;
  }
  ...
  protected OriginPartStructure() {
    try {
      this.originPartStructureId =
        Utilities.getIdManager().getId("Origin.PartStructureId");
    } catch (Throwable t) {}
  }
  ...
  public org.osid.shared.Id getId()
    throws org.osid.repository.RepositoryException {
    return this.originPartStructureId;
  }
