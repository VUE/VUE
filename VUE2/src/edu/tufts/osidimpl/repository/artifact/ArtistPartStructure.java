...
public class ArtistPartStructure implements org.osid.repository.PartStructure {
  ...
  private String description =
    "Typically, the name of a Artist should be used to indicate the entity.";
  private boolean mandatory = false;
  private boolean populatedByRepository = true;
  private boolean repeatable = false;
  private static ArtistPartStructure artistPartStructure =
    new ArtistPartStructure();

  protected static ArtistPartStructure getInstance() {
    return artistPartStructure;
  }
  ...
  protected ArtistPartStructure() {
    try {
      this.artistrPartStructureId =
        Utilities.getIdManager().getId("ArtistPartStructureId");
    } catch (Throwable t) {}
  }
  ...
  public org.osid.shared.Id getId()
    throws org.osid.repository.RepositoryException {
    return this.artistrPartStructureId;
  }
