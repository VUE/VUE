...
public class PeriodPartStructure implements org.osid.repository.PartStructure {
  ...
  private static PeriodPartStructure periodPartStructure =
    new PeriodPartStructure();
  ...
  protected PeriodPartStructure() {
    try {
      periodPartStructureId =
        Utilities.getIdManager().getId("PeriodPartStructureId");
    } catch (Throwable t) {}
  }
