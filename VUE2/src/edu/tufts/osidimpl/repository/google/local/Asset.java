...
public class Asset implements org.osid.repository.Asset {
  ...
  protected Asset(String displayName, String description, String url)
    ...
    try {
      ...
      org.osid.repository.Part part = record.createPart(
        URLPartStructure.getInstance().getId(),
        url
      );
      ...
      this.repositoryId =
        Utilities
          .getIdManager()
          .getId("4C728514-3135-43EC-95CA-F588F4668C5B-304-0000001A73B8246E");
