...
public class RepositoryManager
  ...
  private org.osid.authentication.AuthenticationManager authenticationManager =
    null;
  ...
  public void assignConfiguration(java.util.Properties configuration)
    ...
    try {
      ...
      if (configuration.getProperty("sakaiHost") != null) {
        org.osid.shared.Type authenticationType = new Type(
          "sakaiproject.org",
          "authentication",
          "sakai"
        );
        this.authenticationManager =
          (org.osid.authentication.AuthenticationManager) org.osid.OsidLoader.getManager(
        ...
        if (
          !this.authenticationManager.isUserAuthenticated(authenticationType)
        ) {
          throw new org.osid.repository.RepositoryException(
            org.osid.OsidException.PERMISSION_DENIED
          );
        }

        this.key = (String) context.getContext("org.sakaiproject.instanceKey");
        //System.out.println("assigned key is " + key);
        String sessionId = (String) context.getContext(
          "org.sakaiproject.sessionId." + key
        );
        if (sessionId == null) {
          throw new org.osid.repository.RepositoryException(
        ...
        /*
				 ...
				 */
        this.repositoryType =
          new Type("sakaiproject.org", "repository", "contentHosting");
        ...
        this.repositoryVector.addElement(
            new Repository(displayName, key, this)
          );
      }
    } catch (Throwable t) {
      Utilities.log(t);
  ...
  /**
	 ...
	 */
  public org.osid.repository.Repository createRepository(
    String displayName,
    String description,
      ...
      for (int j = 0; j < repositories.length; j++) {
        ...
        try {
          org.osid.repository.AssetIterator assetIterator =
            nextRepository.getAssetsBySearch(
              searchCriteria,
              searchType,
              searchProperties
            );
  ...
  /**
		Unimplemented Method
	 */
  public org.osid.shared.Id copyAsset(
    org.osid.repository.Repository repository,
    org.osid.shared.Id assetId
  ) throws org.osid.repository.RepositoryException {
  ...
  protected String pingForValidSession() {
    try {
      ...
      try {
        System.out.println(
          "Connection failed, session may have timed out.  Retrying once."
        );
        org.osid.shared.Type authenticationType = new Type(
          "sakaiproject.org",
          "authentication",
