...
public class Utilities {
  ...
  private static org.osid.authentication.AuthenticationManager authenticationManager =
    null;
  private static org.osid.shared.Type authenticationType = new Type(
    "sakaiproject.org",
    "authentication",
    "sakai"
  );
  private static org.osid.shared.Type collectionAssetType = new Type(
    "sakaiproject.org",
    "asset",
    "siteCollection"
  );
  private static org.osid.shared.Type resourceAssetType = new Type(
    "sakaiproject.org",
    "asset",
    "resource"
  );
  ...
  public static void setAuthenticationManager(
    org.osid.authentication.AuthenticationManager a
  ) {
