...
public class Asset implements org.osid.repository.Asset {
  ...
  protected Asset(String key, String xml) {
    try {
      this.recordStructureId = RecordStructure.getInstance().getId();
      ...
      for (int i = 0; i < numResources; i++) {
        ...
        if (type.equals("collection")) assetType =
          Utilities.getCollectionAssetType();
        if (type.equals("resource")) assetType =
          Utilities.getResourceAssetType();
  ...
  public java.io.Serializable getContent()
    ...
    try {
      ...
      String result = (String) call.invoke(
        new Object[] { sessionId, this.assetIdString }
      );
  ...
  public void updateContent(java.io.Serializable content)
    ...
    if (!(this.assetType.isEqual(Utilities.getCollectionAssetType()))) {
      System.out.println(
        "Not a collection type " + Utilities.typeToString(this.assetType)
      );
      throw new org.osid.repository.RepositoryException(
        org.osid.shared.SharedException.UNKNOWN_TYPE
      );
  ...
  public org.osid.repository.AssetIterator getAssets()
    ...
    if (this.assetType.isEqual(Utilities.getCollectionAssetType())) {
      try {
        ...
        String siteString = (String) call.invoke(
          new Object[] { sessionId, assetIdString }
        );
