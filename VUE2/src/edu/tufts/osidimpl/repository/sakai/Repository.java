...
public class Repository implements org.osid.repository.Repository {
  ...
  private String repositoryIdPrefixString =
    "E89F7F92-8C23-481B-AF8C-7AE169699F34-2595-000008D778AFEB53";
  ...
  private org.osid.shared.Type titleSearchType = new Type(
    "mit.edu",
    "search",
    "title"
  );
...
*/
  ...
  public org.osid.repository.AssetIterator getAssets()
    ...
    try {
      ...
      String siteString = (String) call.invoke(
        new Object[] { sessionId, virtualRootId }
      );
  ...
  public org.osid.repository.AssetIterator getAssetsByType(
    ...
    if (
      !(assetType.isEqual(Utilities.getCollectionAssetType()) ||
  ...
  public org.osid.repository.AssetIterator getAssetsBySearch(
    ...
    for (int i = 0, size = this.searchTypeVector.size(); i < size; i++) {
      if (
        searchType.isEqual(
          (org.osid.shared.Type) this.searchTypeVector.elementAt(i)
        )
      ) {
        knownType = true;
      }
  ...
  private java.util.Vector match(
