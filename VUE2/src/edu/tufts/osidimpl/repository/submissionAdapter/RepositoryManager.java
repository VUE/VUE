...
public class RepositoryManager
    ...
    try {
      ...
      while ((ser = context.getContext(key)) != null) {
        ...
        org.osid.repository.RepositoryManager repositoryManager =
          (org.osid.repository.RepositoryManager) ser;
  ...
  public org.osid.repository.RepositoryIterator getRepositoriesByType(
    ...
    try {
      ...
      for (int i = 0, size = this.repositoryVector.size(); i < size; i++) {
        org.osid.repository.Repository repository =
          (org.osid.repository.Repository) this.repositoryVector.elementAt(i);
    ...
    try {
      ...
      for (int i = 0; i < assetIteratorVector.size(); i++) {
        org.osid.repository.AssetIterator assetIterator =
          (org.osid.repository.AssetIterator) assetIteratorVector.elementAt(i);
  ...
  /* 			
	...
	*/
  private synchronized void performParallelSearches(
    org.osid.repository.Repository[] repositories,
    java.io.Serializable searchCriteria,
    org.osid.shared.Type searchType,
    org.osid.shared.Properties searchProperties
  ...
  private class SearchThread extends Thread {
    ...
    public void run() {
      ...
      try {
        ...
        assetIteratorVector.addElement(
