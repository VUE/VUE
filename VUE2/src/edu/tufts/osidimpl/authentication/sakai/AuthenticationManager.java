...
public class AuthenticationManager
  ...
  private org.osid.shared.Type authenticationType = new Type(
    "sakaiproject.org",
    "authentication",
    "sakai"
  );
  ...
  public org.osid.shared.TypeIterator getAuthenticationTypes()
    ...
    try {
      ...
      throw new org.osid.authentication.AuthenticationException(
  ...
  public void authenticateUser(org.osid.shared.Type authenticationType)
    ...
    String debugString =
      this.configuration.getProperty("sakaiAuthenticationDebug");
    if (debugString != null) {
    ...
    try {
      String endpoint =
        this.host + ":" + this.port + "/sakai-axis/SakaiLogin.jws";
  ...
  public void destroyAuthentication()
    ...
    try {
      this.context.assignContext(
          "org.sakaiproject.sessionId." + this.host,
          null
        );
  ...
  public void destroyAuthenticationForType(
    org.osid.shared.Type authenticationType
  ) throws org.osid.authentication.AuthenticationException {
    if (authenticationType == null) {
      throw new org.osid.authentication.AuthenticationException(
        org.osid.OsidException.NULL_ARGUMENT
