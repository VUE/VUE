...
implements org.osid.repository.PartStructure
{
	...
	private static ArtifactPartStructure artifactPartStructure = new ArtifactPartStructure();
    ...
    protected ArtifactPartStructure()
    {
        try
        {
            this.artifactrPartStructureId = Utilities.getIdManager().getId("ArtifactPartStructureId");
        }
        catch (Throwable t)
        {
        }        
