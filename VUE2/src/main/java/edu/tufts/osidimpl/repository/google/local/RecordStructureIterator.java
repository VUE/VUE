...
{
    private java.util.Iterator<org.osid.repository.RecordStructure> iterator = null;

    public RecordStructureIterator(java.util.Vector<org.osid.repository.RecordStructure> vector)
