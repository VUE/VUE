...
implements org.osid.repository.PartStructure
{
	...
	private static LastAccessedTimePartStructure lastAccessedTimePartStructure = new LastAccessedTimePartStructure();
    ...
    protected LastAccessedTimePartStructure()
    {
        try
        {
            this.lastAccessedTimerPartStructureId = Utilities.getIdManager().getId("LastAccessedTimePartStructureId");
        }
        catch (Throwable t)
        {
        }        
