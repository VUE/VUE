...
implements org.osid.repository.PartStructure
{
	...
	private static MediumImagePartStructure mediumImagePartStructure = new MediumImagePartStructure();
	
	protected static MediumImagePartStructure getInstance()
	{
		return mediumImagePartStructure;
	}
    ...
    protected MediumImagePartStructure()
    {
        try
        {
            this.MEDIUM_IMAGE_PART_STRUCTURE_ID = Utilities.getIdManager().getId("MediumImagePartStructureId");
        }
        catch (Throwable t)
        {
        }        
