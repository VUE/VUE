...
// Apollia's notes, Feb. 12, 2017, 8:26 AM-8:31 AM and 9:00 AM EST.
// 
// I replaced the original contents of this file with:
// http://stackoverflow.com/a/61982
//
// And I replaced the convertTab method with:
...
//
// To my surprise, the below worked without any modification.
// (I just had to make the MappedTabbedPane extend DnDTabbedPane
// instead of JTabbedPane.)
//
// The only problem I noticed was, when dragging the last tab to some
// other location, that tab would disappear, and so would any other
// tabs you tried to drag after that.
//
// I commented out two lines in MapTabbedPane.java, and that somehow
// seemed to fix that problem, and also the problem of mistaken-seeming
// "Failed to load map" dialog boxes popping up sometimes when loading maps,
// a problem I had run into on occasion for years, which seems to be 
// unrelated to making tabs reorderable via dragdrop.
...
public class DnDTabbedPane extends JTabbedPane {
    ...
    // Added by Apollia on Feb. 12, 2017, 7:21 AM EST.
    // Came from:
    //
    // http://stackoverflow.com/a/8610017
   // http://stackoverflow.com/questions/60269/how-to-implement-draggable-tab-using-java-swing
    ...
    // End of Added by Apollia on Feb. 12, 2017, 7:21 AM EST.
