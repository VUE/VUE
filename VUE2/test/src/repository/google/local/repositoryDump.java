...
public class repositoryDump
{
    ...
    public static void main(String args[])
    {
        try
        {
			...
			properties.setProperty("googleLocalURL","http://googlesearch.tufts.edu");
			properties.setProperty("googleLocalSite","tufts01");
			properties.setProperty("googleLocalClient","tufts01");
			org.osid.repository.RepositoryManager repositoryManager = (org.osid.repository.RepositoryManager)org.osid.OsidLoader.getManager(
                ...
                "edu.tufts.osidimpl.repository.google.local",
                context,
                properties);     
    ...
    private void assetsByRepository(org.osid.repository.RepositoryManager repositoryManager)
    {
        try
        {
            ...
            while (repositoryIterator.hasNextRepository())
            {
                ...
                org.osid.repository.AssetIterator assetIterator = repository.getAssetsBySearch("Art",new Type("mit.edu","search","keyword"),new SharedProperties());
